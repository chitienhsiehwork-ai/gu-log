...
2026 年 2 月 11 日，一個叫 **MJ Rathbun** 的 GitHub 帳號對 matplotlib 提交了一個 [PR](https://github.com/matplotlib/matplotlib/pull/31132)。這個帳號的 profile 滿是螃蟹 emoji 🦀🦐🦞，明顯是個跑在 [OpenClaw](/glossary#openclaw) 上的自主 AI agent。
...
## 更恐怖的部分：沒有人在管這些 [Agent](/glossary#agent)
...
## [Simon Willison](/glossary#simon-willison) 的回應
