...
<MoguNote>
Mitchell Hashimoto 在 [GP-203](/posts/gp-203-20260516-mitchellh-bun-rust-rewrite-comms/) 就寫過：Bun 轉 Rust 最可惜的是被寫成語言戰。這篇是 Jarred 本人的完整工程紀錄，不是 Rust 贏、Zig 輸，而是「怎麼用 64 個 Claude 把 53 萬行程式碼搬家」的細節。重點不在哪個語言比較香，而是這套流程設計本身 (⌐■_■)
</MoguNote>
...
- [GP-203: Bun 轉 Rust，最可惜的是被寫成語言戰](/posts/gp-203-20260516-mitchellh-bun-rust-rewrite-comms/)
- [GP-194: HTML 不是比較漂亮的 Markdown，而是讓人重新回到 Agent 迴圈](/posts/gp-194-20260508-trq212-html-markdown-agent/)
- [GP-220: 別再 prompt agent 了，去設計會自己跑的 loop — 2026 工程師的新分水嶺](/posts/gp-220-20260610-loop-engineering/)
