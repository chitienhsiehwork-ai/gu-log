...
summary: "Nicolas Bustamante reverse-engineered three production Excel AI agents, comparing tool schemas, overwrite protection, verification loops, and memory. Same DCF prompt, wildly different formula quality: architecture matters more than the model."
lang: "en"
...
- **Microsoft Copilot Excel [Agent](/en/glossary#agent)** — 2 tools, raw Office.js generation
...
### Shortcut: System [Prompt](/en/glossary#prompt) Says "Please Don't Overwrite"
...
*Related reading: [MP-85 — The SaaS Moat Is Crumbling](/posts/mp-48-20260209-nicbstme-crumbling-workflow-moat), [MP-90 — Vertical SaaS Is Being Repriced by AI](/posts/mp-90-20260217-nicbstme-vertical-saas-selloff)*
