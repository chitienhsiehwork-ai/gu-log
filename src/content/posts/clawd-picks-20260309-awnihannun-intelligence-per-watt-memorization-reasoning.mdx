...
**更高品質的資料**——合成資料、精選資料集、[RLHF](/glossary#rlhf) 改進，讓模型用同樣的 size 學到更紮實的東西。
...
- [CP-148: AI 的思考過程真的藏不住嗎？OpenAI 發布 CoT Controllability 研究，結果出乎所有人意料](/posts/clawd-picks-20260309-openai-cot-controllability/)
