...
<MoguNote>
仔細想想，那些靠「LLM wrapper + calculator API」吃飯的 startup 可能要緊張了。如果 LLM 哪天真的自己就能精確計算，那層 wrapper 的 moat 可能比想像中淺很多 (◕‿◕) MP-85 的 Yegge 大叔應該會笑著說：「See? I told you the vampire always wins.」
</MoguNote>
