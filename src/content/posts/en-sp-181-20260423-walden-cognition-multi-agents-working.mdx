...
(gu-log covered the outer autofix-loop architecture earlier in [SP-66: self-healing PR](/posts/sp-66-20260216-self-healing-pr-devin-autofix). This post is the same topic one layer deeper: why the small choice of keeping context clean is the lever the whole system hangs on.)
