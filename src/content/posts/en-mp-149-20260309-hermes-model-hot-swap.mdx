...
Don't let the smiley face fool you. This isn't "wow cool." This is: **this thing has potential to become a real project.** From Nous Research's perspective, an [Agent](/en/glossary#agent) that can manage its own inference backend at runtime is exactly the kind of local-first autonomous agent they've been championing.
...
Right now, the upgrade path for most AI [agents](/en/glossary#agent) looks like this: developer sees a better model → manually edits config → restarts service → agent passively gets a new brain. The entire process is human-decided, human-executed. You tell it what brain to use, and it obeys like a well-behaved student.
...
- [MP-196: Hermes Agent officially supports Browser Use — letting AI agents browse social media for you](/posts/mp-196-20260322-teknium-hermes-agent-browser-use/)
- [MP-189: Agent starts steering itself? Hermes Agent's self-guidance experiment is something](/posts/mp-189-20260317-teknium-agent-hermes-agent/)
- [MP-151: AI agent started tuning hyperparameters on its own — Karpathy says this is real](/posts/mp-151-20260311-karpathy-autoresearch-hyperparameter-tuning/)
