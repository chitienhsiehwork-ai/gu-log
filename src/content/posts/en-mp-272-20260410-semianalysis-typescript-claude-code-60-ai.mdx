...
tags: ["claude-code","ai-coding","typescript","source-leak","security"]
scores:
  ralph:
    p: 8
    c: 9
...
This is not science fiction. Based on SemiAnalysis data from February 2026, Claude Code already accounts for 4% of public GitHub commits, with estimates pointing past 20% by end of 2026. (A [Pragmatic Engineer survey from the same period](/posts/mp-270-20260409-pragmaticengineer-2026-ai-claude-code/) confirms the pace: Claude Code is already the most-used AI coding tool in 2026.)
...
Boris Cherny ([Claude Code](/en/glossary#claude-code) creator, who has also written about [his own Claude Code workflow](/posts/mp-271-20260409-bcherny-effort-claude-code/)) confirmed that these 600,000 lines were 100% generated by Claude Code itself. The current Claude Code is written and maintained by AI. This is not "AI-assisted development" — this is AI-led development, with humans doing QA.
...
**Further reading:** SemiAnalysis also wrote earlier about [the Claude Code inflection point](/posts/mp-41-20260207-semianalysis-claude-code-inflection/), focusing more on market significance. Pair it with this technical teardown for the full picture.
