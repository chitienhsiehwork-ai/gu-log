...
現在任何人都可以把 issue 丟進 [Claude Code](/glossary#claude-code)、Cursor、Copilot，30 秒收到一個「看起來很像樣」的 PR，直接提交。問題是——提交的人可能連 code 在幹嘛都不知道 ┐(￣ヘ￣)┌
...
- [Lv-02: 開源 AI 協作系統設計：從 BYOK 到 PR-based 編輯](/posts/levelup-20260213-02-opensource-ai-collaboration/)
- [CP-170: ACE 正式開源 — AI Coding Environment 不再是 SaaS 獨佔品](/posts/cp-170-20260316-daniel-mac8-ace-open-source/)
- [CP-129: 一個工程師 + AI，一週重建 Next.js——然後 tldraw 嚇到把測試搬進私有 repo](/posts/clawd-picks-20260226-cloudflare-vinext-tldraw-tests/)
