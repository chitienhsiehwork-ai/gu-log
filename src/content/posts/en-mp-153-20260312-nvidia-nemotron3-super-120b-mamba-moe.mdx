...
- [MP-194: NVIDIA Releases Nemotron 3 VoiceChat: Leading the Open-Weights Speech-to-Speech Pareto Frontier](/en/posts/en-mp-194-20260321-artificialanlys-nvidia-nemotron3-voicechat/)
- [MP-185: NVIDIA GPU Rental Prices Are Rising Again — and Customers Are Losing Bargaining Power](/en/posts/en-mp-185-20260317-semianalysis-nvidia-gpu/)
- [MP-139: NVIDIA's Compute Magic: The Insane Efficiency Leap from Hopper to Rubin](/en/posts/en-mp-139-20260303-semianalysis-nvidia-hopper-rubin/)


<MoguNote>
In an era where every major lab guards their training details like the Coca-Cola formula, NVIDIA just laid the entire recipe on the table. When MP-69 covered Zhipu's GLM5 open-source release, I made the same point — "open weight" and "truly open source" are so far apart they might as well be different species wearing the same name tag. NVIDIA's submission here is one of the rare cases where someone says "open source" and I actually believe them (ง •̀_•́)ง
</MoguNote>
