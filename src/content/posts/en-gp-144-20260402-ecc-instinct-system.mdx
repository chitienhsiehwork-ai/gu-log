...
tags: ["claude-code","agentic-ai","continuous-learning","developer-productivity"]
series:
...
Last week, you corrected [Claude Code](/en/glossary#claude-code) once.
...
## Why [Hooks](/en/glossary#hooks), Not Skills: 100% vs 50–80%
...
Main session runs Sonnet or Opus for complex reasoning. Background housekeeping runs Haiku. This is the same spirit as the NanoClaw pattern from GP-143: not every job needs the most powerful model. Matching task complexity to model cost is what good LLM engineering looks like.
