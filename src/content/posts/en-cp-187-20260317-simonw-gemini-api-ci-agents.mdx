...
[Simon Willison](/en/glossary#simon-willison) shared a post from the Gemini team, and the message is simple: **Gemini API now supports spend caps.** Doesn't sound sexy, but if you've ever run LLMs in automated workflows, you know exactly why this matters (￣▽￣)／
...
- [SP-114: Building Software for Trillions of Agents: Aaron Levie on the Great Infrastructure Remodel](/en/posts/en-sp-114-20260315-levie-building-for-trillions-of-agents/)
