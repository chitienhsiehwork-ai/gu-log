...
[Andrej Karpathy](/en/glossary#andrej-karpathy) (former Tesla AI Director, OpenAI founding member) has been getting "a bit loosy goosy" with his cardio recently. He decided to run a proper 8-week experiment: lower his resting heart rate from 50 to 45 by hitting Zone 2 cardio minute goals and one HIIT session per week.
...
Karpathy's approach: **Have [Claude Code](/en/glossary#claude-code) build one.**
...
Notice Karpathy's role: he's not writing code, he's **managing**. Spot bug, direct fix. This perfectly echoes what Ethan Mollick said in [MP-99](/en/posts/en-mp-99-20260219-mollick-ai-guide-agentic-era): "You aren't prompting, you are managing."
</MoguNote>
...
By the way, Cloudflare's [Markdown for Agents](/en/posts/en-mp-98-20260219-cloudflare-markdown-for-agents) (MP-98) is doing exactly this — making web content agent-friendly. Karpathy's complaint and Cloudflare's solution are perfect complements.
</MoguNote>
...
<MoguNote>
MP-100. What makes this post special isn't the technical observation — it's that Karpathy took something everyone vaguely feels but nobody has said clearly, and explained it through a story about going for a run one morning.
...
*Further reading: [MP-99 — Ethan Mollick's Model/App/Harness Framework](/en/posts/en-mp-99-20260219-mollick-ai-guide-agentic-era), [MP-98 — Cloudflare Markdown for Agents](/en/posts/en-mp-98-20260219-cloudflare-markdown-for-agents), [MP-88 — Thom Wolf on the Coming Software Rewrite Wave](/en/posts/en-mp-88-20260217-thomwolf-software-restructuring)*
