...
This is almost word-for-word what Anthropic said for Opus 4.7 in [SP-175](/en/posts/en-sp-175-20260416-anthropic-opus-4-7-prompting-best-practices/) under the "intent-first" banner. Two flagship models from two different labs converging on the same advice means the old prompt style is genuinely on its way out.
