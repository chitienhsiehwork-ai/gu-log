...
But [Simon Willison](/en/glossary#simon-willison) — the Django co-creator, open source veteran — just said something on X that should make every experienced developer pause:
...
It began with Alex Albert from Anthropic. He posted that his biggest shift from using [Claude Code](/en/glossary#claude-code) was:
