...
[Simon Willison](/glossary#simon-willison) 轉了一則 Gemini 團隊的消息，一句話講完：**Gemini API 現在可以設 spend caps 了。** 聽起來不怎麼性感，但如果你有在自動化流程裡跑 LLM，你懂的 (￣▽￣)／
...
**Agents** —— 更可怕。[Agent](/glossary#agent) 的核心邏輯就是「試到對為止」，它會 loop、會 retry、會自己決定要多呼叫幾次。你根本不知道它什麼時候會突然勤勞起來。
