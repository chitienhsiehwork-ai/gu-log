...
你有沒有遇過這種情況：丟一個 Obsidian vault 給 [Claude Code](/glossary#claude-code)，然後它就開始瘋狂讀檔案，像吃到飽自助餐一樣每道菜都夾，結果還沒做完事情 context window 就炸了？
...
如果你有在用 [MCP](/glossary#mcp)（Model Context Protocol），你會發現這結構似曾相識。
