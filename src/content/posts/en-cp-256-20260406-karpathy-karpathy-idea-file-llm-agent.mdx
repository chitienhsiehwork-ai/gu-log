...
A GitHub Gist titled **LLM Wiki**, containing zero lines of runnable code. Just concepts, architecture, and workflows. Karpathy's argument: in the age of [LLM agents](/glossary#agent), sharing finished code matters less and less — the recipient's agent will rebuild everything from scratch based on its own needs. What's actually worth sharing is the **idea itself**.
