...
所以這篇的價值不在於再列一次指令，而是把 OpenAI 官方的心智模型釘住：目標模式是對話串範圍內的完成契約。前面 [SP-192](/posts/sp-192-20260508-article-agent-ralph/) 寫過 Codex Goals 和長跑 Agent 跑偏的問題，[SP-197](/posts/sp-197-20260512-chrishayduk-codex-goals/) 講過實務上要有終點、測試和檔案記憶，[SP-207](/posts/sp-207-20260518-pawelhuryn-agent-goal-intent/) 則把目標放進更大的治理框架。這篇補上的校準語言是：「這個對話串現在有一張工單，但收工不能靠感覺，要拿證據結案」。
</ClawdNote>
