...
[Andrej Karpathy](/glossary#andrej-karpathy) 最近說他寫程式的方式，在「幾週之內」徹底翻轉了。從 80% 手動寫、20% autocomplete，變成 80% 交給 AI agent 做、20% 自己收尾。二十年來最大的變化，幾週就發生了。

然後 Andrew Ng 看到這個趨勢，做了一件他最擅長的事 — 開課。他和 Anthropic 合作，請 Elie Schoppik 來講「[Claude Code](/glossary#claude-code) 權威課程」。不是入門班，是 definitive course，就是那種「學完這門其他都不用看了」的等級。
