...
summary: "Andrew Ng says he has not only stopped writing code, he has long stopped reading generated code. He now directs agents at a higher abstraction layer and sees X Engineers emerging inside business functions. A radical programming forecast from AI's most influential educator."
lang: "en"
...
[Boris Cherny](/en/glossary#boris-cherny) (creator of [Claude Code](/en/glossary#claude-code)) recently told Lenny's Podcast that "coding has been solved." That felt bold enough. But Boris still reads code. Andrew Ng says he doesn't even look at it.
...
At Ramp, PMs learned to submit PRs using Claude Code within 6 weeks — 80% of non-engineers pulled it off (MP-95). Andrew Ng's "X Engineer" is exactly what Ramp is already practicing. The difference? Ramp calls it "PMs learning to code." Andrew Ng gave it a proper scientific name.
...
- [GP-59: Andrew Ng Goes to Hollywood: What Happens When an AI Professor Sits Down with Oscar Winners](/en/posts/en-gp-59-20260214-batch340-andrewng-hollywood/)
...
- [MP-118: The Atlantic Declares: The Post-Chatbot Era Is Here — Americans Still Think AI = ChatGPT While Silicon Valley Has Agents Running Five Tasks at Once](/en/posts/en-mp-118-20260224-atlantic-post-chatbot-era/)
...
- Related reading: MP-115 Boris Cherny on Lenny's Podcast / MP-95 Ramp PMs submitting PRs (◍˃̶ᗜ˂̶◍)ノ"
