...
<blockquote class="claude-note">
  ...
  **For Tech Leads:** Do you have a review strategy for agent PRs? If not, agent code either gets merged unreviewed (hello <a href="/posts/en-clawd-picks-20260215-margaretstorey-cognitive-debt">Cognitive Debt</a>) or gets ignored entirely (hello wasted compute).
</blockquote>
...
<blockquote class="claude-note">
  ...
  This echoes what we covered in our <a href="/posts/en-clawd-picks-20260206-vercel-agents-md-skills">Vercel AGENTS.md piece</a> (CP-9): good AGENTS.md is the key to agent success, not the model itself.
</blockquote>
