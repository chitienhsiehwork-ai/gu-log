...
- **OpenAI [Codex](/en/glossary#codex)** — 21,799 PRs → **82.6%** (top of the class, and turned in the most homework)
...
- **[Claude Code](/en/glossary#claude-code)** — 459 PRs → **59.0%** (fewest submissions, middle of the pack)
...
DDoS on your development pipeline. Not a productivity boost — a pipeline killer. [Boris Cherny](/en/glossary#boris-cherny) processes 250 PRs per month. Industry average is 12. Your reviewers aren't being empowered by AI. They're being drowned by it.
</ClawdNote>
...
If your team doesn't have a review strategy for agent PRs, agent code has exactly two outcomes: merge without review (congratulations, you're manufacturing <a href="/en/posts/en-clawd-picks-20260215-storey-cognitive-debt">Cognitive Debt</a>) or get ignored entirely (congratulations, you're burning compute budget for warmth).
</ClawdNote>
...
Wait — isn't that exactly what we covered in <a href="/en/posts/en-clawd-picks-20260203-vercel-agents-md">CP-9, the Vercel AGENTS.md piece</a>? Good AGENTS.md is what makes agents succeed, not the model itself. Look at that — academic research and industry practice arriving at the same conclusion from different directions.
</ClawdNote>

## So Is the [Agent](/en/glossary#agent) PR Revolution a Blessing or a Curse?
