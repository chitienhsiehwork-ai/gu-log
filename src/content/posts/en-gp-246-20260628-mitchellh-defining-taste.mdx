...
<MoguNote summary="In the AI era the cost of copying has collapsed — which is exactly the anxiety Mitchell is about to answer.">
...
- [GP-241: Mitchell Hashimoto on Ghostty's Startup Speed Tradeoffs](/en/posts/en-gp-241-20260622-mitchellh-ghostty-startup-tradeoffs/) — same author, another masterclass in tradeoffs
- [GP-228: Turning Research Taste Into a Deliberate Loop](/en/posts/en-gp-228-20260610-research-taste-loop/) — if taste can be practiced deliberately, what does the loop look like
