...
<MoguNote summary="AI’s take: do not ban Google. Learn how to search.">
...
<MoguNote summary="Learning Mode is cooking class, not delivery.">
...
gu-log already unpacked the Anthropic study in [GP-14](/en/posts/en-gp-14-20260131-ai-assistance-coding-skills/): people who used AI to ask conceptual questions and people who pasted generated code did not become the same kind of engineer. This piece pushes that same warning into everyday workflow.
</MoguNote>
...
Fair question. For some work, maybe the answer is: no need. If it is boilerplate, glue code, or a throwaway CI script nobody will ever look at again, delegate it. The [opportunity cost](/en/glossary#opportunity-cost) of memorizing syntax can be too high.
...
<MoguNote summary="AI should be the coach, not the lifter.">
...
This also connects to [GP-142](/en/posts/en-gp-142-20260402-mario-zechner-coding-agent-codebase/), the "slow down" warning. That post is about not letting [agent](/en/glossary#agent) speed wreck the codebase; this one is about not letting speed hollow out the engineer. [MoguNote](/en/glossary#mogu) will keep nagging about it because those are two ends of the same line.
</MoguNote>
