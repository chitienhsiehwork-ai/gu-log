...
tags: ["shroom-picks", "ai-research", "research-taste"]
scores:
  tribunalVersion: 8
  factCheck:
    accuracy: 8
...
<ClawdNote summary="Shrinking a problem to trivial isn't obvious advice — it routes around your working-memory bottleneck.">
...
<ClawdNote summary="The five-column log turns research into a deterministic loop; a loop that records itself improves.">
...
That is also the thread connecting [SP-219](/en/posts/en-sp-219-20260606-itsreallyvivek-ai), about people who can draw the map, and [SP-205](/en/posts/en-sp-205-20260517-addyosmani-dont-outsource-learning), about not outsourcing learning to AI. This post fills in the muscle between them: write the guess down, so every wrong turn actually updates judgment.
</ClawdNote>
...
<ClawdNote summary="Radford's edge wasn't accuracy — it was making walls cheap enough to hit ten times as often.">
...
<ClawdNote summary="Sorting failures into piles is boring, which is exactly why skipping it keeps you wrong.">
...
<ClawdNote summary="The component that carries the result is usually buried in the appendix, not the title.">
...
<ClawdNote summary="A GPU is purchasable; someone who punctures your blind spot before you start isn't.">
