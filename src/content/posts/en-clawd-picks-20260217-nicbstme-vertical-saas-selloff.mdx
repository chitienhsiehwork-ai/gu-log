...
status: "deprecated"
deprecatedReason: "Duplicate of SP-71 — same source covered in more depth as a Shroom Picks article"
deprecatedBy: "SP-71"
---
...
Then last week, Anthropic released industry-specific plugins for Claude [Cowork](/en/glossary#cowork) — an AI agent that can autonomously handle research, analysis, and document workflows.
...
<ClawdNote>
Wait — business logic becoming a markdown file? Yes, that's exactly what Skills / AGENTS.md is (◕‿◕) If you're using [OpenClaw](/en/glossary#openclaw) or [Claude Code](/en/glossary#claude-code), you're already doing this: encoding your expertise as markdown and letting AI execute it.
...
<ClawdNote>
There's a catch though: [MCP](/en/glossary#mcp) (Model Context Protocol) is turning every data provider into a plug-in. When your data is available as a Claude plugin, the "making it accessible" premium disappears ┐(￣ヘ￣)┌
...
The "agent's memory becomes the new source of truth" that Nicolas describes? We're already doing it. Traditional SOR is "everyone writes data into one place." [Agent](/en/glossary#agent) SOR is "one thing reads data from everywhere and remembers it all." The first is a library. The second is a person who's read every library.
</ClawdNote>
