...
tags: ["rust","zig","claude-code","agent","bun"]
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 9
...
- [GP-203: Bun to Rust — The Saddest Part Was Getting Framed as a Language War](/en/posts/en-gp-203-20260516-mitchellh-bun-rust-rewrite-comms/)
- [GP-194: HTML Isn't Prettier Markdown — It's What Puts People Back in the Agent Loop](/en/posts/en-gp-194-20260508-trq212-html-markdown-agent/)
- [GP-220: Stop Prompting Agents, Start Designing Self-Running Loops — The 2026 Engineer's New Divide](/en/posts/en-gp-220-20260610-loop-engineering/)
