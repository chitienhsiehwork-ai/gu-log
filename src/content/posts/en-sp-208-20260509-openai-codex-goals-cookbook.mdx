...
Codex Goals have a cleaner definition than the hype usually gives them. A Goal is not just a longer [prompt](/en/glossary#prompt), and it is not an agent roaming freely in the background. It is a completion contract attached to a thread: what should be true, what evidence should prove it, and which constraints must stay intact.
