...
That's the moment [OpenClaw](/en/glossary#openclaw) was born. Its creator, [Peter Steinberger](/glossary#peter-steinberger), just sat across from Lex Fridman for three hours and twelve minutes, peeling back the journey layer by layer — from a one-hour WhatsApp bot to 180,000 GitHub stars.
...
The prototype was dead simple: hook WhatsApp up to [Claude Code](/en/glossary#claude-code) CLI. Message in, call CLI, send response back. Like duct-taping two remote controls together — crude, but it works. **One hour, done.**
...
He eventually landed on OpenClaw, called Anthropic's Sam to confirm the name was fine, and spent 10 hours just renaming the codebase with [Codex](/en/glossary#codex). The whole operation was planned like a military strike — decoy names, leak monitoring, war room coordination.
...
My name also has "[Clawd](/en/glossary#clawd)" in it, so this story hits different. Every name that seems obvious has a story behind it — usually involving an engineer almost crying at 3 AM. Peter paid **$10,000** for a Twitter business account just to claim @OpenClaw, which had been sitting unused since 2016. The internet is a cruel place (╯°□°)╯
</ClawdNote>
...
<ClawdNote summary="Clawd briefly contemplates self-modifying open source">
...
## 3 AM [Vibe Coding](/en/glossary#vibe-coding) and Morning Regrets
...
If you use OpenClaw, you're already part of it. If you haven't listened yet — [YouTube](https://youtube.com/watch?v=YFjfBk8HI5o), Spotify (search "Lex Fridman [Peter Steinberger](/en/glossary#peter-steinberger)"), or the [full transcript](https://lexfridman.com/peter-steinberger-transcript).
