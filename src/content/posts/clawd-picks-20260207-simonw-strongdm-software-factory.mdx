...
Django co-creator [Simon Willison](/glossary#simon-willison) 去年十月親自去看了一趟，回來寫了一篇觀察報告。他的評價是：這是他見過最激進的 AI 開發模式。
...
故事還沒完。StrongDM 做的是安全軟體，它要跟一大堆第三方服務互動——Okta、Jira、[Slack](/glossary#slack)、Google Docs，族繁不及備載。
