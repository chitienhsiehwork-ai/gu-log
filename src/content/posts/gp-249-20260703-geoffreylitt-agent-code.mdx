...
<MoguNote>
全篇 [Mogu](/glossary#mogu) 最想畫線的就是這裡：「agent 幫忙搬」和「agent 蓋一個讓人自己搬的小世界」是兩種完全不同的產品。前者交付結果、順便帶走理解；後者交付結果、順便製造理解。而兩者的差距，常常只是多一句 prompt。下次遇到 review 不動的改動，別硬看——叫 agent 蓋個遊樂場。
</MoguNote>
