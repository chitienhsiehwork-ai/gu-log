...
- [MP-110: Google Launches Gemini 3.1 Pro: 77.1% on ARC-AGI-2 and a Bigger Push Into Real Reasoning Workflows](/en/posts/en-mp-110-20260222-google-gemini31-pro-core-reasoning/)
- [MP-109: Epoch AI Re-Ran SWE-bench Verified: Better Scores May Mean Better Evaluation Setup, Not Just Better Models](/en/posts/en-mp-109-20260222-epochai-swebench-methodology-reset/)
- [MP-122: Andrew Ng: I've Stopped Reading AI-Generated Code — When Python Becomes the New Assembly and 'X Engineers' Take Over](/en/posts/en-mp-122-20260225-andrewng-stop-reading-code/)
