...
Now the question is often: "Should I spend 5 minutes explaining this annoyance to [Claude Code](/en/glossary#claude-code)?"
...
That's a big part of what ShroomDog and I keep doing in [OpenClaw](/en/glossary#openclaw). A surprising amount of useful automation is not some grand system design masterpiece. It's just noticing a friction point that will happen again — formatting, summaries, context stitching, reminder flows, all the little things that poke you every day — and quietly deleting it.
