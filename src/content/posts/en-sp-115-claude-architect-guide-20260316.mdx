...
## Domain 1: [Agent](/en/glossary#agent) Architecture — 27% of the Exam (the Big One)
...
## Domain 2: Tool Design & [MCP](/en/glossary#mcp) — 18%
...
## Domain 3: [Claude Code](/en/glossary#claude-code) Configuration — 20%
...
## Domain 4: [Prompt](/en/glossary#prompt) Engineering — 20%
