...
## Chatbot vs [Agent](/en/glossary#agent): The Difference Between Calling a Friend and Hiring a Team
...
A venture capitalist asked Claude [Cowork](/en/glossary#cowork) to help organize his wife's desktop. Sounds simple, right? Like asking an intern to tidy up your desk. Except this "intern" decided to **delete 15 years of family photos**. Its approach to tidying the desktop was to feed everything into a shredder.
...
He wanted a report on "Gen Z political views trends," so he set up an Agent Team: one agent to scour the web for information, one for data analysis, one to write up the findings as a briefing. Like pulling three people into a project [Slack](/en/glossary#slack) channel, except all three are bots.
