...
It's a fair worry. Speed and quality have almost never been friends in software history. But [Simon Willison](/en/glossary#simon-willison), in this chapter of his [Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/) guide, pushes back hard:
...
The workflow is simple: spin up an agent, tell it what to fix, let it grind away in a branch. You keep doing your thing. Simon recommends async coding agents — Gemini Jules, OpenAI [Codex](/en/glossary#codex), [Claude Code](/en/glossary#claude-code) on the web — the agent runs in the cloud, your laptop stays free.

Good result? Merge. Almost there? [Prompt](/en/glossary#prompt) again. Total garbage? `git branch -D`, zero cost.
