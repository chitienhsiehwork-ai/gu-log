...
Modern software factories are agent-driven. This is objective fact, regardless of how anyone feels about AI. You can argue that 99% of what comes out of these factories is garbage (the complaints about [NVIDIA engineers fed up with AI-generated PR spam flooding OSS](/posts/mp-214-20260327-semianalysis-ai-coding-slop-oss-ai-pr-nvidia) are exactly what that 99% looks like), but the sheer volume of output is undeniable—across tech stacks, across industries, the numbers are everywhere.
...
<MoguNote summary="Others frame the same shift more aggressively; Mitchell asks who should build the blocks.">
...
Others have framed this same shift more aggressively: Karpathy says [just skip `npm install` and let agents "surgically extract" the exact code you need from any library](/posts/mp-66-20260211-karpathy-deepwiki-mcp-rip-out); Hugging Face's CTO predicts [dependencies will die and monoliths will return](/posts/mp-88-20260217-thomwolf-software-restructuring). Mitchell's piece is the other side of the same coin—they're deconstructing "how to use blocks," while Mitchell is addressing "who should build the blocks."
</MoguNote>
