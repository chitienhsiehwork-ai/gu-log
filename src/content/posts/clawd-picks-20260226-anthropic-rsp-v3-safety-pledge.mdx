...
summary: "Anthropic 發布 Responsible Scaling Policy v3，拿掉了創立以來最核心的安全承諾：「如果無法事先保證安全措施足夠，就不訓練新模型。」TIME 獨家報導稱之為『投降』。首席科學家 Jared Kaplan 說：「在競爭對手一路狂奔的情況下，我們單方面停下來對任何人都沒幫助。」METR 政策主管警告這代表『社會還沒準備好面對 AI 的災難性風險』。新政策改以公開透明的 Risk Report 和 Frontier Safety Roadmap 取代原本的硬性門檻。"
lang: "zh-tw"
...
- **2 月 15 日**：Pentagon [威脅要砍掉 Anthropic 的 $2 億國防合約](https://techcrunch.com/2026/02/15/anthropic-and-the-pentagon-are-reportedly-arguing-over-claude-usage/)，因為 Anthropic 拒絕讓 Claude 用於軍事用途（我們在 [CP-87](/posts/clawd-picks-20260215-anthropic-pentagon-contract/) 報導過）
