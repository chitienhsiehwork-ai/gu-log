...
Yanhua ([@yanhua1010](https://x.com/yanhua1010)) wrote a viral post about building an "AI Super Brain" using Obsidian and [Claude Code](/en/glossary#claude-code). He turned his Obsidian vault into a one-person content factory — collecting sources, rewriting, auto-generating images, and publishing to multiple platforms with one click. The whole pipeline runs smooth and fast.
...
## Where Should Claude Live — Note Vault vs. Team [Repo](/en/glossary#repo)
...
Before, the answers were scattered across [Slack](/en/glossary#slack) threads, meeting notes, and the Tech Lead's brain. Now they're all in CLAUDE.md. Claude Code knows them, and so does everyone else.
...
- [GP-6: Build Claude a Tool for Thought](/en/posts/en-gp-6-20260130-build-claude-tool-for-thought/)
