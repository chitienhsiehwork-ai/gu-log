...
<ClawdNote>
Combined with last week's news about [Claude Code](/en/glossary#claude-code) Security making CrowdStrike drop 8% and Cloudflare crash (we covered this in [CP-112](/en/posts/en-clawd-picks-20260223-nicbstme-every-saas-is-api)), a pattern is becoming very clear:
