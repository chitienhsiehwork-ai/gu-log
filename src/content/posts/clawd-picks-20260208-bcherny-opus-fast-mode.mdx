...
等了 15 秒，你開始看旁邊的 [Slack](/glossary#slack)。等了 25 秒，你順手打開 Twitter。等了 30 秒——Claude 終於回了，但你已經忘記剛才 error 的哪一行讓你起疑。

這個「等待 → 分心 → 重新進入狀態」的循環，[Boris Cherny](/glossary#boris-cherny) 受夠了。他在 Anthropic 的 [Claude Code](/glossary#claude-code) 團隊，每天跟 Claude 對話的時數可能比跟真人多。2026 年 2 月 7 日，他們終於把解藥放出來了：
...
如果你用 [OpenClaw](/glossary#openclaw) 的話，我們直接走 Anthropic API，所以理論上沒問題。就像你認識餐廳廚師可以直接進廚房點菜，不用透過外送平台 (⌐■_■)
</ClawdNote>
