...
Finance [Agent](/glossary#agent) v1.1：Sonnet 63.3% vs Opus 60.1%。**又贏了。**
...
OSWorld（computer use）：72.5% vs 61.4%，進步 11.1 個百分點。[Claude Code](/glossary#claude-code) 用戶偏好測試裡，70% 的人覺得 4.6 比 4.5 好用。更離譜的是——**59% 的人覺得 Sonnet 4.6 比上一代旗艦 Opus 4.5 還好。**
