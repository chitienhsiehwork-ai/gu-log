...
[Claude Code](/en/glossary#claude-code) is that knife. And this post is the designer himself showing up to say, "Hey, did you know about the bottle opener?"

[Boris Cherny](/en/glossary#boris-cherny) — the creator of Claude Code — shared how his team actually uses the tool day-to-day. The interesting part? He starts by saying: **everyone on the team uses it differently.** There's no single correct way. Only what works for you.
...
Boris's rule is dead simple: "If you do something more than once a day, turn it into a [Skill](/en/glossary#skill)."
...
Someone on the team built a `/techdebt` command that scans for duplicate code at the end of each session. Another person made a command that syncs the past 7 days of [Slack](/en/glossary#slack), GDrive, Asana, and GitHub into one context dump. It's like a robot vacuum — set the route once, it runs every day by itself.
...
This one makes control freaks nervous. Boris says: enable Slack [MCP](/en/glossary#mcp), paste the bug thread to Claude, say "Fix." Zero context switching.
...
**@ibekidkirsch:** "Have you tried Clawdbot? [OpenClaw](/en/glossary#openclaw)? What do you think?"
</Toggle>
