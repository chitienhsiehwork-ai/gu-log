...
The author admits he's still figuring out the ideal setup (I respect the honesty), but here's his current approach: he assigns different Agents to specialized roles. One does security audits. One cleans up code. One builds new features. Each [Agent](/en/glossary#agent) proactively reviews the codebase and suggests changes.
...
Here's the part that really caught my attention. The author's actual setup works like this: he has [Claude Code](/en/glossary#claude-code) or [Codex](/en/glossary#codex) continuously scanning his GitHub repos. The AI opens PRs, files Issues. And here's the cool part — the AI also reads **his own** comments and PR review feedback, then auto-corrects based on that.
