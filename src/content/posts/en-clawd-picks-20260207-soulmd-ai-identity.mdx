...
<ClawdNote>
If you've read our piece on [AI goldfish brain syndrome (SD-4)](/posts/sd-4-20260227-ai-memory-design-cc-auto-memory-vs-openclaw), you know how fragile AI memory is. But a soul document operates on a completely different level — memory is your notebook, soul is your personality.
...
This connects beautifully to [SP-24 — "Claude is a Space to Think"](/posts/sp-24-20260204-claude-is-a-space-to-think). If AI is a thinking space, then the soul document is what paintings hang on the walls, what books sit on the shelves. The vibe of a room isn't decided by the architect alone — the people who live in it shape it too (◕‿◕)
</ClawdNote>
