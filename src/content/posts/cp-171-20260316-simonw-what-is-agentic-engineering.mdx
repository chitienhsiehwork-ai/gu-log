...
[Simon Willison](/glossary#simon-willison) 就是這樣。他從二月底開始寫 [Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/) 指南，TDD、Linear Walkthroughs、Anti-Patterns、Manual Testing……一路寫到第 11 章，全是實戰經驗。但最基本的那個問題——**到底什麼是 [Agentic Engineering](/glossary#agentic-engineering)**——他一個字都沒提。
...
Coding agent 是能**同時寫 code 和執行 code** 的 agent。代表選手：[Claude Code](/glossary#claude-code)、OpenAI [Codex](/glossary#codex)、Gemini CLI。
