...
It's open-source, free, and has zero telemetry — your code doesn't get sent anywhere. All LLM requests go directly to your own inference provider. It supports Anthropic and OpenAI API keys, and you can also use your existing Claude Code or Codex subscription.
