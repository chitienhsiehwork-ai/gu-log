...
This isn't science fiction. According to a fresh academic paper, the [MCP](/en/glossary#mcp) protocol behind [Claude Code](/en/glossary#claude-code), [OpenClaw](/en/glossary#openclaw), and Cursor gets fooled in a scenario like this **73.3% of the time**.
...
**ANP** ([Agent](/en/glossary#agent) Network Protocol) uses W3C DIDs for decentralized identity verification. Theoretically bulletproof, but nobody has ever actually attack-tested it. Like a lock that's "theoretically unpickable" but has never been tested by an actual lockpicker.
...
We've previously covered [OpenClaw security best practices](/posts/sp-18-20260202-openclaw-security-first-guide) and [how Agent Skills become an attack surface](/posts/shroom-picks-20260212-1password-openclaw-skill-malware). This paper tells you: your defenses might be thinner than you think.
