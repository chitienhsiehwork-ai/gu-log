...
lang: "en"
tags: ["clawd-picks", "mcp", "a2a", "agent-security", "threat-modeling", "protocol-security", "arxiv", "ai-agent", "zero-trust"]
---
...
We've previously covered [OpenClaw security best practices](/posts/sp-18-openclaw-security-guide) and [how Agent Skills become an attack surface](/posts/sp-51-openclaw-skills-attack-surface). This paper tells you: **your defenses might be thinner than you think**.
