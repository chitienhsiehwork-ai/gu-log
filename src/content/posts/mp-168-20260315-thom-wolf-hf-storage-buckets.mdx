...
<MoguNote>
Thomas Wolf 用 "fastest growing" 來形容 Storage Buckets，這措辭值得注意。不是 "most popular"、不是 "most requested"，是成長最快。意思是：這東西上線之後需求噴出來的速度，連他們自己可能都沒預料到。AI 圈現在的瓶頸不在算力，不在模型，在「資料放哪裡」這種最無聊但最致命的問題上。跟 MP-89 那篇聊 inference cost 的邏輯一樣 —— 大家都盯著模型跑分，結果最後卡住你的永遠是那些不 sexy 的基礎設施 ┐(￣ヘ￣)┌
</MoguNote>
...
<MoguNote>
這讓我想到一件事。你知道為什麼 AWS 靠 S3 賺到翻掉嗎？不是因為 S3 技術多厲害，是因為每個人都有東西要放，而且放了就拿不走。Hugging Face 現在做的事，味道非常像年輕時期的 AWS —— 先用免費模型把人圈進來，然後讓你的資料住進來。資料一旦住進來，搬家成本就是你的續約保證金。MP-85 那篇 Yegge 的 AI Vampire 文章講過類似的 pattern：平台的護城河不是技術多猛，是你的東西搬不走 (⌐■_■)
</MoguNote>
...
<MoguNote>
這就是科技圈最經典的劇本 —— 越無聊的基礎設施越賺錢。沒人會說「哇 S3 好酷喔」，但 AWS 一半的利潤都從那裡來。Hugging Face 顯然也看懂了這個劇本。當你的平台上所有人都在煩「資料要放哪」的時候，賣倉庫比賣食譜更賺。MP-49 那篇講 OpenAI 的 enterprise platform 策略也是同一套路 —— 先當工具，再當平台，最後當 infra ╰(°▽°)╯
</MoguNote>
...
- [MP-88: Hugging Face CTO 預言：Monolith 回歸、Dependency 滅亡、Strongly Typed 語言崛起 — AI 正在重寫軟體世界的結構](/posts/mp-88-20260217-thomwolf-software-restructuring/)
- [MP-138: AI 算力租賃的隱藏下半場：5年合約到期後會發生什麼事？](/posts/mp-138-20260302-semianalysis-ai-5/)
- [MP-178: AI 實驗室的新戰場：搶著幫私募股權公司取消軟體授權？](/posts/mp-178-20260317-dee-bosa-openai-pe-saas/)
