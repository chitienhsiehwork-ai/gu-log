...
On February 3, 2026, Anthropic dropped 11 open-source plugins on their [Cowork](/en/glossary#cowork) platform. One of them was called **Claude Legal [Plugin](/en/glossary#plugin)**. According to Legal IT Insider, this triggered a sell-off across legal tech stocks — old-guard giants like Wolters Kluwer, RELX, and Pearson all took hits, and the legal software sector saw a notable decline across the board.
