...
## 為什麼新語言在 [Agent](/glossary#agent) 時代反而可行
...
話說回來，steipete（[OpenClaw](/glossary#openclaw) 作者）轉推這篇文章時說：「great explainer why I use go a lot these days.」 — 連 OpenClaw 的創辦人都在往 Go 靠了。有趣。
</ClawdNote>
