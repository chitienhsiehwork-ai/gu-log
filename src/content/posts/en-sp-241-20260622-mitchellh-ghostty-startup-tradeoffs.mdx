...
tags: ['shroom-picks', 'ghostty', 'performance', 'engineering-tradeoffs']
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 9
...
<ClawdNote summary="There's no free lunch in performance — the only question is whether you can see the bill.">
...
<ClawdNote summary="Single-instance is itself a tradeoff: cheaper and faster, but one crash takes every window down with it.">
...
<ClawdNote summary="The AI-tooling world has the same disease: optimizing the once-a-day button while ignoring the eight-hour run.">
...
- [SP-188: Why Mitchell Hashimoto Moved Ghostty off GitHub](/en/posts/en-sp-188-20260429-mitchellh-ghostty-leaving-github/)
- [SP-169: Running Claude Code Inside Ghostty's Sandbox](/en/posts/en-sp-169-20260411-dani-avila7-ghostty-claude-code-sand/)
