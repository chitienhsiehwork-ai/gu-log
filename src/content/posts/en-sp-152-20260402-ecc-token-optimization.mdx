...
Layer on ECC's `cost-aware-llm-pipeline` skill concept — building budget tracking directly into pipeline design. The idea is similar to [hooks](/en/glossary#hooks) — [SP-146's Hook Architecture](/posts/sp-146-20260402-ecc-hook-architecture/) inserts automated behavior at key pipeline nodes; this inserts cost awareness at the same nodes.
