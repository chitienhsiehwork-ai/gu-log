...
（相關閱讀：[Karpathy 用 8 個 AI Agent 組研究團隊](/posts/mp-135-20260301-karpathy-multi-agent-research-org)踩到的坑，和 [Anthropic 的 multi-agent 設計哲學](/posts/gp-132-20260327-anthropic-multi-agent-harness-design)——不同切入角度，同樣的核心問題。）
