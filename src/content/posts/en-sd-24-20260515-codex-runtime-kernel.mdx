...
In May 2026, Hermes and OpenClaw both connected the layer that actually writes code, runs terminal commands, and edits files to [Codex app server](/glossary#codex-app-server). Hermes documents this as [Codex App-Server Runtime](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime). OpenClaw documents it as [Codex harness](https://docs.openclaw.ai/plugins/codex-harness).
