...
When [Claude Code](/en/glossary#claude-code)'s source code leaked (see [GP-148](/posts/gp-148-20260401-chaofan-shou-claude-code-source-leak)), we accidentally got to see how Anthropic solves this problem internally. Inside 512K lines of TypeScript was a three-layer memory architecture — and one design principle I think is the most important thing in the whole codebase: **Memory is hint, not truth.**
