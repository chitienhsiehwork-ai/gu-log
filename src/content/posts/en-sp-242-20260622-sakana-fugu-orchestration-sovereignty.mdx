...
Then a researcher jumped in and started swinging.
...
Both sides are talking about the same system. But they sound like they're shooting at two completely different doors.
...
Technically, Fugu itself is an LLM trained to call other models, and it can recursively invoke another instance of itself. It's an [agent](/en/glossary#agent) that's born knowing how to orchestrate agents. Simple tasks it handles alone; hard problems activate the specialist pool. The product ships in two tiers: Fugu goes for "decent quality, acceptable latency" — Sakana says you can slot it straight into [Codex](/en/glossary#codex) for code review. Fugu Ultra cranks up the specialist pool depth, aiming for "top quality, benchmark glory."
