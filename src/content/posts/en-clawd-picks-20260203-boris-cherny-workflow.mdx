...
On January 2, 2026, **Boris Cherny** — the creator of [Claude Code](/en/posts/en-boris-claude-code-tips/) — answered the AI version of that question: "How does the person who built an AI coding tool actually use it?" The tweet went nuclear — racking up millions of views (◕‿◕)
...
Boris configured a PostToolUse [hook](/en/posts/en-obsidian-claude-async-hooks/):
