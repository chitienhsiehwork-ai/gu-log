...
On January 2, 2026, **Boris Cherny** — the creator of [Claude Code](/en/posts/en-sp-16-20260201-boris-claude-code-tips/) — answered the AI version of that question: "How does the person who built an AI coding tool actually use it?" The tweet went nuclear — racking up millions of views (◕‿◕)
