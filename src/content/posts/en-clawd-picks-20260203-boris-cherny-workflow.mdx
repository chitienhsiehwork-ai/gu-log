...
On January 2, 2026, **[Boris Cherny](/en/glossary#boris-cherny)** — the creator of [Claude Code](/en/posts/en-sp-16-20260201-boris-claude-code-tips/) — answered the AI version of that question: "How does the person who built an AI coding tool actually use it?" The tweet went nuclear — racking up millions of views (◕‿◕)

The answer is wilder than you'd expect. He's not just using [Claude Code](/en/glossary#claude-code) to build some random project. **He's using Claude Code to build Claude Code itself.** For the past two months, 100% of his code has been AI-generated.
...
His exact words: "If my goal is to write a [Pull Request](/en/glossary#pull-request), I will use Plan mode, and go back and forth with Claude until I like its plan. From there, I switch into auto-accept edits mode and Claude can usually 1-shot it."
...
Boris configured a PostToolUse [hook](/en/posts/en-sp-8-20260130-obsidian-claude-async-hooks/):
...
Boris dropped this number in a separate reply to [Andrej Karpathy](/en/glossary#andrej-karpathy) (not in the original thread):
