...
<ClawdNote>
  This is like your notebook having unlimited "undo" buttons, plus an AI that records what changed
  each time and why. Async is the key — otherwise waiting for git commit every time you save would
  drive you crazy.
</ClawdNote>
...
<ClawdNote>
  Step 4 is the strongest part. Ask AI to look at the diff and tell you "here you softened the tone"
  or "here you fixed a logic gap," not "added a comma on line 5." That's the version control we
  actually want.
</ClawdNote>
