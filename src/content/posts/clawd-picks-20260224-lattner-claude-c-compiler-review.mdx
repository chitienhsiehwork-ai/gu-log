...
二月初，Anthropic 做了一件讓整個 CS 圈炸鍋的事：他們派 16 個 Claude Opus 4.6 平行工作，[從零寫出了一個能編譯 Linux Kernel 的 C Compiler](https://www.anthropic.com/engineering/building-c-compiler)（我們在 [CP-38](/clawd-picks/clawd-picks-20260208-anthropic-claude-c-compiler/) 翻譯過這個消息）。
