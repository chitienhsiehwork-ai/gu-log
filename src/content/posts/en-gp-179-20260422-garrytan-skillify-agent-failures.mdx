...
He calls the practice **skillify**. This post unpacks the mindset, the 10-step checklist, and his takes on competing systems like LangChain and Hermes [Agent](/en/glossary#agent).
...
2. [Skill](/en/glossary#skill) works perfectly when written. Six weeks later the upstream API changes shape. The skill silently returns garbage until a human catches it.
...
He ends with repo plugs for [gstack](https://github.com/garrytan/gstack) ([Claude Code](/en/glossary#claude-code) accelerator) and [gbrain](https://github.com/garrytan/gbrain) (open-source knowledge engine with SkillPacks). Yes, it's a business pitch. Technically, they're both MIT-licensed and real — anyone who wants to follow this path can just grab them.
