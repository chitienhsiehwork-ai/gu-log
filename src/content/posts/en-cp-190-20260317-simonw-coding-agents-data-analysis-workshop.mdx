...
Now [Simon Willison](/en/glossary#simon-willison) says: hey, you can just ask an AI agent to do that for you.

And he's not just talking about it — he dropped the full handout from his three-hour workshop, right there on Twitter.

The handout comes from NICAR (National Institute for Computer-Assisted Reporting), which is basically the annual pilgrimage for data journalists across the US. Simon taught a three-hour session on using coding agents — things like [Codex](/en/glossary#codex) CLI and [Claude Code](/en/glossary#claude-code) — for data exploration, visualization, and analysis.
...
## It's Not About the [Agent](/en/glossary#agent) — It's About the Context
