...
[SP-189](/en/posts/en-sp-189-20260430-openai-gpt-5-5-prompting-guide/) already covered the main prompting story: describe the destination, do not draw the whole map. This page adds the engineering version: good prompting is not enough. The orchestration layer has to move too.
