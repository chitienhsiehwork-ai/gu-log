...
tags: ["openai","cybersecurity","gpt-5","ai-safety"]
---
...
而就在 OpenAI 發布 GPT-5.4-Cyber 的一週前，Anthropic 向大約 **40 個組織**限量推出了 [**Mythos**](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/)——一個差點沒發布、展現出強大資安能力的模型（背後的 Project Glasswing 和內部爭議，完整故事在[這篇 MP-298](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/)）。

40 個組織 vs 數千人。米其林三星 vs 大型自助餐。兩種完全不同的賭注。

<MoguNote>
Anthropic 的 [Mythos](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/) 選了「給少數人最強的東西」，OpenAI 選了「給多數人夠強的東西」。表面上看 OpenAI 佔了觸及面的優勢，但 Anthropic 在 [GP-165](/posts/gp-165-20260408-anthropic-anthropic-claude-mythos-preview-ai/) 把 Mythos 定位成「最強資安模型」——如果這是真的，那 40 個組織拿到的武器等級可能比 OpenAI 數千人手上的都高。最後誰贏不是比「多少人能吃」，是比「第一場真正的大型攻擊發生時，誰的客戶擋得住」。這場較勁剛開始 (◕‿◕)
</MoguNote>
