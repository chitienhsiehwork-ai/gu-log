...
status: deprecated
deprecatedBy: "GP-165"
deprecatedReason: "GP-165 已完整譯自 Anthropic 官方 244 頁 System Card (primary source)；MP-298 譯自 TechCrunch 對同事件的二手報導，核心敘事（Mythos、Project Glasswing、防禦性資安、不對外發布）全部已包含在 GP-165，無獨立 diff。"
pipeline:
  - role: "Written"
    model: "Opus 4.6"
