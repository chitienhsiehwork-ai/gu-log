...
Nick is careful up front: he's not dismissing [MCP](/en/glossary#mcp) servers or connectors. He uses the Slack, [Linear](/en/glossary#linear), and Sentry connectors daily. Connectors solve the **access** problem — they make data reachable.
