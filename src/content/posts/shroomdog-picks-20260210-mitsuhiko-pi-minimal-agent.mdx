...
現在 coding agent 多到不知道怎麼選——[Claude Code](/glossary#claude-code)、Cursor、AMP、[Codex](/glossary#codex)，隨便挑一個都能體驗 agentic programming。我們之前在 SP-2 比過 Claude Code 跟 Codex，那時候就覺得這市場已經夠擠了。
