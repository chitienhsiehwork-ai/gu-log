...
How big a deal is that? LangSmith tested it themselves: **with trace tooling, [Claude Code](/en/glossary#claude-code) jumped from 17% to 92% on their eval set.** Same model. The only difference was whether it could see what was actually happening in production.
...
## Traces: The Flight Recorder of the [Agent](/en/glossary#agent) World
