...
This cycle has a name: [ReAct](https://arxiv.org/abs/2210.03629) (the Princeton and Google paper). Think, act, observe the result, think again, repeat until done. In programming terms: understand the goal, write code, run it, read the error, infer the cause, fix it, run again, until tests pass.
