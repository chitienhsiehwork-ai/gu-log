...
status: deprecated
deprecatedBy: "SP-165"
deprecatedReason: "SP-165 已完整譯自 Anthropic 官方 244 頁 System Card (primary source)；CP-298 譯自 TechCrunch 對同事件的二手報導，核心敘事（Mythos、Project Glasswing、防禦性資安、不對外發布）全部已包含在 SP-165，無獨立 diff。"
pipeline:
  - role: "Written"
    model: "Opus 4.6"
