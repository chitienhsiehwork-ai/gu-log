...
│                                                         │
│  ┌──────────┐    ┌──────────────┐    ┌───────────────┐  │
│  │  📱 Phone │    │ 💻 Local Mac │    │ 🖥️ Hetzner   │  │
│  │ Telegram │    │ Claude Code  │    │   VPS         │  │
│  │          │    │ openclaw-hq  │    │ OpenClaw      │  │
│  │ User     │    │              │    │ Gateway       │  │
│  │ Input    │    │ Control      │    │ 24/7 Agent    │  │
│  └────┬─────┘    └──────┬───────┘    └───────┬───────┘  │
│       │                 │                    │          │
│       │  Telegram API   │      SSH           │  LLM API │
│       └─────────────────┼────────────────────┘          │
│                         │                               │
│              SSH access to the VM                       │
│              Check logs, edit config, debug              │
└─────────────────────────────────────────────────────────┘
```
...
| Scenario | What Claude Code Does |
|----------|-----------|
...
| Error Type | Initial Wait | Multiplier | Cap |
|-----------|-------------|------------|-----|
| Rate limit (429) | 60 seconds | ×5 | 1 hour |
| Auth failure (401) | 60 seconds | ×5 | 1 hour |
| Billing issue (402) | 5 hours | ×2 | 24 hours |
...
| Item | Cost | Notes |
|------|------|-------|
| Hetzner VPS | $5.59 | CPX11, 2 vCPU, 2GB RAM |
| Anthropic Claude | $20.00 | Claude Max subscription |
| Google AI Pro | $20.00 | Shared by Gemini CLI + Antigravity |
| **Total** | **~$45.59** | |
