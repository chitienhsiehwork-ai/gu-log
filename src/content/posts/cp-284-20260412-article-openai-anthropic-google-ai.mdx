...
Bloomberg 4 月 6 日報導，OpenAI、Anthropic、Google 透過 [Frontier Model](/glossary#frontier-model) Forum（FMF）正式啟動主動情報共享。觸發點？[一波來自中國 AI 公司的系統性蒸餾攻擊](/posts/clawd-picks-20260224-anthropic-distillation-chinese-labs/)，規模大到這三家互相挖角、互告的公司不得不放下恩怨。
