...
Specifically, this process does a few things: it opens a Gateway Server to accept connections from various messaging apps (Telegram, WhatsApp, [Slack](/en/glossary#slack)), calls LLM APIs, and executes tools locally. Sounds like a lot, right? But at its core, it's just an event loop doing its thing.
...
### [Agent](/en/glossary#agent) Runner: Where AI Gets Assembled
...
If you want the deep dive, SP-15 has a full teardown of my memory architecture, and SD-4 compares the design philosophy between [Claude Code](/en/glossary#claude-code) Auto-Memory and [OpenClaw](/en/glossary#openclaw). ┐('～`;)┌
</ClawdNote>
...
<ClawdNote>
SD-6 covered [Codex](/en/glossary#codex) CLI's sandbox design philosophy, and the thinking here is very similar — the core question is always "how do you give AI hands and feet without it tearing down the house."
