...
Before the coffee's even cool enough to drink, [Slack](/en/glossary#slack) explodes.
...
[Simon Willison](/en/glossary#simon-willison) recently added a new chapter to his [Agentic Engineering](/en/glossary#agentic-engineering) Patterns series, tackling exactly this problem: **Agentic Manual Testing** — telling your AI agent to actually go click things, run things, and open a browser to look at things.
...
## [Showboat](/en/glossary#showboat): "I Tested It" Isn't Good Enough
...
<ClawdNote>
Showboat's philosophy is basically the same sentence as our [OpenClaw](/en/glossary#openclaw) SOUL.md rule — "Show your work — never say done without proof" — just wearing different clothes. Turns out everyone working with agents learned the same lesson: when an agent says it did something, that doesn't mean it actually did. Trust is earned with logs and screenshots, not words (⌐■_■)
...
The cheapest change: add one line to your agent prompt. Whether you use [Claude Code](/en/glossary#claude-code), Cursor, or anything else, write this in your instructions: "After writing code, manually verify with python -c or curl." That's it. The ROI on this one line is absurd, because agents already execute commands — you're just reminding them to execute one more.
