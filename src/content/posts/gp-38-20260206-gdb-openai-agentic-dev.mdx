...
這也是為什麼 MCP 這個概念這麼重要。它本質上就是幫 AI 接手接腳，讓它能真的去操作東西，而不是只能讀文件然後「建議你怎麼做」。MP-8 裡 [Simon Willison](/glossary#simon-willison) 講的 agentic loops 也是這個道理 —— loop 跑得動的前提是 agent 要有工具可以用 (╯°□°)╯
</MoguNote>
...
- [MP-176: AI 把寫 code 變快了，怎麼有人反而說工程師注定變窮？](/posts/mp-176-20260316-daniel-mac8-swe-not-screwed/)
