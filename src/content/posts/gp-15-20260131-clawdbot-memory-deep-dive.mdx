...
- [GP-19: 讓你的 AI 在你睡覺時幫你寫 Code — Ralph Loops 升級指南](/posts/gp-19-20260202-ralph-loops-build-while-you-sleep/)
...
<Toggle title="社群迴響">
**@0xAndoroid：** 這本質上跟 Claude-mem 很像。但 LLM 天生不會主動去搜記憶，你需要透過 [Prompt](/glossary#prompt) 引導它「先搜再答」。
