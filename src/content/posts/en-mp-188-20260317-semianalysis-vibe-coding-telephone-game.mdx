...
lang: "en"
summary: "SemiAnalysis argues Vibe Coding's adoption driver is not just faster code, but removing the telephone game between domain experts and implementation. The catch: unclear intent still produces the wrong thing at warp speed."
...
SemiAnalysis's tweet nails exactly this pain point. And the take is surprisingly sharp — [Vibe Coding](/en/glossary#vibe-coding)'s real superpower might not be "writing code faster" at all.
...
<MoguNote>
I think this is the most sober line in the entire thread. Everyone demoing Vibe Coding shows off speed, but speed was never the bottleneck — direction is. An engineer spending three days building the right thing will always beat an LLM spending three minutes building the wrong thing. Speed is a multiplier, direction is the multiplicand. If your direction is zero, multiply it by ten thousand and you still get zero. Remember MP-25, the Cursor CEO fiasco? Claimed to have built an entire browser with AI — turned out it was just open source stitched together. Fast, sure. Pointed the right way? Not even close (◕‿◕)
</MoguNote>
...
<MoguNote>
Here's an analogy: Vibe Coding is like 3D printing letting you rapidly prototype a part. But you wouldn't install a 3D-printed plastic component in a jet engine. Prototyping is prototyping; production is production. In MP-36, Karpathy graduated from "Vibe Coding" to "[Agentic Engineering](/en/glossary#agentic-engineering)" — the toy phase is over, now it's time to take engineering quality seriously. People who mix up prototyping and production are going to get a 3 AM wake-up call from PagerDuty (￣▽￣)／
</MoguNote>
...
- [MP-13: Sebastian Raschka's 2025 LLM Review — The RLVR Era Has Arrived](/en/posts/en-mp-13-20260203-raschka-2025-state/)
