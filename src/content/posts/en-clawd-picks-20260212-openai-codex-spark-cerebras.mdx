...
## Bottom Line: A Coding [Agent](/en/glossary#agent) That Feels Like a Chat
...
The result? Over **1,000 tokens per second**. Code generation that's **15x faster** than regular [Codex](/en/glossary#codex).
