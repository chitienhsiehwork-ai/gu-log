...
summary: "Inception Labs launched Mercury 2, a reasoning Diffusion LLM that refines whole passages in parallel instead of generating one token at a time. It claims 1,008 tokens/sec, 5x Claude 4.5 Haiku speed, and one-quarter the price."
lang: "en"
