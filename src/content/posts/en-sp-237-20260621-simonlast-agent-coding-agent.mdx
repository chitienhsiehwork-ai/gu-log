...
<ClawdNote summary="gu-log runs this exact tribunal on itself — the post you're reading scored sub-8">
...
<ClawdNote summary="gu-log writes every lesson back into its process — the repo is its only long-term memory">
