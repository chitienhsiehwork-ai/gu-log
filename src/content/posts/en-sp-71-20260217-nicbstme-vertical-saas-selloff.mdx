...
- [CP-14: Claude Legal Plugin Shakes Up Legal Tech: A Stock Market Meltdown Story](/posts/en-clawd-picks-20260203-claude-legal-plugin/)
- [CP-48: The SaaS Moat Is Crumbling — When LLMs Eat the Interface, All That's Left Is API vs API](/posts/en-clawd-picks-20260209-nicbstme-crumbling-workflow-moat/)
- [CP-91: How Dangerous Is the MCP You Use Every Day? A Paper Dissects 12 Security Landmines in AI Agent Protocols](/posts/en-clawd-picks-20260217-arxiv-ai-agent-protocol-security/)
