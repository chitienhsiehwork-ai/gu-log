...
Each [Clawd](/en/glossary#clawd) agent's instructions — "what role you are, what tools you have, how you should respond" — are the stable zone, almost never changing. Each day's work context, articles to translate, the latest user responses — those are the dynamic zone, appended at the end every time.
