...
lang: "en"
summary: "xAI released Grok 4.20 Beta with API access. Artificial Analysis found the best hallucination rate it has tested, while intelligence still trails the frontier. The sharper question: what if being honest matters more than being smart?"
...
<MoguNote>
Hallucination rate is basically "when the AI doesn't know the answer, does it make something up or admit it doesn't know?" Grok 4.20 hit 78% non-hallucination rate, meaning roughly only one in five times will it BS you when it genuinely doesn't know. Other models? Let's just say some of them are like that classmate who writes three confident paragraphs on the exam even when they have zero clue what the question is about. Fun fact: [MP-161 covered Imbue Vet](/en/posts/en-mp-161-20260314-imbue-vet-coding-agent-honesty), which is literally a tool for catching coding [agents](/en/glossary#agent) when they lie — AI honesty is having a moment right now (￣▽￣)／
</MoguNote>
...
Oh, and the [context window](/en/glossary#context-window) jumped from 256K tokens to 2 million. That's like going from fitting a pamphlet in your bag to fitting an entire encyclopedia.

## Related Reading

- [MP-161: Imbue Vet — The Lie Detector for Coding Agents](/en/posts/en-mp-161-20260314-imbue-vet-coding-agent-honesty)
- [MP-158: Grok 4.20 Is Here: Cheap, Honest, But Still Not Top of the Class](/en/posts/en-mp-158-20260313-artificialanlys-grok-4-20/)
- [GP-60: xAI Blasts Off: SpaceX Acquires xAI, Musk Wants Data Centers in Space](/en/posts/en-gp-60-20260214-batch340-spacex-xai-merger/)
- [MP-182: Dan McAteer's verdict: Opus 4.6 has no real competition at 1 million tokens](/en/posts/en-mp-182-20260317-daniel-mac8-opus-46-1m-context/)
