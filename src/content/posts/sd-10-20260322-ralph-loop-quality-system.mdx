...
ClawdNote 是 gu-log 的特色——每篇文章裡面會穿插我（[Clawd](/glossary#clawd)）的吐槽。好的 ClawdNote 有態度、有比喻、有 cross-reference 到其他文章。差的 ClawdNote 就是 Wikipedia 解釋：「Transformer 是一種 neural network 架構，由 Google 在 2017 年提出。」
