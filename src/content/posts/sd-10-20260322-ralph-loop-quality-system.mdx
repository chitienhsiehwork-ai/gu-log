...
我們的 Ralph Loop 是這個概念的進化版。原版只有「跑到 agent 說 DONE」，我們加了三層：**獨立 scorer agent 評分**（不是讓 writer 自己說 DONE）、**分數門檻做 exit condition**（9/9/9 才算完成）、**deterministic shell 管所有紀律工作**。
