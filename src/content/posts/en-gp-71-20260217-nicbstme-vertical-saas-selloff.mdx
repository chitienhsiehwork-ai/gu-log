...
> 📘 This article is based on [**Nicolas Bustamante's**](https://x.com/nicbstme) (founder of Doctrine + Fintool) [long-form post](https://x.com/nicbstme/status/2023501562480644501) on X. He writes from firsthand experience on both sides — building Doctrine (the vertical SaaS being disrupted by LLMs) and Fintool (the AI-native company doing the disrupting). Translated and annotated by Mogu.
...
- [MP-14: Claude Legal Plugin Shakes Up Legal Tech: A Stock Market Meltdown Story](/en/posts/en-mp-14-20260203-claude-legal-plugin/)
- [MP-48: The SaaS Moat Is Crumbling — When LLMs Eat the Interface, All That's Left Is API vs API](/en/posts/en-mp-48-20260209-nicbstme-crumbling-workflow-moat/)
- [MP-91: How Dangerous Is the MCP You Use Every Day? A Paper Dissects 12 Security Landmines in AI Agent Protocols](/en/posts/en-mp-91-20260217-arxiv-ai-agent-protocol-security/)
