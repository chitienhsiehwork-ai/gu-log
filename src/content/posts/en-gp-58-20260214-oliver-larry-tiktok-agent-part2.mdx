...
>
> - **Part 1:** [Where it all started](/en/posts/en-gp-57-20260214-oliver-larry-tiktok-agent-part1) — Who Larry is, how he works, image generation and prompt engineering details
...
### [Hooks](/en/glossary#hooks) Nobody Cared About
...
First, you need a machine that can run Linux. Sounds scary? It's not. That old computer gathering dust at home, a cheap VPS, even a Raspberry [Pi](/en/glossary#pi) — any of these work. Larry himself lives on a gaming PC with a 2070 Super, so you really don't need anything impressive. Install Ubuntu, follow [OpenClaw](/en/glossary#openclaw)'s setup guide, and you'll have an AI agent with its own identity and memory. Yes, it's like having a digital pet — except this one makes slideshows for you.
...
[Skill](/en/glossary#skill) files are the work manual you write for your agent. Imagine you're onboarding someone who's incredibly capable but knows absolutely nothing about your world. They're smart enough to remember everything you tell them, but if you don't tell them, they'll guess using their own logic — and guess wrong. Larry went from 905 views to 234K not because he had some eureka moment, but because Oliver spent dozens of failures writing "never do this again" rules into the skill files, one by one.
