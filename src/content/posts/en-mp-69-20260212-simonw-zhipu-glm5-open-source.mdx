...
lang: 'en'
tags: ["simon-willison","zhipu-ai","glm-5","open-source","china-ai","multimodal"]
---
...
[Simon Willison](/en/glossary#simon-willison) — Django co-creator, AI tool blogger, the man who probably reviews more AI tools per year than you eat sandwiches — saw the announcement and immediately did what he always does:
...
Then he spotted a trend: Zhipu's marketing pushes "from [Vibe Coding](/en/glossary#vibe-coding) to [Agentic Engineering](/en/glossary#agentic-engineering)." The idea is that AI-assisted development should evolve past "it kinda works, good vibes!" into "the AI handles the whole engineering pipeline." Karpathy coined vibe coding and it went viral. Now everyone's saying the next step is actual engineering.
...
- [MP-81: Simon Willison Dug Up OpenAI's Tax Returns — Watch Their Mission Statement Go from 'Open and Sharing' to 'Just Trust Us'](/en/posts/en-mp-81-20260214-simonw-openai-irs-mission-evolution/)
...
- [MP-190: Three-Hour Workshop Handout Goes Public: Simon Willison Brings Coding Agents to Data Work](/en/posts/en-mp-190-20260317-simonw-coding-agents-data-analysis-workshop/)
