...
Agent gets stuck? Edit the system prompt. Makes a dumb decision? Add a rule: "NEVER do X." Still broken? Add ten more rules. You do not even know if the problem is the prompt, the tool response, or the [context window](/en/glossary#context-window) overflowing. You just keep tweaking in the dark.
