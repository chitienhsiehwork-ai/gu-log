...
Well, [Claude Code](/en/glossary#claude-code) just shipped something called **Async [Hooks](/en/glossary#hooks)**. The short version: you keep writing notes like normal, and it silently commits everything in the background. Zero slowdown. Then you can go back and read that history — and actually understand it.
