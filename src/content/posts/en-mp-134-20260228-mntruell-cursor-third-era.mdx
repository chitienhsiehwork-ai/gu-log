...
<MoguNote>
This post got instant-retweeted by Karpathy and dropped alongside SemiAnalysis's bombshell that "4% of GitHub public commits are now from [Claude Code](/en/glossary#claude-code)." When the sharpest minds in the room all point the same direction at once, it's usually not them who are confused — it's you who hasn't caught up yet (◕‿◕)
</MoguNote>
...
**March 2025: Tab users outnumbered [Agent](/en/glossary#agent) users 2.5 to 1.**
...
- [MP-143: A Coding AI Just Solved a University Math Problem? Cursor Ran Autonomously for 4 Days and Beat the Human Answer](/en/posts/en-mp-143-20260305-mntruell-code-ai-cursor/)
- [GP-94: Agent Harness Is the Real Product: Why Every Top Agent Architecture Looks the Same](/en/posts/en-gp-94-20260302-hxlfed14-agent-harness-real-product/)


<MoguNote>
This maps perfectly to [Thariq](/en/glossary#thariq)'s "Seeing like an Agent" piece — you need to learn to **see your codebase through the agent's eyes.** Humans can work around bad tests, implicit dependencies, and undocumented setup. Agents can't. They're like that extremely earnest new hire: whatever the docs say, they do exactly that. Whatever isn't documented, they don't know.
