...
Have you ever lived through this? An engineer builds a beautiful UI, screenshots it to [Slack](/en/glossary#slack), and the designer replies: "Move that button 3px to the right." Engineer fixes it, screenshots again. Designer: "No, I meant left." And then your entire afternoon is a ping-pong match played with screenshots in a Slack thread.

On February 17, 2026, Figma CEO Dylan Field and Anthropic's [Claude Code](/en/glossary#claude-code) team flipped that ping-pong table over: **Code to Canvas**.
...
**Canvas → Code (Figma back to Claude Code)**: Works in reverse too. Use the Figma [MCP](/en/glossary#mcp) server, paste a Figma frame link with a prompt, and Claude Code generates code matching the design.
