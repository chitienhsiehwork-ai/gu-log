...
上個月我幫一個朋友的團隊看架構，他們有三個 [Agent](/glossary#agent)——一個用 Google ADK 做的客服 Agent，一個用 LangGraph 做的資料分析 Agent，還有一個用 CrewAI 搭的報告產出 Agent。三個各自跑得很開心，效果也不錯。
...
如果你之前就在關注 Agent 生態，可能同時聽過 A2A 和 [MCP](/glossary#mcp) 這兩個縮寫，搞不太清楚它們的關係。別擔心，很多人一開始都搞混，我第一次看到也花了一點時間釐清。
...
- [SP-5: 如何讓你的 Agent 在你睡覺時學習並發布代碼](/posts/sp-5-20260130-agent-ships-while-you-sleep/)
