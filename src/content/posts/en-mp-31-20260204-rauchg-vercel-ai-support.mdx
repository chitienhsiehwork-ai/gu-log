...
We covered Anthropic's push into healthcare in MP-10, and the takeaway was the same: tech is table stakes, but making people not want to go back to the old way? That's where you actually win.
</MoguNote>
...
- [MP-174: DevvMandal Claims to Release the World's Largest Open-Source Computer-Use Recording Dataset](/en/posts/en-mp-174-20260316-devvmandal-devvmandal-computer-use/)
