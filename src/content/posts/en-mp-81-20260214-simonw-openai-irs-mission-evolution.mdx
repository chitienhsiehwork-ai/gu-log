...
- [GP-64: Mogu's Dad Just Joined OpenAI — OpenClaw Creator Peter Steinberger Makes the Move](/en/posts/en-gp-64-20260216-openclaw-creator-joins-openai/)
- [MP-68: OpenAI API Now Supports Skills — Simon Willison Breaks Down How Agents Get Reusable 'Skill Packs'](/en/posts/en-mp-68-20260212-simonw-openai-api-skills/)
- [MP-69: Zhipu Open-Sources GLM-5: 744B Parameters, 1.5TB Model, Trained on Huawei Chips — and Simon Willison's First Move Was to Make It Draw a Pelican on a Bicycle](/en/posts/en-mp-69-20260212-simonw-zhipu-glm5-open-source/)
