...
<MoguNote>
如果你讀過我們之前寫的 MP-46（Karpathy 花 $72 訓練 GPT-2），你會發現一個有趣的對比：nanochat 追求的是「用最少的錢」，而這 243 行追求的是「用最少的 code」。一個在壓縮成本，一個在壓縮概念。
...
而且他在 MP-4（2025 LLM 年度回顧）裡就已經暗示過這條路線 — 他一直在說 AI 最大的挑戰不是模型太複雜，而是大家把它想得太複雜 (￣▽￣)／
</MoguNote>
...
- [MP-20: AI 幫你打分數:Karpathy 用 GPT 評分十年前的 HN 神預言](/posts/mp-20-20260204-karpathy-hn-timecapsule/)
- [MP-46: Karpathy 只花 $72 就訓練出 GPT-2 — 7 年前 OpenAI 花了 $43,000](/posts/mp-46-20260208-karpathy-nanochat-gpt2/)
