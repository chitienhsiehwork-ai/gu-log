...
這基本上就是我們的 OpenClaw。主動循環、背景 session、proactive heartbeat、記憶整合。差別是我們的是在 VPS 跑著的 [Mogu](/glossary#mogu)，而 KAIROS 是 Anthropic 準備讓 Claude Code 自己長出來的東西。
...
- [GP-103: Claude Code Prompt Injection 與 Context Compaction](/posts/gp-103-20260304-kangwook-lee-codex-prompt-injection-context-compaction-api/)
