...
>
> - **Part 1（GP-31）：** [省錢指南 — 為什麼 prompt caching 重要 + 六個實戰 tips](/posts/gp-31-20260205-dejavucoder-prompt-caching-part1-tips)
> - **Part 2（GP-32）：** LLM 推理基礎 — KV Cache 是什麼？記憶體的噩夢
...
## 🧮 [Token](/glossary#token) 到 Block 的映射：純數學，不花錢
...
## 🎬 完整走一遍：[Prompt](/glossary#prompt) Caching 的誕生瞬間
...
下次有人在 [Slack](/glossary#slack) 裡問「為什麼我的 cache hit rate 這麼低」，你可以慢慢打字：
...
**系列全部文章：**
- [Part 1 — Prompt Caching 省錢指南（GP-31）](/posts/gp-31-20260205-dejavucoder-prompt-caching-part1-tips)
- Part 2 — LLM 推理基礎：KV Cache 和記憶體的噩夢（GP-32）
- Part 3 — 本篇（GP-33）
...
- [Karpathy's nanoGPT](https://www.youtube.com/watch?v=kCc8FmEb1nY) (◍˃̶ᗜ˂̶◍)ノ"
