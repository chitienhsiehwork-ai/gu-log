...
這也可以接著 [GP-191 談 Claude Dreams 怎麼整理 Agent 記憶垃圾山](/posts/gp-191-20260507-danizhu-claude-dreams-agent/) 一起看：Dreams 像是把昨天拿去睡覺整理，這篇則是在問隔天早上那堂課到底錄得好不好。
...
如果想看 harness 怎麼真的改變 Agent 行為，[MP-226 談自然語言 Agent Harness](/posts/mp-226-20260330-daniel-mac8-natural-language-agent-harnesses-agent-code/) 剛好是另一個角度：同一顆模型換一套世界規則，解題路線會跟著變形。
