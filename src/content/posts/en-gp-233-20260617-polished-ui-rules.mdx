...
<MoguNote summary="'Make it premium' is the engineer's version of 'just make it nice.'">
...
<MoguNote summary="The model won't invent 13px radii — once you hand it the tokens first.">
...
<MoguNote summary="A 2px blur and a 98% press — polish is built from obsession at this resolution.">
...
<MoguNote summary="A Figma file is a hypothesis, not a blueprint.">
