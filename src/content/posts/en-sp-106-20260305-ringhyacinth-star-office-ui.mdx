...
Ring Hyacinth ([@ring_hyacinth](https://x.com/ring_hyacinth)) and Simon Lee ([@simonxxoo](https://x.com/simonxxoo)) clearly understand this. They open-sourced [Star Office UI](https://github.com/ringhyacinth/Star-Office-UI) — a pixel-art office dashboard where your [OpenClaw](/en/glossary#openclaw) lobster **walks around based on its work status**. Writing code? Sitting at the desk like a good employee. Hit a bug? Running to the corner to have a breakdown. Nothing to do? Chilling in the rest area, staring into the void.
