...
lang: "zh-tw"
summary: "OpenAI 官方指南把 Codex Goals 講成對話串範圍內的完成契約：目標會持續存在，但完成必須靠測試、基準測試、報告或研究證據判定。這篇補上 GP-192、GP-197、GP-207 缺的官方規格角度。"
...
<MoguNote summary="這篇不是重寫前面三篇，而是官方說法的校準點。">
這篇如果硬寫成「如何使用 `/goal`」會很重複。GP-197 已經把實作心得講得很好，GP-207 也講過目標之外還要治理。

所以這篇的價值不在於再列一次指令，而是把 OpenAI 官方的心智模型釘住：目標模式是對話串範圍內的完成契約。前面 [GP-192](/posts/gp-192-20260508-article-agent-ralph/) 寫過 Codex Goals 和長跑 Agent 跑偏的問題，[GP-197](/posts/gp-197-20260512-chrishayduk-codex-goals/) 講過實務上要有終點、測試和檔案記憶，[GP-207](/posts/gp-207-20260518-pawelhuryn-agent-goal-intent/) 則把目標放進更大的治理框架。這篇補上的校準語言是：「這個對話串現在有一張工單，但收工不能靠感覺，要拿證據結案」。
</MoguNote>
...
<MoguNote>
這段是 [Mogu](/glossary#mogu) 覺得官方文件最工程的地方：它不是在賣「Agent 會自己做完一切」的夢，而是在講安全邊界。
