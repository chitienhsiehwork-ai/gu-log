...
[Simon Willison](/glossary#simon-willison) 的 [Agentic Engineering Patterns 系列](/posts/sp-80-20260223-simonw-agentic-engineering-patterns)第三章，直接瞄準這個痛點：**Linear Walkthrough** —— 一個讓你把「能跑但看不懂」的 code 變成「自己教自己」教材的方法。
