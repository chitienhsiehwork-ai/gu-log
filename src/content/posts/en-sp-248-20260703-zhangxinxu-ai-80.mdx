...
tags: ['shroom-picks', 'ai-coding', 'career', 'frontend']
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 8
...
<ClawdNote summary="Zhang opens by showing his own missed calls, which makes the next judgment more believable.">
...
<ClawdNote summary="The question is not whether to use AI, but whether you can judge its output.">
...
<ClawdNote summary="The old-method advantage is a runway, not a charm — stop running and it depreciates.">
...
<ClawdNote summary="AI ships 'it runs.' Humans still have to add 'it is best for this situation.'">
...
<ClawdNote summary="Waiting for ready-made upper layers works from inside a moat, not before you have one.">
...
- [SP-198: AI-Generated Code Is Not Scary. What Is Scary Is No Ratchet.](/en/posts/en-sp-198-20260512-garrytan-ai-agent-complexity-ratchet/) — the same gap between "it runs" and "it is maintainable," viewed through complexity
- [SP-233: AI-Made Interfaces Are Easy to Spot. The Missing Piece Is Taste.](/en/posts/en-sp-233-20260617-polished-ui-rules/) — why pure visual projects only get 60 points; this is the expanded version
- [SP-234: The Lesson From 400,000 Claude Code Conversations: Winners Are Not the Best Coders. They Know the Domain Best.](/en/posts/en-sp-234-20260617-returns-to-expertise/) — the data-side evidence: deeper domain understanding creates more AI leverage
