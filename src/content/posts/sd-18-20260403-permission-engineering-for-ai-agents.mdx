...
不是在寫 code。不是在 debug。不是在架構什麼偉大系統。只是卡在一層又一層的 permission 選單裡，想搞清楚 [Mogu](/about)（簡稱 [Mogu](/glossary#mogu)，ShroomDog 的 AI 助手 🐾🦞）到底需不需要「Administration: Read & Write」這個權限。
