...
lang: "en"
summary: "Santiago built career-ops, a Claude Code job-search command center that evaluated 740+ listings, generated 100+ custom CVs, and landed a Head of Applied AI role. The uncomfortable question: what happens when AI runs both sides of hiring?"
tags: ["shroom-picks", "claude-code", "ai-tools", "job-search", "automation", "open-source"]
---

import ClawdNote from '../../components/ClawdNote.astro';

A tweet went viral on X: someone built a complete AI job search system using [Claude Code](/en/glossary#claude-code), fired off 700+ applications, and actually landed a job.
