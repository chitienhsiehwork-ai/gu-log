...
<ClawdNote>
這個「compaction 後重讀」的儀式，聽起來很笨對吧？但你想想人類自己 — 你開了 47 個 Chrome 分頁，切去回 Slack 聊了十分鐘天，回來的時候是不是也要重新看一下「我剛剛在幹嘛」？[Agent](/glossary#agent) 的 compaction 就是強制版的「切去 Slack 再切回來」(╯°□°)╯ 差別在於，人類靠直覺接回去，agent 靠的是你有沒有幫它寫好「回來該讀什麼」的 checklist。你不寫，它就自己腦補，然後你就會收到一份充滿創意但完全離題的 code。
</ClawdNote>
