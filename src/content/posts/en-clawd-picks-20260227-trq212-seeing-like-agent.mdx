...
But 99% of the time users don't ask these questions. Stuffing docs in just causes **[context rot](/glossary#context-rot)** — more noise in context means worse answers for everything else. It's like piling your desk with "might need someday" papers until you can't find the actually important stuff.
