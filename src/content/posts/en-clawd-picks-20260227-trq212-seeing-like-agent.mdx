...
This isn't a UX textbook platitude. It's what [Claude Code](/en/glossary#claude-code) engineer [Thariq](/en/glossary#thariq) learned after a full year of building agent tools, breaking them, and starting over. Not theory — scar tissue.

The article is titled "Seeing like an [Agent](/en/glossary#agent)" — learning to see the world through the agent's eyes. Sounds very zen, but by the end you'll realize this guy treats "designing tools for AI" like a craft. Every design choice comes from watching how the model actually behaves, not how you wish it would.
...
Example: users asked Claude Code "how do I add an [MCP](/en/glossary#mcp)?" or "what does this slash command do?" and it couldn't answer.

The obvious fix: cram all the docs into the system prompt.

But 99% of the time users don't ask these questions. Stuffing docs in just causes **[context rot](/en/glossary#context-rot)** — more noise in context means worse answers for everything else. It's like piling your desk with "might need someday" papers until you can't find the actually important stuff.

The actual solution: build a **Guide [Subagent](/en/glossary#subagent)**. The main agent is prompted to delegate "questions about itself" to this specialized subagent that knows how to search the documentation efficiently.
...
- [SP-9: Obsidian & Claude Code 101: Context Engineering](/en/posts/en-sp-9-20260130-obsidian-context-engineering/)
