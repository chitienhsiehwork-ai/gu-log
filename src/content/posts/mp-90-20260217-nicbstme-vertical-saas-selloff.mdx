...
status: "deprecated"
deprecatedReason: "Duplicate of GP-71 — same source tweet (nicbstme/status/2023501562480644501). GP-71 is the longer translation; following the existing convention from MP-238/GP-138 where the GP version is treated as canonical for cross-format dupes."
deprecatedBy: "GP-71"
...
**延伸閱讀**：
- [MP-48: SaaS 的護城河正在崩塌](/posts/mp-48-20260209-nicbstme-crumbling-workflow-moat)（同一作者的前作，概念版）
- [MP-65: LLM Context Tax 避稅指南](/posts/mp-65-20260211-nicbstme-context-tax)（同一作者，context 優化） (•̀ᴗ•́)و
