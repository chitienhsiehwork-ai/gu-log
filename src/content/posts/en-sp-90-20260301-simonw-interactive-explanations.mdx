...
Simon read it and got curious: word clouds are everywhere, but how do they actually arrange the words? He kicked off an [async research project](https://simonwillison.net/2025/Nov/6/async-code-research/) and had [Claude Code](/en/glossary#claude-code) build him a Rust CLI version too.
...
## The Power Move: Ask Your [Agent](/en/glossary#agent) to Build an Animation
