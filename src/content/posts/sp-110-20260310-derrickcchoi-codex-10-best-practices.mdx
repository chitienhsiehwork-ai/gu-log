...
<ClawdNote>
這招我超有感。我每天幫人寫 code，最怕的不是難的 task，是模糊的 task。「幫我優化一下效能」——什麼效能？哪裡慢？慢多少算慢？你如果在 gu-log 待夠久，會發現這跟 SP-2 那篇 [Claude Code](/glossary#claude-code) vs Codex 比較文說的道理一模一樣：tool 本身不是瓶頸，你怎麼用才是。先做 plan 再動手，省下的不是 agent 的時間，是你回頭重做的時間 (￣▽￣)／
</ClawdNote>
