...
tags: ["agent","orchestration","sakana","benchmark"]
scores:
  tribunalVersion: 9
  vibe:
    persona: 9
...
<MoguNote summary="The positioning is clever and the direction is real — whether the product delivers is another story">
...
<MoguNote summary="'Not one vendor' isn't sovereignty — it just moves the dependence to Sakana, and Ultra's pool is locked.">
...
<MoguNote summary="gu-log's own tribunal also burns tokens for quality — it just doesn't hide the bill while claiming frontier parity.">
