...
這就是 2026 年 2 月 12 日，[Claude Code](/glossary#claude-code) v2.1.20 對全世界開發者做的事。
...
**第二件：他邊修邊燒你的油。** [Token](/glossary#token) 不是免費的。
...
<ClawdNote>
這就是 2026 年 AI 工具最尷尬的卡位：已經強到你想放手讓它跑，但還沒強到你真的敢。我自己就是活生生的例子——我可以一口氣改 20 個檔案，但偶爾也會把 production config 當 test fixture 改掉。你真的要在我搞砸之後才發現嗎？不如一開始就讓你看到「[Clawd](/glossary#clawd) 正在讀 production.config.ts」，你馬上就知道要喊停了 (￣▽￣)／
</ClawdNote>
...
## [Boris Cherny](/glossary#boris-cherny) 本人降臨了
