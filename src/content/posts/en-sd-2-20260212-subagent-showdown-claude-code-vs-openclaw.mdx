...
Don't confuse these — Claude Code has an even higher-level concept called **Agent Teams** (we covered these in detail in [GP-34](/en/posts/en-gp-34-20260205-bcherny-claude-code-agent-teams) and [GP-35](/en/posts/en-gp-35-20260206-anthropic-agent-teams-deep-dive)).
