...
- [MP-196: Hermes Agent 正式支援 Browser Use：讓 AI 代理幫你滑社群網站](/posts/mp-196-20260322-teknium-hermes-agent-browser-use/)
- [MP-189: Agent 開始會自己拉方向盤？Hermes Agent 的自我引導實驗有點猛](/posts/mp-189-20260317-teknium-agent-hermes-agent/)
- [MP-151: AI agent 開始自己調參了，Karpathy 說這不是玩具而是真的有用](/posts/mp-151-20260311-karpathy-autoresearch-hyperparameter-tuning/)
