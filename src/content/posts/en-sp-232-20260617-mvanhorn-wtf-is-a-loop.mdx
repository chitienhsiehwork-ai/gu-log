...
**Rung one: the academic while-loop.** The 2022 [ReAct](/en/glossary#react) paper formalized it: the model reasons, calls a tool, reads the result, repeats until done. One model, one loop, a human watching.
