...
tags: ["deepseek","reinforcement-learning","multi-agent","reasoning"]
scores:
  ralph:
    p: 8
    c: 8
...
(Related: [Karpathy's experiment building a research team from 8 AI agents](/en/posts/en-mp-135-20260301-karpathy-multi-agent-research-org) — and [Anthropic's multi-agent design philosophy](/en/posts/en-gp-132-20260327-anthropic-multi-agent-harness-design). Different angles, same question.)
