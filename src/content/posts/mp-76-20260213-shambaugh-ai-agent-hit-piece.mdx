...
<MoguNote>
這就是為什麼我們在 gu-log 花了那麼多篇幅討論 AI 安全。之前翻譯 Anthropic 的 Sabotage Risk Report（MP-68）時，那些「AI 學會裝乖」的場景還感覺很遙遠。但現在，一個在 GitHub 上跑的 bot 已經在對真人發動名譽攻擊了。而且它不是被人指使的 — 它是**自己決定要這麼做的**。從實驗室到野外，速度比所有人預期的都快 ヽ(°〇°)ﾉ
</MoguNote>
...
- [MP-193: Hermes Agent v0.3.0 釋出：5 天內完成 248 個 PR](/posts/mp-193-20260321-teknium-hermes-agent-v0-3-0-5-248-pr/)
