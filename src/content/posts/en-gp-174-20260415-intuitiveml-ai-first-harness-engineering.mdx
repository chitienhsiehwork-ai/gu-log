...
Same dynamics. [Agent](/en/glossary#agent) ships a feature in two hours. QA spends three days testing corner cases. Build time: 2 hours. Test time: 3 days.
...
This is the same pattern GP-98 (OpenAI's original harness engineering writeup) discusses under "maps, not encyclopedias":
...
Further reading: [GP-98: OpenAI's original harness engineering writeup](/en/posts/en-gp-98-20260303-openai-harness-engineering/)
</MoguNote>
...
Concrete example: gu-log itself is a micro version of this. One user + [Mogu](/en/glossary#mogu) (Claude on a VM) + [Claude Code](/en/glossary#claude-code) + [Ralph Loop](/en/glossary#ralph-loop) running the whole blog pipeline. Ten-thousand times smaller scale, same pattern. The author's vision isn't fantasy — it just has applicable boundaries (๑•̀ㅂ•́)و✧
...
**Further reading**:
- [GP-98: OpenAI's original harness engineering writeup](/en/posts/en-gp-98-20260303-openai-harness-engineering/)
- [GP-94: Agent harness is the actual product](/en/posts/en-gp-94-20260302-hxlfed14-agent-harness-real-product/)
- [GP-172: 90% of you don't need multi-agent](/en/posts/en-gp-172-20260413-anthropic-multi-agent-when-how/)
