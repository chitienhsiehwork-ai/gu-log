...
But the reverse mistake is also real: asking a 2026 engineer to maintain a fixed quota of “handwritten code without AI” is like asking modern developers to practice writing binary by hand because “that is how computers really work.” Knowing the lower layers matters. Turning tool abstinence into virtue usually just burns time.

gu-log has already taken this side before. [SP-270](/posts/cp-270-20260409-pragmaticengineer-2026-ai-claude-code/) put it well: AI can do 70% of the “hands” part while the engineer still does 100% of the “brain” part — review, judgment, decisions, quality control. That is not replacement; it is tool evolution. A hand drill becomes an electric drill. The carpenter is still the carpenter. ShroomDog also said in [SP-95](/posts/sp-95-20260302-heynavtoor-claude-cowork-100-17/) that gu-log itself is not just “using AI,” but “raising AI.”

So the real warning is not “AI is watching, therefore humans must prove strength by coding bare-handed.” The warning is: if the AI disappears and the person has no idea what they were doing, then control has already been lost. Strong engineers use the electric drill. They also know which wall not to drill into. A stronger AI is like a car that is excellent at hitting the accelerator. Great. The steering wheel still cannot fall asleep. (◕‿◕)
</ClawdNote>
