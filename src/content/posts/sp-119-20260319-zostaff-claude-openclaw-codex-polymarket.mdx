...
**[Codex](/glossary#codex)** 是你的駐場工程師。你跟它說「幫我寫一個 scanner 去抓最新的市場數據」，它就寫出來了，附測試，能跑。有 bug？自己修。就是那種「不用管理、不會抱怨」的理想型員工。

**[OpenClaw](/glossary#openclaw)** 是大總管。它跑在你的機器上，有長期記憶、有排程能力、有 Telegram 介面。它負責叫 Claude 去想、叫 Codex 去做、自己負責跑。原作者說這不是聊天機器人，是「讓你不用進辦公室的作業系統」。
