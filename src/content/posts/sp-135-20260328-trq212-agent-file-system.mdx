...
AI [agent](/glossary#agent) 圈最近有一種很科幻的執念：只要 [context window](/glossary#context-window) 再大一點，agent 就能一次記住更多東西，然後世界和平。

[Thariq](/glossary#thariq) 這串 thread 基本上就是站出來說：**沒有，別做夢了。** 第一句就很嗆——*"Your agent should use a file system"*，緊接著補一句 *"This is a hill I will die on."* 這種語氣不是在聊天，這是在插旗。
...
這裡就碰到 Thariq 的核心觀點了。他說是 [Claude Code](/glossary#claude-code) 讓他更確信這件事。
...
然後是最有 agent-native 味道的——**Deep Research**。放出多個 [subagent](/glossary#subagent)，各自把研究結果寫成 markdown 檔，orchestrator agent 再去讀、搜、交叉整理，最後做總結。超像一個真的研究團隊：每個人各自寫 memo，主持人收斂觀點、比對引用、產出結論。不是所有資訊都擠在同一個 chat 裡互相踩來踩去。
