...
[Simon Willison](/glossary#simon-willison)——對，就是那個寫 SQLite 的 Simon——最近在他的 newsletter 提出一個讓人冷汗直流的概念：**AI [Agent](/glossary#agent) 的致命三連擊（The Lethal Trifecta）**。
...
- **GitHub [MCP](/glossary#mcp) server**——repo 裡藏 prompt injection 就能攻擊
- **GitLab Duo**——同上
- **ChatGPT**——被網頁內容劫持
- **Google Bard**——同上
- **Amazon Q**——同上
