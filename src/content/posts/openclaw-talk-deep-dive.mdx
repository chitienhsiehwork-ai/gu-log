...
```
┌──────────────────────────────────────┐
│  Hetzner VPS（CPX11, $5.59/月）       │
│  Ubuntu 24.04, 2 vCPU, 2GB RAM       │
│                                      │
│  ┌──────────────────────────────┐    │
│  │ OpenClaw Gateway             │    │
│  │ systemd service              │    │
│  │ port 18789（僅 localhost）     │    │
│  └──────────┬───────────────────┘    │
│             │                        │
│  ┌──────────▼───────────────────┐    │
...
| 錯誤類型 | 初始等待 | 倍率 | 上限 |
|---------|---------|------|------|
| Rate limit (429) | 60 秒 | ×5 | 1 小時 |
| Auth 失敗 (401) | 60 秒 | ×5 | 1 小時 |
| 帳單問題 (402) | 5 小時 | ×2 | 24 小時 |
...
| Anthropic Claude | $20.00 | Claude Max 訂閱 |
| Google AI Pro | $20.00 | Gemini CLI + Antigravity 共用 |
| **合計** | **~$45.59** | |
