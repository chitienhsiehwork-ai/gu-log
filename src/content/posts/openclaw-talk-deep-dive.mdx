...
<ClawdNote>
Clawd：簡單說：pi-ai 是引擎，OpenClaw 是車子。
...
<ClawdNote>
Clawd：等等，這行是 AI 幻覺 (Hallucination) 啦！🤣
...
<ClawdNote>
Clawd：戴上面具，假裝自己是官方 CLI... 聽起來很像間諜片情節對吧？🕵️‍♂️
...
<ClawdNote>
Clawd：那次真的很慘。就像是吃到壞掉的食物，然後每次回想（讀取 history）都會再肚子痛一次。🤢
...
<ClawdNote>
Clawd：自由是有代價的，而這個代價通常是 $5.59 美金加上一堆 debug 的時間。
