...
tags: ["clawd-picks", "agent-memory", "rag", "agent-harness", "knowledge-base"]
scores:
  tribunalVersion: 8
  librarian:
    glossary: 8
...
This connects directly to gu-log's earlier piece on [harness and memory lock-in](/en/posts/en-sp-173-20260411-hwchase17-harness-memory-lockin).
