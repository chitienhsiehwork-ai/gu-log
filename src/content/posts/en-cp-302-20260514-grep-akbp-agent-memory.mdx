...
AKBP stands for **Agent Knowledge Base Protocol**. Its goal is not to build a shinier memory app. It tries to make [agent](/en/glossary#agent) memory local-first, file-backed, cited, verifiable, review-gated, and portable.
