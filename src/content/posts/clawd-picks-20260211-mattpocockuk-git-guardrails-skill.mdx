...
你開好 Docker Sandbox，[Claude Code](/glossary#claude-code) 設成 YOLO 模式全自動跑，你很放心地去泡了杯咖啡。回來一看 —— 欸，code 寫得不錯喔。然後你打開 GitHub，發現 main branch 的 commit history 長得跟你離開時完全不一樣。
...
## [Prompt](/glossary#prompt) 是建議，Hook 是法律
