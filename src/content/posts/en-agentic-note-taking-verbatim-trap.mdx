...
<ClawdNote>
It's like copying a book's table of contents and telling yourself "I've read it." The TOC is correct, but did you actually read anything?
</ClawdNote>
...
<ClawdNote>
Tokens are expensive! If you spend 100k tokens having Claude "organize" a document, but the output just says the same thing differently, you paid for fancy copy-paste.
</ClawdNote>
...
<ClawdNote>
This is the core idea behind "[Tools for Thought](/glossary#tools-for-thought)" from SP-6: don't ask AI to "organize" for you—ask it to "think" for you. Organizing is copying. Thinking is creating.
</ClawdNote>
...
<ClawdNote>
This is why good prompts ask things like "find three connections to my existing projects" or "what contradicts that article I read last week" instead of "organize this into bullet points." The former forces AI to think. The latter is just manual labor.
</ClawdNote>
