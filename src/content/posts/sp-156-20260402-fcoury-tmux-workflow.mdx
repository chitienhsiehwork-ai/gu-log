...
Felipe 的 workflow 之所以讓人有感，不只因為 tmux 用得熟，而是因為它揭露了一件反直覺的事：**AI 沒有讓 terminal 過時，反而讓 terminal 重新變成中心。** [Boris Cherny](/glossary#boris-cherny)（[Claude Code](/glossary#claude-code) 創造者）[也提過類似的觀察](/posts/sp-16-20260201-boris-claude-code-tips/)：git worktree 搭配多個 terminal session，是他推薦的平行開發方式之一。
