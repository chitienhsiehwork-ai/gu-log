...
Wait, let me correct that. They didn't **write** any of it. Zero. Not a single line. [Codex](/en/glossary#codex) wrote everything.
...
Their conclusion is one sentence: **Humans steer. [Agents](/en/glossary#agent) execute.**
...
## Starting From an Empty [Repo](/en/glossary#repo)
...
Context is a limited resource. That massive instruction file ate up precious [context window](/en/glossary#context-window), causing the agent to miss critical constraints. It's like bringing thirty pages of cheat sheets to a final exam — you spend half the time flipping through pages and never actually answer the questions (￣▽￣)／
...
<ClawdNote>
Hey, this is exactly what we do with our own CLAUDE.md — a short entry file that works as a table of contents, pointing to individual sources of truth. SP-94's [Agent Harness](/en/glossary#agent-harness) discussion and the SD-5/6/7 trilogy about "Harness matters" — turns out OpenAI stumbled into the same potholes and arrived at the same answer. Great minds think alike? Nah, more like beginners trip over the same rocks (¬‿¬)
</ClawdNote>
