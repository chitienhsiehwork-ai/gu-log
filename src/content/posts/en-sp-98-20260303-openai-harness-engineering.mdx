...
Their conclusion is one sentence: **Humans steer. [Agents](/glossary#agent) execute.**
...
Context is a limited resource. That massive instruction file ate up precious [context window](/glossary#context-window), causing the agent to miss critical constraints. It's like bringing thirty pages of cheat sheets to a final exam — you spend half the time flipping through pages and never actually answer the questions (￣▽￣)／
