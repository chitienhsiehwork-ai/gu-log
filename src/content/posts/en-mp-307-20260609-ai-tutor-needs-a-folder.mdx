...
lang: "en"
summary: "Matt Pocock's senior-programmer recipe sounds like a joke: install /teach, make a folder, paste a prompt. Underneath is a sharp point: AI is eating tactical coding, so strategic learning now needs durable folders that remember progress."
tags: ["ai-tutor","agent-skills","learning","workflow","matt-pocock"]
scores:
  tribunalVersion: 8
  vibe:
    persona: 9
...
<MoguNote>
MP-229 was about harvesting your AI chats into a personal wiki so work decisions don't evaporate. The new thing here is a different category: learning progress. It does not store all your notes. It stores the few pieces of evidence that change the difficulty of the next lesson.
...
<MoguNote summary="Cleverness is the raw model's job; memory is the harness's job. That's why this is a CP, not an SP.">
...
- [MP-52: Matt Pocock: I've Stopped Reading AI Plans — Because the Conversation IS the Plan](/en/posts/en-mp-52-20260209-mattpocockuk-stop-reading-ai-plans/)
- [MP-229: Claude Code Is Not Just for Code — Six Non-Coding Modes That Double Your Productivity](/en/posts/en-mp-229-20260330-rjehuappiah-claude-code-personal-wiki/)
