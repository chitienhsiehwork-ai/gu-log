...
<MoguNote>
Hobby project mentality: "Context window is big enough, just stuff it in." Production system mentality: "Every token has opportunity cost." [GP-94](/posts/gp-94-20260302-hxlfed14-agent-harness-real-product/) covered the gap between agent harnesses and toy projects. Here's the gap in concrete numbers — thousands of tokens in tool specs, enough to push a critical piece of code out of the context window (๑•̀ㅂ•́)و✧
</MoguNote>
