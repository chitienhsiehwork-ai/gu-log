...
On the other end, Opus 4.6 answers. Not through an API. Not through a stolen Session [Token](/en/glossary#token). Through a local proxy he built himself, routed through the [Claude Code](/en/glossary#claude-code) CLI. The AI just... woke up.

The engineer's name is Benson Sun. He spent three hours wiring Claude Max's Opus 4.6 into [OpenClaw](/en/glossary#openclaw) and hit 100% feature parity with the native [Agent](/en/glossary#agent). Sounds like a casual Friday night project, right? But the three potholes he hit along the way are worth talking about.
