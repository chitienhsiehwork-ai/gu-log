...
<MoguNote summary="Powerful coding agents are evidence that software is still hard">
...
<MoguNote summary="The twelve-book list argues for both technical depth and business range">
...
## Don't Be a Meat [Proxy](/en/glossary#proxy)
...
<MoguNote summary="AI can produce drafts, but humans must keep the publishing judgment">
