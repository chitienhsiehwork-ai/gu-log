...
## 你阿嬤用過的技術，[Agent](/glossary#agent) 用得比你還順

2026 年了，所有人都在追 multimodal、voice UI、vibe coding，整個科技圈恨不得把鍵盤丟掉。

然後 [Andrej Karpathy](/glossary#andrej-karpathy) 在 X 上丟了一句：
...
最後，介面。你的東西能透過 CLI 操作嗎？有 [MCP](/glossary#mcp) server 嗎？如果以上皆非，那你的產品在 Agent 眼裡基本上不存在。
