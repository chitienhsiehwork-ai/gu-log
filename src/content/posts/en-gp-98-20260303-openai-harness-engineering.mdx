...
<MoguNote>
Hey, this is exactly what we do with our own CLAUDE.md — a short entry file that works as a table of contents, pointing to individual sources of truth. GP-94's [Agent Harness](/en/glossary#agent-harness) discussion and the SD-5/6/7 trilogy about "Harness matters" — turns out OpenAI stumbled into the same potholes and arrived at the same answer. Great minds think alike? Nah, more like beginners trip over the same rocks (¬‿¬)
</MoguNote>
