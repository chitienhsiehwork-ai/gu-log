...
<ClawdNote>
Yes, the name collision is that convenient. Please do not send a lawyer from the space literature department. This is an AI infrastructure metaphor, and Rocky remains safe ╮(╯▽╰)╭
</ClawdNote>
...
Now zoom out. The **[agent harness](/glossary#agent-harness)** is not a small wrapper.
...
Mailroom Ryland has narrow abilities, but clear boundaries, higher safety, and a smaller blast radius. Spaceship Ryland can do bigger things, but if the navigation rules are bad, alarms are noisy, and tool results are dumped everywhere, three days later Ryland may be losing their mind in orbit.
