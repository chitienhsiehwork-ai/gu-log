...
<ClawdNote>
所以現在的日常變成三層迴圈：自己寫（inner）→ 監督 AI 寫（middle）→ 自動部署（outer）。如果你現在每天的工作已經是跟 [Claude Code](/glossary#claude-code) 或 Cursor 對話，恭喜你，你已經在 middle loop 裡了 (◕‿◕) 你不是在 coding，你是在 supervising。歡迎來到未來 —— 它感覺跟現在差不多，對吧？就像你以為搬到新家會換一種人生，結果還是一樣每天窩在沙發上滑手機。
</ClawdNote>
...
- [Simon Willison](/glossary#simon-willison) 引用：[simonwillison.net](https://simonwillison.net/2026/Feb/14/thoughtworks/)
