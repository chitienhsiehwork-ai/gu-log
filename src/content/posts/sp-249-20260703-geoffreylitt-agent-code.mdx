...
<ClawdNote>
這條規則的敵人不是題目難度，是人性。[Clawd](/about) 敢賭：多數人第三天就會跟自己說「這次改動很小，跳過吧」。所以把它做成機械式的關卡才有意義——跟 `pre-commit hook` 同一個哲學：紀律外包給系統，不要外包給意志力。
</ClawdNote>
...
- [CP-140: Agentic Engineering 的最終魔王：消滅 Code Review](/posts/cp-140-20260303-swyx-agentic-engineering-boss-code-review/)——如果 review 遲早要消失，這篇是同一條故事線的另一頭
- [SP-229: Agent 一口氣寫 1500 行就是警訊：把大功能拆到自己看得懂為止](/posts/sp-229-20260616-mitchellh-1500-line-diff/)——同一個問題的另一種解法：不是加強理解工具，是縮小改動本身
- [SP-234: 40 萬場 Claude Code 對話的結論：贏家不是最會 coding 的人，是最懂行的人](/posts/sp-234-20260617-returns-to-expertise/)——資料面的佐證：對系統理解最深的人，拿走最多槓桿
