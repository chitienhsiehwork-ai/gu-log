...
[Andrej Karpathy](/en/glossary#andrej-karpathy) has been there too. But his solution is a bit more... radical:
...
## 🤖 DeepWiki [MCP](/en/glossary#mcp) + GitHub CLI: 150 Lines of fp8 Code in 5 Minutes
...
He was working with [torchao](https://github.com/pytorch/ao) for fp8 training and hit some annoyances. He had a hunch: "Wait, shouldn't fp8 training basically just be a Function like [Linear](/en/glossary#linear), except with a few extra casts and three calls to `torch._scaled_mm`? Why is this so complicated?"
