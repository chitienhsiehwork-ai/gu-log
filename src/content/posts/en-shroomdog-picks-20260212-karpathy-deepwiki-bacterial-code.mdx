...
summary: "Karpathy used DeepWiki MCP and GitHub CLI to have Claude rip fp8 training out of torchao into 150 self-contained lines that ran faster. His bacterial code idea favors low-coupling, dependency-free code agents can extract and transplant."
lang: "en"
