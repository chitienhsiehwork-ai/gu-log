...
tags: ['shroom-picks', 'claude-code', 'multi-agent', 'workflow']
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 7
...
- [SP-169: Ghostty + Claude Code: Taming Multi-Pane Terminal Workflow With SAND](/posts/sp-169-20260411-dani-avila7-ghostty-claude-code-sand/)
- [SP-153: The Context Problem When 9 AI Agents Work Simultaneously — ECC Iterative Retrieval Pattern in Practice](/posts/sp-153-20260402-ecc-iterative-retrieval/)
- [SP-105: Claude Code Agent Teams: When AI Founds Its Own Company, Clocks In, and Holds Its Own Meetings](/posts/sp-105-20260305-claude-code-agent-teams/)
