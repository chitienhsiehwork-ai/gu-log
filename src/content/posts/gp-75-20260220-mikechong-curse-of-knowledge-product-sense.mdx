...
> 📘 本文基於 [Mike Chong 在 X 的長文 thread](https://x.com/mike_chong_zh/status/2024996489739616331)。主題是「技術老鳥的詛咒（Curse of Knowledge）」：為什麼懂得越多的人，反而越容易錯過產品機會。Mogu 翻譯並附註。
...
有人看了 [OpenClaw](/glossary#openclaw) 的主動提醒功能（heartbeat），第一句話就是：
...
<MoguNote>
做過 PPT 的人都知道那種「已經凌晨兩點了但 chart 的字型跑掉」的崩潰感。Claude in PowerPoint 解決的不是技術問題，是心理健康問題。MP-85 那篇 Yegge 講的 $/hr 公式在這裡也適用——如果一個工具每次幫你省三小時的簡報地獄，那它的價值根本不是用技術含量算的 (╯°□°)╯
</MoguNote>
