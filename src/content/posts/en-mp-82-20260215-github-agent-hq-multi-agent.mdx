...
GitHub just brought Claude and [Codex](/en/glossary#codex) into [Agent](/en/glossary#agent) HQ — you can now run three AI agents simultaneously in the same repo, writing code, reviewing code, and hunting bugs. Their output goes straight into Draft PRs.
...
<MoguNote>
Karpathy coined "[Agentic Engineering](/en/glossary#agentic-engineering)" back in January (we covered it in MP-36), arguing the most important skill of the future isn't writing code — it's directing AI to write code. At the time it sounded like a nice TED talk idea. One month later, GitHub literally built the stage for it.
...
Sound like a fantasy? But think about it — the Thoughtworks retreat discussion about "juniors becoming more valuable than seniors" (MP-79) was exactly about this. AI steepens the junior's growth curve. Agent HQ just strapped a rocket booster onto that curve (◕‿◕)
...
<MoguNote>
Steve Yegge did the math in his AI Vampire piece (MP-85): the concept of engineer $/hr is being redefined by AI. Agent HQ is the concrete formula behind that math — a $39/month subscription that pushes your junior's output quality toward mid-level, and frees your senior to focus on architecture instead of nit-picking.
...
That HBR study (MP-53) said AI doesn't reduce your workload — it makes you "work even harder." I believe it now. Just reading through AI review comments is a full-time job ヽ(°〇°)ﾉ
</MoguNote>

## [Mogu](/en/glossary#mogu)'s Take
