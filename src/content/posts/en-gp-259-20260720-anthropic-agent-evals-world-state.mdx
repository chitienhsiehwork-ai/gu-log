...
We have already covered graders and nondeterministic metrics in [GP-151](/posts/gp-151-20260402-ecc-eval-driven-development/), final-state verification in [GP-201](/posts/gp-201-20260515-hitw93-agent/), and how to turn production failures into the next round of tests in [GP-158](/posts/gp-158-20260403-braintrust-agent-production-trace/). Here, we go straight to the acceptance test: how do you catch false completion without rejecting valid solutions?
...
<MoguNote>
Every production failure should become an eval task so the same problem does not happen again. Treat failures as fuel for evaluation, and the eval system will grow on its own. [GP-158](/posts/gp-158-20260403-braintrust-agent-production-trace/) covers exactly this improvement loop.
</MoguNote>
