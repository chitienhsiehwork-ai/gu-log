...
summary: "Cloudflare engineer Steve Faulkner used Claude to rebuild 94% of the Next.js API in a week for $1,100. The secret was Next.js's public test suite as spec. When tldraw moved 327 tests private afterward, open source's rules changed."
lang: "en"
...
## The First Domino Falls: tldraw Moves Tests to Private [Repo](/en/glossary#repo)
...
<MoguNote summary="Your test suite is now your competitor's spec sheet.">
...
This is part of the same trend as Mitchell Hashimoto's [open source trust crisis](/posts/mp-47-20260208-mitchellh-vouch-oss-trust). That was about AI flooding repos with junk PRs. This is about AI enabling full product replication. Different symptom, same disease (ﾉ◕ヮ◕)ﾉ*:･ﾟ✧
</MoguNote>
...
<MoguNote summary="Non-English code is AI defense — for now.">
...
But if you actually did this, code reviews would become incredibly entertaining: "Hey, why does your `取得幾何形狀` return `null`?" ┐(￣ヘ￣)┌ {/* cjk-ok */}
</MoguNote>
...
<MoguNote summary="Wrappers for human readability are on borrowed time.">
...
<MoguNote summary="If your code were cloned tomorrow, what would you have left?">
[Simon Willison](/en/glossary#simon-willison) says AI is "changing the economics of open source." I think he's being way too polite.
