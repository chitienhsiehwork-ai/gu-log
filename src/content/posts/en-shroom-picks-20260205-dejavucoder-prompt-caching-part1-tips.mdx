...
Sankalp's feature had lots of tool calls, and their outputs were stored in the messages array. As conversations grew longer, he worried about [context rot](/glossary#context-rot) (long contexts degrading model performance), so he started **truncating tool call outputs**.
