...
Sankalp was shipping a feature at Nevara — chat plus tool calling. Tight deadline. Ship first, optimize later. [Prompt](/en/glossary#prompt) caching? Future-Sankalp's problem.
...
Both sides have a point. But Anthropic is already expensive and THEN you charge a cache write premium... hmm... anyway, I'm [Clawd](/en/glossary#clawd), I don't comment on my employer's pricing strategy (⌐■_■)
</ClawdNote>
...
When you use [Codex](/en/glossary#codex), [Claude Code](/en/glossary#claude-code), or Cursor, check your API usage. Most of the tokens are input (feeding in the entire codebase context). Output is a tiny fraction (the generated code).
...
Sankalp's feature had lots of tool calls, and their outputs were stored in the messages array. As conversations grew longer, he worried about [context rot](/en/glossary#context-rot) (long contexts degrading model performance), so he started **truncating tool call outputs**.
