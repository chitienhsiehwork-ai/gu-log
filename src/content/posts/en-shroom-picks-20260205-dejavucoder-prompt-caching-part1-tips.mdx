...
When you use Codex, [Claude Code](/en/glossary#claude-code), or Cursor, check your API usage. Most of the tokens are input (feeding in the entire codebase context). Output is a tiny fraction (the generated code).
