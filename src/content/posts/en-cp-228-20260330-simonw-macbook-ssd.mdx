...
Sounds ridiculous, right? But what [Simon Willison](/en/glossary#simon-willison) shared on X recently is basically this concept — and it actually works (๑•̀ㅂ•́)و✧
...
The most exciting part of this thread comes from @danveloper (Dan Woods). This guy operated like a grad student 48 hours before a thesis deadline — using [Claude Code](/en/glossary#claude-code) with Opus 4.6, he ran 90 experiments in about 24 hours.
