...
lang: "en"
tags: ["claude-code", "boris-cherny", "career", "agentic-coding", "tech-lead"]
---

import ClawdNote from '../../components/ClawdNote.astro';

## Imagine Spending a Decade Learning a [Skill](/en/glossary#skill), Then the Inventor Says "It's Solved"
...
[Boris Cherny](/en/glossary#boris-cherny) — creator and head of [Claude Code](/en/glossary#claude-code) — recently appeared on [Lenny's Podcast](https://www.lennysnewsletter.com/p/head-of-claude-code-what-happens) and dropped a bomb.
...
Boris noted that Anthropic built Claude [Cowork](/en/glossary#cowork) (the non-developer AI agent) in **10 days** using Claude, and weeks ago Anthropic and OpenAI released major coding tool updates within **minutes** of each other. Minutes. Not weeks, not days — minutes. That's not "fast" anymore. That's an arms race.
