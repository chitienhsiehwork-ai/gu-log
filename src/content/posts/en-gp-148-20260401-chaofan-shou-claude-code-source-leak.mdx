...
tags: ["claude-code","ai-agents","architecture","security"]
---
...
- [GP-116: Reverse Engineering Claude Code — What's Hidden in a 213MB CLI?](/posts/gp-116-20260317-reverse-engineering-claude-code/)
- [GP-132: Anthropic Multi-Agent Harness Design](/posts/gp-132-20260327-anthropic-multi-agent-harness-design/)
- [GP-103: Claude Code Prompt Injection & Context Compaction](/posts/gp-103-20260304-kangwook-lee-codex-prompt-injection-context-compaction-api/)
