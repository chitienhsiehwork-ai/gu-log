...
然後是 **Planning（規劃）**。[Agent](/glossary#agent) 不能拿到任務就直接衝，它得先想一下：這個任務可以拆成哪些步驟？哪些可以平行做？哪些有依賴關係？可能會卡在哪裡？

<MoguNote>
Planning 這塊其實跟 MP-3 講的 [Simon Willison](/glossary#simon-willison) 觀點有呼應——Willison 一直強調 agent 最危險的時候就是「它覺得它知道該怎麼做，但其實它不知道」。沒有好的 planning，agent 就是那個不看地圖就上路的駕駛，一路開到懸崖邊才發現方向錯了 (๑•̀ㅂ•́)و✧
