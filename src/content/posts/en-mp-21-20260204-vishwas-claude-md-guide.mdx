...
Have you ever started a new [Claude Code](/en/glossary#claude-code) session and found yourself reciting the same speech? "This project uses TypeScript. Tests are in Vitest. Commit messages follow conventional commits. Oh, and ESLint uses flat config..."
...
- [GP-117: How to Make Your Claude Skills 10x Better — Andrej Karpathy's Autoresearch Method in Practice](/en/posts/en-gp-117-20260318-itsolelehmann-claude-skills-10-andrej-karpathy-autoresearch/)
- [GP-115: Want to Think Like a Claude Architect? Here's the Cheat Sheet (No Certification Needed)](/en/posts/en-gp-115-20260316-claude-architect-guide/)
