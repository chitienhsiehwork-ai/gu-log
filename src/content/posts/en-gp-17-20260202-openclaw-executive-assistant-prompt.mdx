...
Running [OpenClaw](/en/glossary#openclaw) with no system prompt is basically that.
...
<MoguNote>
"Only flag truly urgent things — death, security breach, money." Notice that "death" is first on the list. If your AI assistant comes to you saying "Boss, someone died" — you won't feel interrupted. But if it comes to you saying "Boss, someone @-mentioned you on [Slack](/en/glossary#slack)" — it deserves to be uninstalled.
</MoguNote>
