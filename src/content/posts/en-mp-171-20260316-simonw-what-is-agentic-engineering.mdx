...
lang: "en"
summary: "Simon Willison finally defines Agentic Engineering after 11 hands-on chapters: using coding agents to help build software. The interesting part is why he needed the patterns first before the simple definition felt earned."
...
That's why Simon keeps emphasizing in other chapters to "[hoard things you know how to do](/en/posts/en-gp-88-20260227-simonw-hoard-things)" and "[use the TDD red-green cycle](/posts/gp-80-20260223-simonw-agentic-engineering-patterns) to help agents converge." These patterns are all about helping the agent system "learn," even though the underlying LLM starts fresh every single time.
