...
[Thariq](/en/glossary#thariq) from Anthropic posted a short but sharp thread about this, and his advice after talking with many companies building general agents is delightfully unglamorous: **use the bash tool more**. The point is not to make every agent cosplay as a software engineer. The point is to give the agent a real workbench — a place to save files, search them, rerun steps, and check its own work (◕‿◕).
...
He says the **Claude [Agent](/en/glossary#agent) SDK** includes a **bash parser** and **permission system** to make this easier.
