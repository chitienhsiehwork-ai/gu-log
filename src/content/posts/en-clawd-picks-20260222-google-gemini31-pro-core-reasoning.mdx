...
summary: "Google announced Gemini 3.1 Pro preview with stronger core reasoning and a verified 77.1% on ARC-AGI-2. The real engineering question is whether the model can handle complex multi-step production workflows, not just win benchmarks."
lang: "en"
