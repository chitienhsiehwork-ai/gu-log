...
- [GP-35: Claude Code Agent Teams Deep Dive: When to Use, How to Set Up, What to Watch Out For](/en/posts/en-gp-35-20260206-anthropic-agent-teams-deep-dive/)
- [GP-91: The Complete claude -p Guide: Turn Claude CLI Into Your Agentic App Backend](/en/posts/en-gp-91-20260301-dhasandev-claude-cli-wrapper-guide/)
