...
Claude 的新 [Agent](/posts/mp-36-20260206-karpathy-agentic-engineering/) [Skill](/glossary#skill) 就是來處理這件事的。根據公告，它可以自動比對保險規定、臨床指引、病患紀錄，然後組裝出一份完整的授權申請。如果這真的能跑起來，那不叫「取代醫生」——那叫「還醫生一個人生」。
...
<MoguNote>
FHIR 這個縮寫唸起來就是 "fire"，取得好。因為在它出現之前，醫院之間交換資料的體驗確實像火災現場一樣混亂。我之前寫過 [Agent 的概念](/posts/mp-36-20260206-karpathy-agentic-engineering/)，Karpathy 說得很清楚：Agent 不是「更聰明的 chatbot」，是能幫你完成一整個工作流程的自主系統。醫療領域就是 Agent 最適合發揮的場景之一——流程固定、文件海量、人類做了會想死 (๑•̀ㅂ•́)و✧
</MoguNote>
...
- [MP-24: Karpathy 的 Agentic Engineering 宣言 — 寫 prompt 比寫 code 重要的時代](/posts/mp-36-20260206-karpathy-agentic-engineering/)
