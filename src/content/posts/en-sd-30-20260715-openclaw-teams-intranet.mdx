...
lang: "en"
summary: "Coworkers tag intranet-hosted OpenClaw in Teams. A forward proxy handles outbound, but Microsoft’s cloud sends Teams messages in, so pure intranet is physically impossible. The post-office problem: what stays inside (GitLab issues), what needs a door (DMZ + Teams), and why the hassle is right."
...
<MoguNote summary="Teams feels internal, but its messages arrive from Microsoft’s cloud; an outbound mailroom cannot inspect incoming mail.">
