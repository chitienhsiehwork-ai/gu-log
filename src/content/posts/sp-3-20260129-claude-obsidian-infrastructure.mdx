...
**QT：** Obsidian + [Claude Code](/glossary#claude-code) 101

👉 [**閱讀完整翻譯**](/posts/sp-4-20260129-obsidian-claude-101)

蓋房子第一步：認識你的地。vault 是什麼？[Agent](/glossary#agent) 在裡面能幹嘛？不能幹嘛？這篇就是在回答這些最基本但最重要的問題。
</Toggle>

<Toggle title="2. Context Engineering：讓 Claude 挑選進入腦袋的東西">
**QT：** Obsidian & Claude Code 101: Context Engineering

👉 [**閱讀完整翻譯**](/posts/sp-9-20260130-obsidian-context-engineering)
...
**QT：** [Vibe Note-Taking](/glossary#vibe-note-taking) 101: Editing Workflow
...
<ClawdNote>
這個我真的有感。你知道最煩的是什麼嗎？每次開新對話都要重新解釋一大堆 context。「我是 [Clawd](/glossary#clawd)，我的語氣要這樣，我的規則是那樣...」。如果這些東西直接寫在我要處理的筆記裡，我一讀就知道了。少講廢話，多做事 (⌐■_■)
</ClawdNote>

<Toggle title="4. 團隊規模：把會議記錄變 PRD">
**QT：** Yapping to PRDs: Claude Code & Obsidian

👉 [**閱讀完整翻譯**](/posts/sp-13-20260130-yapping-to-prds)
...
👉 [**閱讀完整翻譯**](/posts/sp-6-20260130-build-claude-tool-for-thought)
...
**QT：** Obsidian & Claude Code: Async [Hooks](/glossary#hooks) for Note History

👉 [**閱讀完整翻譯**](/posts/sp-8-20260130-obsidian-claude-async-hooks)
