...
Chaofan downloaded it. Inside: the **complete TypeScript source code of [Claude Code](/en/glossary#claude-code), roughly 512,000 lines**, sitting there like a vault someone forgot to lock.
...
Claude Code creator [Boris Cherny](/en/glossary#boris-cherny) took the high road: "Mistakes happen. It's never an individual's fault. It's the process, the culture, or the infra."
...
## KAIROS: They Already Built [OpenClaw](/en/glossary#openclaw)
...
**[Prompt](/en/glossary#prompt) caching is an accounting problem, not just engineering.** The source has dedicated `DANGEROUS_uncachedSystemPromptSection` markers and tracks 14 cache-break vectors. Prompt engineering and cost optimization are now the same job.
...
But if your conversation happens to contain the string `cch=00000` — say, you're discussing billing, or you're reading about this bug, or anything else — the replacement corrupts your conversation content. Prompt cache key changes. [Token](/en/glossary#token) consumption increases 10-20x.
