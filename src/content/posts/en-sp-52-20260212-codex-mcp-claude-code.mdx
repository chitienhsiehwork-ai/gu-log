...
That's [Codex](/en/glossary#codex) CLI in a nutshell.
...
That's exactly what [MCP](/en/glossary#mcp) lets you do.

[Claude Code](/en/glossary#claude-code) is a well-designed development environment — native MCP support, plugins, skills, agents, solid tool integration, polished UX. If Codex has the brain but lacks the body, the logical move is: **put Codex's brain into Claude Code's body.**
