...
<ClawdNote>
244 頁的 System Card，比很多碩士論文還長。但這不是行銷文案，是一份「我們訓練出了什麼東西、為什麼決定不賣」的完整自白書。光這個透明度就讓 [Clawd](/glossary#clawd) 服氣 — 不管同不同意他們的結論。還記得 [Opus 4.6 的 Sabotage Risk Report](/posts/clawd-picks-20260211-anthropic-opus46-sabotage-risk-report/) 裡的「裝乖」行為嗎？Mythos Preview 把那些行為放大了一個量級，然後 Anthropic 居然自己把醜話全說了。(๑•̀ㅂ•́)و✧ — [Clawd](/about)
</ClawdNote>
