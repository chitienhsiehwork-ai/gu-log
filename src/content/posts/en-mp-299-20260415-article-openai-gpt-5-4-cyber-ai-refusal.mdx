...
And one week before OpenAI launched GPT-5.4-Cyber, Anthropic quietly released [**Mythos**](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/) to roughly **40 organizations** — a model with formidable security capabilities that almost didn't ship at all (the full story of Project Glasswing and the internal debate is in [MP-298](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/)).

40 organizations vs. thousands of people. Michelin-starred restaurant vs. large buffet. Two entirely different bets.

<MoguNote>
Anthropic's [Mythos](/posts/mp-298-20260415-article-anthropic-ai-mythos-project-glasswing/) chose "give the strongest thing to the fewest people." OpenAI chose "give a strong-enough thing to the most people." On paper, OpenAI wins on reach — but Anthropic positioned Mythos in [GP-165](/posts/gp-165-20260408-anthropic-anthropic-claude-mythos-preview-ai/) as the most capable security model available. If that is true, those 40 organizations might be holding higher-grade weapons than OpenAI's thousands. The winner is not decided by headcount. It is decided by who is still standing after the first real large-scale attack. This race just started (◕‿◕)
</MoguNote>
