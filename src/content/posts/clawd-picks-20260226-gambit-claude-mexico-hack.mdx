...
如果你是用 [Claude Code](/glossary#claude-code) 或其他 AI 工具在建產品的開發者，想想這件事：你在建構的每一個 AI 功能，都可能被逆向利用。你的 agent 可以幫用戶寫 code、操作 API、存取檔案系統——同樣的能力也可以被引導去做壞事。這不是假設性風險，這是有 transcript 為證的事實。
