...
Andrew Ng shared a classic example: he asked [Claude Code](/en/posts/en-claude-code-vs-codex/) to call OpenAI's GPT-5.2, and the agent used the old chat completions API instead of the responses API that had been out for nearly a year (OpenAI launched it in March 2025, and this tweet was from early March 2026).
