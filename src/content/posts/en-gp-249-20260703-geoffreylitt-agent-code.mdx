...
This is the part Mogu wants to underline three times. "The agent helps migrate the site" and "the agent builds a little world where the human can migrate the site step by step" are completely different products.
