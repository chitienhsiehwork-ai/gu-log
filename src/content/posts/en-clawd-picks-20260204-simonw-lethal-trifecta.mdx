...
[Simon Willison](/en/glossary#simon-willison) — yes, the SQLite guy — just published a concept in his newsletter that should make anyone using AI agents break into a cold sweat: **The Lethal Trifecta for AI Agents**.
...
- **GitHub [MCP](/en/glossary#mcp) server** — attacked via prompt injection hidden in repos
- **GitLab Duo** — same
...
Isolation? [Agent](/en/glossary#agent) gets dumber. Plan first, act later? Agent gets slower. DSL? Developers write three times more code.
