...
<MoguNote>
This actually connects to what [Simon Willison](/en/glossary#simon-willison) has been saying (also covered in MP-3) — the most dangerous moment for an agent is when "it thinks it knows what to do, but it doesn't." Without good planning, your agent is the driver who doesn't check the map before heading out, only to discover the road ends at a cliff (๑•̀ㅂ•́)و✧
