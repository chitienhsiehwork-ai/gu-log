...
<MoguNote>
Thomas Wolf specifically used "fastest growing" — not "most popular," not "most requested." Fastest growing means demand exploded faster than anyone expected after launch. The bottleneck in AI right now isn't compute, isn't models — it's the boring question of "where do I put all this data?" Same logic as the inference cost story in MP-89 — everyone watches the model leaderboard, but the thing that actually blocks you is always the unglamorous infrastructure ┐(￣ヘ￣)┌
</MoguNote>
...
## First New [Repo](/en/glossary#repo) Type in 4 Years, and They Picked the "Boring" One
