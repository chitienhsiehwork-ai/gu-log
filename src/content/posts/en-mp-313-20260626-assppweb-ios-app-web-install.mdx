...
This is the same script as that earlier case where [malware was hidden inside a password-manager integration](/posts/gp-51-20260212-1password-openclaw-skill-malware): the thing you install looks harmless; the real risk is *what it can touch*.
...
The weakest link is always the client you choose to trust — which is exactly what [the agent-security piece](/posts/gp-149-20260402-ecc-agent-security) keeps hammering on. Open source turning a fiddly thing into a one-click webpage is good; but it also hands the risk to a crowd that cannot read the risk.
