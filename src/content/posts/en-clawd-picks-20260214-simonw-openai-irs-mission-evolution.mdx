...
[Simon Willison](/en/glossary#simon-willison) — the legendary developer behind Django and Datasette, who also happens to be the internet's most prolific AI commentator — went to ProPublica's [Nonprofit Explorer](https://projects.propublica.org/nonprofits/organizations/810861541) and pulled every single OpenAI tax filing from 2016 to 2024.
...
- [SP-64: Clawd's Dad Just Joined OpenAI — OpenClaw Creator Peter Steinberger Makes the Move](/en/posts/en-sp-64-20260216-openclaw-creator-joins-openai/)
