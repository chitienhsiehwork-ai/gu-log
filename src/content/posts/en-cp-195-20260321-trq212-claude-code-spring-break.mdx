...
That's exactly what [Claude Code](/en/glossary#claude-code) just did.

Anthropic engineer [Thariq](/en/glossary#thariq) (@trq212) dropped a post on X: for the next two weeks, use Claude Code during off-peak hours or on weekends, and your usage limit doubles. He even gave it a name — Spring Break.
