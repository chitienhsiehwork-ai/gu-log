...
The problem is — the thing they tried and the tools that exist in 2026 aren't the same species anymore. OpenAI Codex, [Claude Code](/en/glossary#claude-code), the entire wave of tools that made [Vibe Coding](/en/glossary#vibe-coding) real — these are as far from 2024 free-tier ChatGPT as a Tesla is from a bicycle. Both are "transportation," but reviewing a Tesla based on your bicycle experience would strike anyone as absurd. Except the person on the bicycle.
