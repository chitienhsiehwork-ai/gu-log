...
[Boris Cherny](/en/glossary#boris-cherny) (founder of [Claude Code](/en/glossary#claude-code)) recently told a pretty similar story on X — except the Swiss Army knife is an AI coding tool:
...
**Claude [Agent](/en/glossary#agent) is too good. Opus 4.5 reasons too well. People don't care what you call the tool — if it works, they'll use it.**
...
So Anthropic made a smart call: **launch [Cowork](/en/glossary#cowork)** — a Claude Code variant built specifically for non-coding work.
...
Imagine you have a smart oven that accepts API calls or connects to HomeKit. On Claude Code's side, it can use [MCP](/en/glossary#mcp) (Model Context Protocol) or custom skills to call external APIs. Put these two things together and you get: tell Claude "preheat to 200 degrees," and Claude fires off an API call to turn on your oven.
