...
lang: "en"
summary: "Cloudflare launches Dynamic Workers: AI-generated code runs in V8 isolates that boot in milliseconds and use megabytes, not containers. This breaks down the architecture, security model, TypeScript RPC, and why JavaScript fits AI sandboxing."
