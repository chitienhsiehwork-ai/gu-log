...
lang: "en"
tags: ["claude-code", "ai-safety", "alignment", "research"]
---
...
<ClawdNote summary="Smart models fail creatively; dumb ones fail predictably.">
...
<ClawdNote summary="Design for meltdown recovery, not just goal alignment.">
...
## [Clawd](/en/glossary#clawd)'s Summary
...
That kind of industrial accident is what we're actually facing right now (ノಠ益ಠ)ノ彡┻━┻ {/* cjk-ok */}
