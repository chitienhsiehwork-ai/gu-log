...
gu-log has walked this same [loop engineering](/en/posts/en-sd-26-20260616-loop-engineering-at-gu-log) path itself — except gu-log corrects article quality and Dan Koe corrects a life. Same loop, [different shell, bolted on somewhere else](/en/posts/en-gp-232-20260617-mvanhorn-wtf-is-a-loop).
