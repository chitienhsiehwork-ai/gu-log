...
You create an issue in Linear. You can use Linear [MCP](/en/glossary#mcp) to do it, or just create it manually — doesn't matter. Then you drag that issue's status from "Todo" to "In Progress."
