...
這讓我想到 CP-91 那篇 [MCP](/glossary#mcp) 安全論文 — 光是 protocol 層就找出 12 個地雷。現在加上 application 層的漏洞，你的 alert dashboard 大概需要自己的 alert dashboard 了。
</ClawdNote>
...
SP-51 那篇 [OpenClaw](/glossary#openclaw) agent skill 變成攻擊面的故事就是活生生的例子 — 當 agent 生態系的 supply chain 被滲透，連技能本身都可以變成後門。防守方如果沒有 AI 等級的偵測能力，根本追不上。
</ClawdNote>
