...
Teknium retweeted @peterom, who shared something short but interesting: they're running an experiment on Hermes [Agent](/en/glossary#agent) that lets the agent **steer itself** — adjusting its own behavior mid-execution.
