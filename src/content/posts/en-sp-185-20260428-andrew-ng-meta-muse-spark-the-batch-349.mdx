...
The Batch's own "We're thinking" section flags an emerging pattern: **Muse Spark's [contemplating mode](/en/glossary#contemplating-mode) and Kimi K2.5's Agent Swarm both point in the same direction — more labs scaling performance through "inference-time multi-agent orchestration" rather than continuing to train ever-larger single models**.
