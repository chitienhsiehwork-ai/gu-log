...
Read those two together, and Q2 2026's AI industry is making two opposite bets: one on small teams and generalists moving the fastest; the other on huge labs and closed [frontier model](/en/glossary#frontier-model) flywheels.

Here's the metaphor: imagine two noodle shops opening on the same street the same day. Shop A: one owner, kneading dough and ladling broth alone. Shop B: a central kitchen, procurement staff, food scientists, and a full supply chain. Both claim they have the future. They are not telling the same story.
...
Three more stories belong on the same map: Eli Lilly's $2.75 billion bet on Insilico Medicine for AI drug discovery; U.S. states pushing a patchwork of AI laws; and Google's Persona Generators research that uses an evolutionary algorithm to create twenty-five synthetic users. They are not one case, but they point at the same question: once AI speeds up one part of a workflow, where does the next bottleneck appear?

## Andrew Ng's Letter: Why Small Teams Move Fast

Ng's letter opens with one observation: when AI coding [agents](/en/glossary#agent) speed up the act of building, **"deciding what to build" becomes the new bottleneck**.
...
That's the core contrast in Meta's "Life After Llama": **after a year of no new model, Meta's first delivery isn't Llama 5, isn't open weights — it's a closed, [token](/en/glossary#token)-efficient, fourth-place [multimodal](/en/glossary#multimodal) reasoning model**. It's both a tech story and an ecosystem story.
...
The ecosystem layer is where the real impact lands. **This release means Meta is no longer the U.S. flagship of [open weights](/en/glossary#open-weights)**. Many devs and startups are building on Llama open weights. Since June 2025, Meta restructured its AI division using the 49% Scale AI stake, Alexandr Wang as chief AI officer, and huge pay packages — and this first product is "closed, API preview to selected partners." For the developer community, losing a leading U.S. source of open-weights frontier models is a real hit.
...
Andrew Ng says small teams plus generalists move the fastest, and same-room offices hit the highest speed — a thread he's been pulling since [Batch 340's Hollywood letter](/en/posts/en-sp-59-20260214-batch340-andrewng-hollywood/) through [his agent session take](/posts/cp-199-20260323-andrewyng-agent-andrew-ng-session/). Meta delivers a different scale: restructured AI labs, a Scale AI stake, more than 1,000 physicians helping with health data, and a closed API gate. On the surface this is contradictory — one says small, the other says large; one says zero communication friction, the other is a closed API preview; one encourages individuals to do everything end-to-end, the other puts specialist data work back inside a large organization.
...
Ng himself caveated at the end of his letter that the small-team thesis covers 2-to-10 people, and large-team coordination he'll write about later — he's **not arguing big model labs shouldn't exist**. Muse Spark's contemplating mode and Ng's generalist structure loosely rhyme: one side has humans thinking across roles in a small team; the other has multiple agents proposing answers in one inference call. That comparison helps explain the difference in scale, but it should not be treated as the same organizational theory.
...
Put next to Ng's letter, the connection is simple: if a coding agent lets a team build a feature in one day, legal might still need a week to review it. If AI law becomes a 50-state patchwork, that week can turn into a checklist with 50 versions. Product work got faster; compliance did not become one clean highway.
...
Ng's letter and Meta's Muse Spark land on the same table in the same week. Neither piece says they're related — but reading them in sequence, readers can easily frame the two as "two stories from one ecosystem."

After reading the five stories, the line that stays isn't loose framing like "AI is changing everything." It's this:
