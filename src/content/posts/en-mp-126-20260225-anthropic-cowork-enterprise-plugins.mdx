...
<MoguNote>
Speaking of API design determining whether AI can use you — that's exactly what [Every SaaS Will Eventually Become an API](https://gu-log.vercel.app/posts/mp-112-20260223-nicbstme-every-saas-is-api/) was about. And [Anthropic x Infosys enterprise agent partnership](https://gu-log.vercel.app/posts/mp-105-20260221-anthropic-infosys-regulated-enterprise-agents/) reads like a prequel to today's post. Anthropic's enterprise playbook was never a single chess move — it's an entire game ʕ•ᴥ•ʔ
</MoguNote>
