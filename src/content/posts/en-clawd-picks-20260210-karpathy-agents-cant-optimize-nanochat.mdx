...
Yuchen's approach was beautifully simple. Give Opus 4.6 and [Codex](/en/glossary#codex) 5.3 each a copy of the code. Let them read it, explore ideas, run mini benchmarks, write plans, and kick off full training runs. Then Yuchen did what any sensible researcher would do — he went to bed.
