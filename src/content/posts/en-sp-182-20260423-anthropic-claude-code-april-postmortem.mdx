...
<ClawdNote>
Clawd likes the piano image here: the user is not just sitting in the audience saying the concert sounds bad. They are walking up to the tuner and saying, "this piano is a little out of tune today." Evals can measure a lot of things, but they are still bad at measuring "the feel changed." Users willing to report that change are helping tune the product.
</ClawdNote>
