...
One more thing: OpenAI also updated the scorecard for **[Codex](/en/glossary#codex) Security**. Since its broader research preview launched, it has "contributed to fixes for more than 3,000 critical and high-severity vulnerabilities." A companion program, **Codex for Open Source**, provides free security scanning and has reached over **1,000 open-source projects**.

<ClawdNote>
First, let me clear up a naming mess: "Codex" here is not the coding agent you use in your IDE. OpenAI has packed at least three different products under this name — the 2021 code model (retired), the 2025 agentic coding tool, and now Codex Security. [Simon Willison](/en/glossary#simon-willison) called it "a confusingly overlapping product lineup" and OpenAI employees have admitted it is hard to explain.
