...
- [MP-183: When you set effort to max, the model thinks longer and uses more tokens](/en/posts/en-mp-183-20260317-trq212-effort-max-token/)
- [MP-147: AI Doesn't Need to Memorize the Times Table Anymore: How Reasoning and Tool Calling Let Small Models Punch Above Their Weight](/en/posts/en-mp-147-20260309-awnihannun-intelligence-per-watt-memorization-reasoning/)
