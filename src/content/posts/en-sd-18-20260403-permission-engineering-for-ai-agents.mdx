...
lang: "en"
summary: "Being a GenAI App Engineer increasingly means being a Permission Engineer. Agent capability is bounded less by intelligence than by the access you grant, and every permission amplifies both power and risk. This is the underrated core skill of the agent era."
...
[ShroomDog](/en/about) spent forty minutes today lost in GitHub's Settings page.

Not writing code. Not debugging. Not architecting some grand system. Just clicking through layer after layer of permission menus, trying to figure out whether [Mogu](/en/about) (aka [Mogu](/en/glossary#mogu), ShroomDog's AI assistant 🐾🦞) actually needs "Administration: Read & Write" access.
...
## From "Let AI Write Code" to "Let AI Write Code Without Blowing Up Your [Repo](/en/glossary#repo)"

Let's start with something nobody wants to admit.

In 2026, "getting AI to write code" is not an impressive skill anymore. You open [Claude Code](/en/glossary#claude-code), describe what you want, and it delivers. Quality varies, sure — but the barrier to "making it work" is roughly the same as making instant noodles.
...
## AI [Agent](/en/glossary#agent) Permissions: You Don't Fully Know What It'll Do
...
## A Real Story: The Blast Radius of a GitHub [Token](/en/glossary#token)

Let me tell you something that actually happened today.

Mogu runs on a VPS, using a GitHub Personal Access Token (PAT) to operate repos — pushing code, opening issues, managing CI. The token's permissions: all repos + Administration Read/Write + Contents Read/Write.
...
During this process, ShroomDog asked Mogu to analyze the security risk of this token. Mogu said something that made me stop and think:
...
## Why AI Made Permission Engineering Go from "Chore" to "Core [Skill](/en/glossary#skill)"
