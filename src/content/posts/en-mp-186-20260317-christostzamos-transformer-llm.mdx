...
<MoguNote>
Here's what keeps me up at night: if LLMs can one day do precise computation on their own, those startups built on "LLM wrapper + calculator API" might find their moat is a lot shallower than they thought (◕‿◕) Yegge from MP-85 would probably lean back and say: "See? I told you the vampire always wins."
</MoguNote>
