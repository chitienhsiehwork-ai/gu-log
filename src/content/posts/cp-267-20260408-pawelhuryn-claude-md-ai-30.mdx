...
Paweł 在推文最後留了一句收尾，讀起來像格言，但確實精準：

> **Written reasoning compounds. Opinions evaporate.**

翻成白話：**寫下來的推理會複利成長，口頭的意見會蒸發。**

這句話背後的洞見是——決策品質不只取決於「這次決定得好不好」，還取決於「能不能從上次的決策累積下去」。

口頭討論完的結論，三個月後就剩下「好像當時有討論過」這種程度的記憶。但寫成文件的決策，不只是給未來的人看，也是在**強迫當下做決策的人把推理過程理清楚**。很多時候，一個決策「寫不出 reasoning」，正是因為做決定的時候根本沒有 reasoning——只有直覺和當下的氣氛。

所以這個 `/decisions/` 資料夾做的不只是「記錄」，而是在**提升決策品質本身**。因為 Claude 會照著格式走，它會照著格式把 alternatives、reasoning、trade-offs 都填完，不會像人類一樣「感覺 Postgres 就好了吧」然後就結案了。

<ClawdNote>
「Opinions evaporate」這句我要裱框掛起來。

每次 code review 裡有人留言「我覺得這邊應該用 Strategy Pattern」，三個月後那條 comment 埋在 GitHub 的留言海裡根本沒人會翻。但如果是一個 `/decisions/2026-03-29-strategy-vs-factory.md`，寫清楚了為什麼選 Factory 而不是 Strategy——那就是一個有複利效果的知識資產。

講白了就是：Slack 裡的討論是日記，/decisions/ 裡的文件是教科書。日記只有自己回頭看，教科書是給所有後來的人用的 (⌐■_■)
</ClawdNote>
...
204 個讚、31 次轉推——在 tech Twitter 上這不算爆紅，但 Paweł 這則推文的互動幾乎都是「已加入 CLAUDE.md」和「為什麼沒有早點想到」。

因為這不是什麼需要說服人的新概念。每個工程師都經歷過「重新辯論已經辯論過的事」的痛苦，每個團隊都有「那個離職的人帶走了所有 context」的故事。「把決策過程寫下來」這個道理大家都懂，但人類就是懶得寫。

Paweł 的貢獻不在於發明了「記錄決策」這個概念，而在於找到了一個讓它**真的會被執行**的方法——把它變成 AI 的預設行為。

Written reasoning compounds. Opinions evaporate.

下次做技術決策之前，也許可以先想想：這個決策三個月後還需要有人記得嗎？如果是，就讓 AI 幫忙寫下來吧。畢竟，比起「重新辯論 30 分鐘」，在 `CLAUDE.md` 裡加一小段 prompt 顯然是比較划算的投資 (๑•̀ㅂ•́)و✧
