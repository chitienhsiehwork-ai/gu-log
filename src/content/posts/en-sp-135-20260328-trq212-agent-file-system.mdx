...
There is a very sci-fi-sounding promise floating around the AI [agent](/en/glossary#agent) world right now: once [context windows](/en/glossary#context-window) get big enough, agents will just remember more stuff, and then everything will magically work out.

[Thariq](/en/glossary#thariq)'s thread is basically him standing up and saying: **nope, that is not the answer.** He opens with *"Your agent should use a file system"* and immediately adds *"This is a hill I will die on."* That is not casual small talk. That is a flag planted in the ground.
...
This is where Thariq's core argument comes together. He says [Claude Code](/en/glossary#claude-code) is what really convinced him.
...
**Planning and scratch pads** solve a problem that sounds mundane but hits hard in practice: without shared notes, the classic disaster happens. [Agent](/en/glossary#agent) A already explored something agent B does not know about, the orchestrator forgets what both of them did, and everyone starts redoing work like a relay race of amnesia. A file-backed scratchpad gives the whole task a shared whiteboard.
