...
但 [Simon Willison](/glossary#simon-willison) — 就是那個 Django 共同創辦人、開源圈的老前輩 — 最近在 X 上說了一句讓人脊背發涼的話：
...
事情的起頭是 Anthropic 的 Alex Albert。他發了一則推說自己用 [Claude Code](/glossary#claude-code) 最大的改變：
