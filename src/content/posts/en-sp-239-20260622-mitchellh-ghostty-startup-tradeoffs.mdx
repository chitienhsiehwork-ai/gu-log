...
lang: 'en'
summary: 'Someone called Ghostty "unusable" because it takes a second to launch. Its author, Mitchell Hashimoto, replied with a textbook explanation of tradeoffs: the slow cold start is not a bug, it is the cost paid up front to buy you eight smooth hours. Along the way he punctures a classic engineering mistake — is the thing you are optimizing a button you press once a day?'
