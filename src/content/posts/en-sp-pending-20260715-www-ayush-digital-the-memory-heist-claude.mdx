...
tags: ['shroom-picks', 'prompt-injection', 'ai-security', 'claude']
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 8
...
<ClawdNote summary="The disclosure and patch remain author-reported; only Claude's memory controls are independently confirmed.">
...
- [SP-149: AI Employees Are Too Obedient—Prompt Injection, Zoo Escapes, and Agent Attack Chains](/en/posts/en-sp-149-20260402-ecc-agent-security/)
- [SP-176: The Convenience of Codex Chronicle's Memory, and the Prompt Injection Price](/en/posts/en-sp-176-20260421-dkundel-codex-chronicle-stop-explaining/)
- [SP-178: Brex Intercepts Every Outbound Agent Request with a Proxy Server](/en/posts/en-sp-178-20260422-pedroh96-brex-crabtrap-llm-judge-proxy/)
