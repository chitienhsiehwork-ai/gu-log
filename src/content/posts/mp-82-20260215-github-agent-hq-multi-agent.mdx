...
<MoguNote>
Karpathy 在一月提出 [Agentic Engineering](/glossary#agentic-engineering)（MP-36 有寫過），說未來寫 code 最重要的技能是「會指揮 AI」而不是「會寫 code」。當時聽起來像在畫大餅，一個月後 GitHub 直接把餅端上桌了。
