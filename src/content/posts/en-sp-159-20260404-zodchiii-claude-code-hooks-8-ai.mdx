...
SP-16 covered [Boris Cherny](/en/glossary#boris-cherny)'s (Claude Code creator) usage tips, where he mentioned CLAUDE.md can specify "don't touch these files." But Boris himself later admitted that prompt-level restrictions aren't hard enough — which is why hooks exist.
