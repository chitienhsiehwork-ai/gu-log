...
Not every metric can be measured live. But it still needs to appear in the spec. Otherwise the agent will take the shortest path to the goal: speed improves, customers get angrier; tests go green, the alarm was unplugged; escalations fall, risk goes underground.
