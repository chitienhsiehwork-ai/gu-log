...
lang: "en"
summary: "Berryxia uses Dense vs MoE to explain why Codex shines at bug fixes, refactors, and long-running engineering while Claude wins vibe coders. The real split is broader: training philosophy, product design, and precise delegation versus interactive creation."
...
The second one says: "I want to build a side project that feels like [Linear](/en/glossary#linear), but more relaxed — maybe with some Notion cleanliness, and please don't make onboarding feel like filing taxes."
...
Berryxia's post tries to explain this exact thing: **why so many traditional programmers like [Codex](/en/glossary#codex), while vibe coders keep drifting back to Claude.**
...
If architecture were the only variable — same training objective, same [RL](/en/glossary#rl) targets, same interface, same feedback loop — then Dense vs MoE would explain much more.
