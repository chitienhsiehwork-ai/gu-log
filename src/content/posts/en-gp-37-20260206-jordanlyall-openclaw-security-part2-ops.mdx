...
This is **Part 2 of 2** in Jordan Lyall's secure [OpenClaw](/en/glossary#openclaw) deployment series.

> **Series Navigation:**
> - [Part 1 (GP-36)](/en/posts/en-gp-36-20260206-jordanlyall-openclaw-security-part1-infra) — Infrastructure: Tailscale + command allowlist + Telegram authentication
> - **Part 2 (this post):** Agent configuration + operational lessons + emergency procedures

In Part 1, we built the infrastructure fortress. But the thing living inside that fortress — your [agent](/en/glossary#agent) — still needs to learn some manners. Build the walls as high as you want; if the resident is undisciplined, it won't matter. This post covers how to **train the agent itself**, plus the real disasters Jordan walked into along the way.

---

## 🧠 Phase 3: Configure the [Agent](/en/glossary#agent) — The SOUL File
...
## 🔐 API [Token](/en/glossary#token) Scoping: Minimum Permissions
...
[Context windows](/en/glossary#context-window) are finite. If you don't clean them periodically, they explode.
...
<MoguNote>
Compare this to ShroomDog's setup (see GP-36) at ~$45/month.
...
Tip four ties back to Part 1: "**Command allowlist, not open shell.** [Prompt](/en/glossary#prompt) injection resistance isn't perfect — you need system-level blocking."
...
- [GP-51: From Magic to Malware: How OpenClaw's Agent Skills Became an Attack Surface](/en/posts/en-gp-51-20260212-1password-openclaw-skill-malware/)
- [GP-53: I Fed 20 Articles to Opus 4.6 and Asked It to Write an OpenClaw Setup Guide. Here's What Actually Works.](/en/posts/en-gp-53-20260213-openclaw-setup-guide-review/)


<MoguNote>
"Two weeks stable before expanding" — sounds slow, right?

But think about what most people do. "Oh it works! Awesome! Let's add [Slack](/en/glossary#slack) integration! And auto-reply! And automated purchasing!" Three days later the agent buys a case of dog food with your credit card.
...
This is the final post in the series. Combined with [Part 1's infrastructure setup](/en/posts/en-gp-36-20260206-jordanlyall-openclaw-security-part1-infra), you have a complete security blueprint from infra to ops. If you also want code-level protections, check out [GP-29 — jzOcb's 4-Layer Defense System](/en/posts/en-gp-29-20260205-jzocb-ai-agent-4-layer-defense) — that covers code hooks and config guards, complementary to the infra + ops approach here.
