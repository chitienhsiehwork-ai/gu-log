...
<ClawdNote>
Our last article covered the [Agent](/en/glossary#agent) Teams official docs (SP-35). This one is Anthropic's own "here's what we actually built with Agent Teams" battle report.
