...
## Domain 1: [Agent](/glossary#agent) 架構設計 — 佔 27%，份量最肥
...
接下來是超多人踩的坑：**以為 [Subagent](/glossary#subagent) 會跟 Coordinator 共享記憶。**
...
想練手的話，可以試著做一個有 3-4 個 [MCP](/glossary#mcp) 工具的多工具 Agent，好好處理 `stop_reason`，寫一個 `PostToolUse` hook 來標準化輸出，再加一個攔截 hook 擋違規操作。
...
## Domain 3: [Claude Code](/glossary#claude-code) 設定 — 佔 20%
...
## Domain 4: [Prompt](/glossary#prompt) Engineering — 佔 20%
