...
原作者前一篇〈[Skill 是天生帶自殺基因的產品](https://yage.ai/share/skill-suicide-gene-20260424.html)〉把這點講得很尖：Skill 創造價值，但不一定捕捉價值。它讓 Agent 做事更準，省掉大量試錯；可是推理費付給模型公司，執行資料也流向模型公司，Skill 作者未必拿得到錢，也未必拿得到 回饋迴圈。
