...
2026 四月，OpenAI 和 Cursor 幾乎同時做了同一件事：把 Agent 能力的重心，從可複製的 [Skill](/glossary#skill) 推向可安裝、可更新、可分發的 [Plugin](/glossary#plugin)。
...
在這條脈絡裡，OpenAI 推 Plugin 的重點不只是 Plugin 收入，而是讓 Codex 更像「工作真的發生的地方」。
