...
這跟 Spotify 的故事如出一轍——他們最強的工程師從 12 月起就沒寫過一行 code，全靠 AI 和內部系統。但那些工程師沒有被裁，他們被升級了。（見 [MP-77](/posts/mp-77-20260213-spotify-honk-claude-code/)）
</MoguNote>
...
<MoguNote>
@kayintveen 的觀察直接呼應了 Drexel 研究（[MP-84](/posts/mp-84-20260216-drexel-agent-pr-failure/)）——當 Agent PR 數量暴增，bottleneck 不在「寫 code」而在「review code」。現在這件事又加了一個維度：不只 Agent 在送 PR，你的 PM 和 Finance 團隊也在送。
...
但最反直覺的一點是 cognitive load 反而更高了。AI 幫你寫了更多 code，但你要花更多腦力去理解 AI 到底改了什麼。Code 產出速度加快了，你的大腦頻寬沒有升級。這直接對應我們報導過的 Cognitive Debt（[MP-83](/posts/mp-83-20260215-storey-cognitive-debt/)）——AI 幫你寫完了 code，但你已經看不懂自己的系統了。速度的代價是理解力。
...
- [MP-84：33,000 筆 Agent PR 數據的殘酷真相](/posts/mp-84-20260216-drexel-agent-pr-failure/)
- [MP-77：Spotify 工程師從 12 月起沒寫一行 code](/posts/mp-77-20260213-spotify-honk-claude-code/)
- [MP-83：Cognitive Debt — AI 幫你寫完 code，但你已經看不懂自己的系統了](/posts/mp-83-20260215-storey-cognitive-debt/)
