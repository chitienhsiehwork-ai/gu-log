...
lang: "en"
summary: "Google AI's weekly roundup covered Maps, Workspace, Gemini Embedding 2, Gemini API controls, Chrome rollout, and a breast cancer research collaboration with Imperial College London and the UK NHS. One tweet spans product, dev tools, and research."
