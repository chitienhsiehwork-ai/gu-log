...
import mapVsTerritory from '../../assets/posts/gp-251-fable-unknowns/map-vs-territory.png';
import knownUnknownsQuadrant from '../../assets/posts/gp-251-fable-unknowns/known-unknowns-quadrant.png';
import unknownDiscoveryLoop from '../../assets/posts/gp-251-fable-unknowns/unknown-discovery-loop.png';
...
<a class="artifact-callout" href="/artifacts/gp-251-unknowns/zh/index.html">
...
- [GP-223: Fable 5 太能幹，反而要重新學怎麼跟它講話 — Anthropic 官方 prompting 指南拆解](/posts/gp-223-20260613-anthropic-prompting-fable-5/)
- [GP-247: 四模型聯軍：一套讓 Fable 當 Tech Lead 的 Claude Code 編制](/posts/gp-247-20260702-diegocabezas01-fable-tech-lead-claude-code/)
