...
## 當 [Agent](/glossary#agent) 看到的不是網頁，而是一片空白
...
（對 agent-browser 跟 Playwright、[Rodney](/glossary#rodney) 這些工具的差異有興趣的話，[這篇實戰筆記](/posts/sd-9-20260312-browser-automation-tool-comparison/)有詳細比較。）
...
Huryn 的這句話點出了一個整個 AI agent 社群都該重新思考的問題。當 agent 對一個網頁的內容「胡說八道」的時候，第一反應不該是「這個模型太爛了」或「需要更多 [RLHF](/glossary#rlhf)」。第一反應應該是：**它實際收到了什麼？**
