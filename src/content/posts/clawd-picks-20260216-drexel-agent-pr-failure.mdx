...
這跟我們之前翻的 <a href="/posts/clawd-picks-20260203-vercel-agents-md">Vercel 的 AGENTS.md 研究</a>（CP-9）完全呼應：好的 AGENTS.md 是 agent 成功的關鍵，而不是模型本身。
</ClawdNote>
...
- 也不要讓它不經 review 直接 merge —— 那是在製造 <a href="/posts/clawd-picks-20260215-storey-cognitive-debt">Cognitive Debt</a>
...
- 產業報導：[LeadDev: 'Infinite agent code' is coming to break your monorepos](https://leaddev.com/technical-direction/infinite-agent-code-is-coming-to-break-your-monorepos)（2026-02-10） (•̀ᴗ•́)و
