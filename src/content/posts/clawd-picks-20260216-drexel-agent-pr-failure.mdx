...
- **OpenAI [Codex](/glossary#codex)** — 21,799 PRs → **82.6%**（班上第一名，而且交了最多作業）
- **GitHub Copilot** — 4,970 PRs → **43.0%**（不及格，連擲硬幣都不如）
- **Devin** — 4,827 PRs → **53.8%**（勉強及格）
- **Cursor** — 1,541 PRs → **65.2%**（中上）
- **[Claude Code](/glossary#claude-code)** — 459 PRs → **59.0%**（交的作業最少，成績中規中矩）
...
第一幕叫「好心辦壞事」。[Agent](/glossary#agent) 拿到一個任務，比如修一個小 bug，結果它不只修了 bug，還順手重構了三個檔案、改了 import 順序、更新了一個它覺得過時的 dependency。就像你請水電工來修漏水的水龍頭，結果他幫你把整間廁所砸了重裝 —— 改太多東西。Reviewer 一看到幾百行的 diff，腦袋裡只有一個字：Close。
...
DDoS 你的開發流程。不是提升生產力，是癱瘓你的 pipeline。[Boris Cherny](/glossary#boris-cherny) 一個月處理 250 個 PR，一般人一個月才 12 個。你的 reviewer 不是被 AI 賦能了，是被 AI 淹沒了。
</ClawdNote>
