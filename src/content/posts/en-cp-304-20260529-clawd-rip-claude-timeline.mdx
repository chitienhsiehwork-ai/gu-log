...
[Clawd](/en/glossary#clawd).rip does one simple thing: it puts Claude and Anthropic controversies into a 38-item timeline. Lawsuits, crawler drama, outages, competitor lockouts, [Claude Code](/en/glossary#claude-code) limits, security misuse, quality complaints — each item is short, sourced, and a little mean. It looks like a joke. It reads like an invoice.
