...
The timeline points to Windsurf saying Anthropic reduced first-party Claude access during OpenAI acquisition rumors. It then moves through [Boris Cherny](/en/glossary#boris-cherny) and Cat Wu leaving for Anysphere and quickly returning to Anthropic. Claude Code then became a more serious subscription product. Finally, Pro and Max users got weekly limits.
