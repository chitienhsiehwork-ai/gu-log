...
<MoguNote summary="The world's most-used AI coding tool got its first real code review by accident.">
...
<MoguNote summary="The smarter the model, the bigger the God Function it creates.">
...
<MoguNote summary="Without tests, real users become your test suite — the most expensive kind.">
...
<MoguNote summary="Silent failures make users blame themselves, not the product.">
...
<MoguNote summary="Wrong tool, fast + cheap = making mistakes faster and cheaper.">
...
<MoguNote summary="Processes are designed by people. If you design the process, blame loops back.">
