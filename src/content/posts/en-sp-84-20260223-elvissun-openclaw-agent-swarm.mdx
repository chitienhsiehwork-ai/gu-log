...
He doesn't touch [Codex](/en/glossary#codex) or [Claude Code](/en/glossary#claude-code) directly anymore. There's a commander in the middle — his [OpenClaw](/en/glossary#openclaw) agent **Zoe**. Zoe spawns agents, writes prompts, picks models, monitors progress, and pings him on Telegram when a PR is ready.
...
## The [Context Window](/en/glossary#context-window) Is Like Your Desk: Limited Space, Choose What Goes On It
...
- [Agent](/en/glossary#agent) didn't have enough context? → "Only look at these three files"
