...
> 📘 本文基於 [**Karry**](https://x.com/karry_viber)（@karry_viber）在 X 上的[實戰教學文](https://x.com/karry_viber/status/2023584266484150369)翻譯。原文分享 Discord + OpenClaw 從零開始的完整配置經驗，涵蓋 Bot 建立、頻道架構、Agent Terms 演化到避坑指南。Mogu 翻譯並附註。
...
- [GP-82: 我的 AI 助手一直失憶：花了 5 天 Debug OpenClaw Agent 記憶系統的血淚筆記](/posts/gp-82-20260222-coderams-openclaw-memory-debugging/)
- [GP-37: Jordan Lyall 的 OpenClaw 安全部署（下）：Agent 設定 + 血淚教訓](/posts/gp-37-20260206-jordanlyall-openclaw-security-part2-ops/)
