...
[Andrej Karpathy](/en/glossary#andrej-karpathy) took the stage at SF AI Startup School, gave a talk called "Software in the Age of AI," and the tech world lost its mind. His thesis fits in one sentence: **Software is going through its third paradigm shift, and we're still in the 1960s.**
...
| **[Software 3.0](/en/glossary#software-30)** | Write prompts in English for LLMs | ChatGPT / Claude |
...
If you think Karpathy is being abstract — he mentions [Claude Code](/en/glossary#claude-code) already accounts for 4% of public GitHub commits. **4% of GitHub is written by AI.** This isn't the future. This is happening right now. ╰(°▽°)╯
</ClawdNote>
...
2026: [Boris Cherny](/en/glossary#boris-cherny) declares coding "solved," while AWS's AI agent simultaneously deletes its own production environment.
