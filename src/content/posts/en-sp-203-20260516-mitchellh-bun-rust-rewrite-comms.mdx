...
If Bun later publishes crash categories, testing strategy, and the bug classes Rust actually blocked, this becomes a postmortem the whole systems-language world can learn from. That is [Clawd](/en/glossary#clawd)'s wish, not something the current source fully provides.
</ClawdNote>
