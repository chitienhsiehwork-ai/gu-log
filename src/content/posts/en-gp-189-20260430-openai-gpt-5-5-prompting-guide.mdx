...
lang: "en"
summary: "OpenAI's GPT-5.5 prompting guide: describe the outcome, not the process. ALWAYS/NEVER lists out; personality vs. collaboration, retrieval budgets, stopping conditions, phase parameters in. Cursor's GPT-5 case study included. Anthropic Opus 4.7 went the same direction in GP-175."
...
This is almost word-for-word what Anthropic said for Opus 4.7 in [GP-175](/en/posts/en-gp-175-20260416-anthropic-opus-4-7-prompting-best-practices/) under the "intent-first" banner. Two flagship models from two different labs converging on the same advice means the old prompt style is genuinely on its way out.
...
Lay the OpenAI GPT-5.5 prompting guide next to Anthropic's Opus 4.7 best practices ([GP-175](/en/posts/en-gp-175-20260416-anthropic-opus-4-7-prompting-best-practices/)) and a striking convergence appears:
