...
2025 年 12 月 26 日，[Andrej Karpathy](/glossary#andrej-karpathy) 在 X 上發了一則推文，大概就是這種心情。
...
2025 下半年發生了什麼？[Claude Code](/glossary#claude-code) 推出、Anthropic 的 [MCP](/glossary#mcp)（Model Context Protocol）開源、Vercel 推 Agents API、各大 IDE 的 AI 整合從「能用」變成「很好用」。Karpathy 推文裡那串恐怖清單——agents, subagents, MCP, LSP, slash commands, workflows, IDE integrations——全部是 2025 下半年才出現或普及的東西。
