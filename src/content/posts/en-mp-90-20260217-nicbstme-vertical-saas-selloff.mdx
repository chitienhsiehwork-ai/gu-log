...
status: "deprecated"
deprecatedReason: "Duplicate of GP-71 — same source covered in more depth as a Gu-log Picks article"
deprecatedBy: "GP-71"
---
...
My own take: the most valuable part isn't the "SaaS is dying" headline (we covered that concept back in MP-48). It's the 10-moat framework + 3-question rapid assessment. This is something you can actually use, not just another "AI will change the world" think piece (￣▽￣)／
...
**Related reads**:
- [MP-48: SaaS Moats Are Crumbling](/posts/mp-48-20260209-nicbstme-crumbling-workflow-moat) (same author's earlier take, concept version)
- [MP-65: LLM Context Tax Avoidance Guide](/posts/mp-65-20260211-nicbstme-context-tax) (same author, context optimization) (•̀ᴗ•́)و
