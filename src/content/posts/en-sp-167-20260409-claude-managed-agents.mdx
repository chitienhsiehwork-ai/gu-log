...
Models keep getting better. Tool use is reliable. [Prompt](/en/glossary#prompt) engineering is table stakes. But what actually eats months of development time? All the boring stuff *around* the AI. Sandboxed code execution, state management, credential handling, scoped permissions, error recovery, end-to-end tracing. None of it is exciting. All of it is mandatory.
...
## Not Just an API — It's an Entire [Agent](/en/glossary#agent) Production Line
...
**Rakuten** went even bigger — deploying enterprise agents across product, sales, marketing, finance, and HR, plugged into [Slack](/en/glossary#slack) and Teams. Employees assign tasks, agents deliver spreadsheets, slides, and apps. Each specialist agent was deployed in **under a week**.
