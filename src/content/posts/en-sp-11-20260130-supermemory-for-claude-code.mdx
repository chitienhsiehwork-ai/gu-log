...
Yeah. [Claude Code](/en/glossary#claude-code) used to be that goldfish (╯°□°)╯
...
## How Is This Different from [MCP](/en/glossary#mcp)?
...
Simply put: MCP version is "you tell it to check its notebook." [Plugin](/en/glossary#plugin) version is "it brings its notebook to class on its own."
