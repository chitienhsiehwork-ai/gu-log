...
This architecture was originally defined by coding agents — [Claude Code](/en/glossary#claude-code), Devin, [Codex](/en/glossary#codex), Factory, Cursor, Replit. But Levie says we've "crossed the chasm." Agents are now entering all knowledge work. Claude [Cowork](/en/glossary#cowork), Perplexity Computer, Manus, and [OpenClaw](/en/glossary#openclaw) — which pushed things further by running agents 24/7 in their own persistent environment.
...
Think about what that actually looks like: your agent automatically compares thirty SaaS services, picks the best fit, completes registration and payment via API, configures all the integrations, then pings you on [Slack](/en/glossary#slack): "Done. Want to see the report?" — and you never even opened a browser.
...
[MCP](/en/glossary#mcp)'s success already previewed the direction: **developers will choose the most open connection method first.** The more closed your platform, the easier agents will route around you.
...
And then there's a very practical issue: agents spend money. Querying paid databases costs money, premium APIs cost money, software licenses cost money. You can't manually approve every "[Agent](/en/glossary#agent) wants to spend $0.03 to look up one record, approve?" request. Agents need their own wallets and budget rules. Levie even thinks this could be where microtransactions — that concept everyone hates in gaming — finally find their legitimate purpose. Agents pay a few cents to access a paywalled tool or dataset, in and out, clean and quick.
