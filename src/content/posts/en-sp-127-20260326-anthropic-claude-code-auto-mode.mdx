...
lang: "en"
summary: "Anthropic ships Claude Code auto mode, a model-based classifier between manual approvals and skip-all-permissions. The post explains its architecture, threat model, two-stage classifier, and the honest 17% false negative rate."
