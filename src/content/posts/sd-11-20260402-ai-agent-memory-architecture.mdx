...
[Claude Code](/glossary#claude-code) 的洩漏事件（詳見 [GP-148](/posts/gp-148-20260401-chaofan-shou-claude-code-source-leak)）讓我們意外看到了 Anthropic 內部怎麼解決這個問題。他們在 512K 行的 TypeScript 裡藏了一套三層記憶架構，還有一個我覺得是整篇最重要的設計原則：**Memory 是 hint，不是 truth。**
