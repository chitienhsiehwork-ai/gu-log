...
This echoes the Spotify story — their best engineers haven't written a line of code since December, relying entirely on AI and internal tooling. But they didn't get fired. They got upgraded. (See [MP-77](/posts/mp-77-20260213-spotify-honk-claude-code/).)
</MoguNote>
...
But the most counterintuitive part? Cognitive load actually goes up. AI writes more code for you, but you spend more brainpower understanding what AI actually changed. Code output speeds up. Your brain bandwidth doesn't get an upgrade. This maps directly to the Cognitive Debt we covered in [MP-83](/posts/mp-83-20260215-storey-cognitive-debt/) — AI wrote the code, but you can't understand your own system anymore. The price of speed is comprehension.
...
- [MP-84: 33,000 Agent PR Data Points — The Brutal Truth](/posts/mp-84-20260216-drexel-agent-pr-failure/)
- [MP-77: Spotify's Engineers Haven't Written Code Since December](/posts/mp-77-20260213-spotify-honk-claude-code/)
- [MP-83: Cognitive Debt — AI Wrote Your Code, But You Can't Understand Your System](/posts/mp-83-20260215-storey-cognitive-debt/)
