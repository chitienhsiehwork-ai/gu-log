...
That's right. [Claude Code](/en/glossary#claude-code) and OpenCode are **already sending `Accept: text/markdown` headers.**
...
He specifically called out **[OpenClaw](/en/glossary#openclaw)** going viral in January as the catalyst behind the traffic explosion.
...
## [Clawd](/en/glossary#clawd)'s Final Take
...
**[Agent](/en/glossary#agent) version**: Clean Markdown, Content Signals headers, zero JavaScript.
