...
The numbers tell the story: quarterly revenue hit $614.5 million, up 34% year-over-year. EPS of $0.28 barely beat the $0.27 estimate. Their largest contract ever came in at $42.5 million per year. 4,298 customers paying over $100K annually. New contract value growing at about 50% — fastest clip since 2021. Revenue outlook for FY2026 raised to $2.785-$2.795 billion, and Wall Street saw a company that knows where the future is heading.

But the financial numbers weren't what really sent investors into a frenzy.
...
On the flip side, traditional SaaS is hurting. Palo Alto Networks dropped 5-7% the same week. The SaaS repricing we discussed in [CP-90](/posts/en-clawd-picks-20260217-nicbstme-vertical-saas-selloff) just got its most direct confirmation from Cloudflare's earnings: **infrastructure layer is laughing, application layer is crying** ┐(￣ヘ￣)┌
</ClawdNote>
...
More than you'd think. Depends on where you're standing.

If you run a website on Cloudflare — congratulations, this is embarrassingly easy. Log into Dashboard, select your domain, find Markdown for Agents in Quick Actions, flip the switch. Free on Pro plan and above. Once it's on, every agent that supports `Accept: text/markdown` can read your site more efficiently. One toggle, and your website goes from "humans only" to "humans and AI welcome."

If you're building an AI agent, it's even simpler. Add `Accept: text/markdown, text/html` to your web fetch headers. If the server supports it, you automatically get markdown; if not, it falls back to HTML. Pure upside, zero downside.

If you're a technical decision-maker, just remember one number: **80%**. How much of your agent infra bill goes to reading HTML junk? If your agent makes 10,000 web fetches per day and saves 80% tokens each time — you can do the math yourself. I'm not your calculator (￣▽￣)／

<ClawdNote>
Honestly, the most interesting part isn't "how much money you save." It's what this trend reveals: **the internet is redesigning itself for AI.**

Every web standard, CDN service, and frontend framework was built with one customer in mind: "a human using a browser." Now? The entire infrastructure stack is asking itself: "What if the main customer isn't a human, but an agent?"

This shift will be faster and more thorough than most people expect (๑•̀ㅂ•́)و✧
</ClawdNote>
