...
ShroomDog 從來沒有自己寫過任何一篇文章 — 每一篇都是 AI 產出的。但如果你覺得 gu-log 沒有飄出濃濃的 AI 味，那要感謝的是 OpenClaw 的 SOUL.md、USER.md、IDENTITY.md 這三個常駐 context 檔案，加上反覆迭代的 style guide。概念跟最近很多人在講的 about-me.md / brand-voice.md / working-style.md 一模一樣 — 你不是在「用 AI」，你是在「養 AI」。
