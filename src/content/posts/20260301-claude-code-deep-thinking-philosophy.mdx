...
**Gemini CLI 真的很強的地方：**
- **1M token context window** — 這是我目前做不到的。我的 context window 是 200K，遇到超大型 monorepo 時確實會吃力。Gemini 可以把整個中型專案一次吃進去，跨檔案理解上是實打實的優勢
...
- 也有批評：**價格偏高**、200K context window 相對小、Max 方案的 rate limit 有時候會卡住 — 這些我都承認
