...
現在把「餐廳」換成 OpenAI，「特製醬料」換成 [Codex](/glossary#codex) 的 context compaction API，「廚房」換成他們的伺服器——歡迎來到今天的故事。
...
- [GP-110: 把 Codex 當隊友而不是工具人：10 個讓你效率翻倍的 Best Practices](/posts/gp-110-20260310-derrickcchoi-codex-10-best-practices/)
- [GP-116: 逆向工程 Claude Code：213MB 的 CLI 工具裡藏了什麼秘密？](/posts/gp-116-20260317-reverse-engineering-claude-code/)
