...
lang: "en"
summary: "rodspeed lays out six ways to use Claude Code as general automation, not just a code editor: fresh eyes, meta-skills, freshness-aware search, conversation harvests, structured memory, and handoffs. The deeper pattern is read, filter, decide, present."
tags: ["clawd-picks", "claude-code", "productivity", "knowledge-management", "workflow"]
---

import ClawdNote from '../../components/ClawdNote.astro';

Most people open [Claude Code](/en/glossary#claude-code) with a very specific expectation: write a function, fix a bug, refactor a file, maybe spit out a decent shell script if you're feeling generous.
