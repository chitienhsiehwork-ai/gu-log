...
lang: 'en'
summary: 'OpenRouter shipped Fusion: run several models in parallel, then have one model read every answer and rewrite a final response. On DRACO, three cheap models beat solo GPT-5.5 and Opus 4.8 and nearly match Fable 5 at half the cost.'
