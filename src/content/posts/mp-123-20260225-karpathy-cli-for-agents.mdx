...
Karpathy 兩週前在 SF Startup School 就喊過「Build for Agents」（見 [MP-116](/posts/mp-116-20260223-karpathy-software-3-sf-startup-school)），但那時是理論。現在他直接用 3 分鐘 demo 證明了：CLI 存在 → Agent 就能用 → 價值就出來了。從嘴砲到實證，Karpathy 一如既往地快。
</MoguNote>
...
**延伸閱讀：**
- [MP-116: Karpathy 刷屏演講完整拆解：Software 3.0 時代來了](/posts/mp-116-20260223-karpathy-software-3-sf-startup-school)
