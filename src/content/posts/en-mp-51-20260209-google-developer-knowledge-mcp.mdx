...
summary: "Google launched the Developer Knowledge API and an official MCP Server (Public Preview), letting AI coding tools query current Firebase, Android, Google Cloud, and Chrome docs instead of inventing APIs from three versions ago."
lang: 'en'
...
Google apparently got tired of this too. On February 4, 2026, they launched the **Developer Knowledge API** and a companion **[MCP](/en/glossary#mcp) Server** (Public Preview). The one-sentence version: **Google turned its official developer documentation into an API that AI tools can query directly.**

Your [Claude Code](/en/glossary#claude-code), Gemini CLI, Cursor—any MCP-compatible AI tool—can now connect to Google's documentation library and look up the latest docs for Firebase, Android, Google Cloud, and Chrome Extensions in real time. Instead of answering from "vague memories of training data," AI now flips open the official textbook before responding.
