...
然後你翻遍 [Slack](/glossary#slack)、翻遍 browser history、翻遍那個你每次都發誓要好好整理但從來沒動手的筆記 app，最後發現那段 code 已經消失在宇宙裡了。你在螢幕前面坐著，覺得自己是世界上最蠢的人。

[Simon Willison](/glossary#simon-willison) 說：**不要讓這種事發生。你解過的每一個問題，都應該留下 working code。**

這是他 [Agentic Engineering](/glossary#agentic-engineering) Patterns 系列的[第四章](https://simonwillison.net/guides/agentic-engineering-patterns/hoard-things-you-know-how-to-do/)，前面三章講了[「寫 code 變便宜了」和 TDD](/posts/sp-80-20260223-simonw-agentic-engineering-patterns)、[Linear Walkthrough](/posts/sp-87-20260226-simonw-linear-walkthroughs)。這一章的概念更 meta：**你過去做過的每一件事，都是未來的彈藥。**
