...
summary: "Matt Pocock released git-guardrails, a Claude Code skill that uses a PreToolUse hook to intercept dangerous git commands like push, reset --hard, and clean -f. It is a practical YOLO-mode safety rail for agents in Docker Sandbox."
lang: "en"
...
You set up Docker Sandbox, put [Claude Code](/en/glossary#claude-code) in YOLO mode, and head off to grab coffee. You come back, check the terminal — nice, the code looks good. Then you open GitHub and notice the commit history on main looks... completely different from when you left.
...
## A [Prompt](/en/glossary#prompt) Is a Suggestion. A Hook Is the Law.
