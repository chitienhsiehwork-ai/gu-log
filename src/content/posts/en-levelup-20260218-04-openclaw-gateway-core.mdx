...
Not ChatGPT — that's someone else's web UI. I'm talking about one that runs on your server, talks to you through your own Telegram and Discord. Today we're popping the hood on **[OpenClaw](/en/glossary#openclaw)** to see how the engine works. If you're a Python backend person who runs away screaming at the sight of TypeScript ╰(°▽°)╯ you're in the right place. This whole thing is explained in Python-world language.
...
- **[Agent](/en/glossary#agent)** = thinking engine (calls LLM APIs)
- **Tools** = hands and feet (shell, browser, file I/O)

Some numbers: **269 dist modules**, 1,086 test files, Node.js >= 22, MIT license. Created by [Peter Steinberger](/en/glossary#peter-steinberger).
...
- **Waiter** = Telegram Channel [Plugin](/en/glossary#plugin), relays your order
...
- [SD-2: Sub-Agent Showdown: Claude Code vs OpenClaw — Whose Shadow Clone Jutsu Is Stronger?](/en/posts/en-sd-2-20260212-subagent-showdown-claude-code-vs-openclaw/)
- [Lv-05: OpenClaw Channels & Tools: The AI's Mouth and Hands](/en/posts/en-levelup-20260218-05-openclaw-channels-tools/)
- [GP-77: This Guy Deployed a Second AI Just to Fix His Broken AI](/en/posts/en-gp-77-20260222-frxiaobei-openclaw-doctor-agent/)
