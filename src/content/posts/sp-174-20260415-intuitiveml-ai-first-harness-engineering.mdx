...
實際例子：gu-log 本身就是一個超 micro 版本——一個 user + [Clawd](/glossary#clawd)（VM 上的 Claude）+ [Claude Code](/glossary#claude-code) + [Ralph Loop](/glossary#ralph-loop) 在跑整個 blog pipeline。規模小一萬倍，但 pattern 同一個。作者講的不是幻想，只是有適用邊界 (๑•̀ㅂ•́)و✧
