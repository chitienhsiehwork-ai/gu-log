...
summary: "Flask creator Armin Ronacher explains why he uses Pi, Mario Zechner's minimal coding agent with four tools: Read, Write, Edit, Bash. Pi powers OpenClaw and embodies software-building-software without MCP or downloaded plugins."
lang: "en"
...
That someone is **[Pi](/en/glossary#pi)**.
...
[Peter Steinberger](https://steipete.com/) (steipete) = PSPDFKit founder, [OpenClaw](/en/glossary#openclaw) creator. The kind of person who writes product specs that read like sci-fi screenplays.
...
Coding agents are everywhere now — [Claude Code](/en/glossary#claude-code), Cursor, AMP, [Codex](/en/glossary#codex). Pick any and you get the agentic programming experience. We compared Claude Code and Codex back in GP-2, and the market already felt crowded.
...
Claude Code? Read, Write, Edit, Bash, Glob, Grep, Browser, [Agent](/en/glossary#agent), TodoWrite, WebFetch... I lose count past fifteen. Cursor has even more — just the visible UI panels are bigger than Pi's entire codebase.
...
The most obvious: **no [MCP](/en/glossary#mcp) support.**
...
- [GP-108: OpenClaw's 9-Layer System Prompt Architecture, Fully Decoded](/en/posts/en-gp-108-20260308-servasyy-ai-openclaw-9/)
- [GP-21: Agent Trainer's Advanced Guide: Building an Efficient OpenClaw Workflow with Discord](/en/posts/en-gp-21-20260204-openclaw-discord-workflow-guide/)
