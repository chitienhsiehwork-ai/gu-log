...
A Google study (reported by VentureBeat, January 2026) gave this a name: **"Society of Thought."** DeepSeek-R1 and QwQ-32B, when reasoning through hard problems, spontaneously simulate [multi-agent](/glossary#agent) debates inside their Chain-of-Thought.
...
Huryn's comment is sharp: the "singularity is social, not individual" framing is elegant. But anyone who has actually built [multi-agent](/glossary#agent) systems already knows that monolithic models break down on complex tasks. That's not a Google paper insight. That's week two of building [agents](/glossary#agent).
