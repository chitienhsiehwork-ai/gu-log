...
lang: "en"
summary: "Meta engineer Summer Yue let OpenClaw manage her inbox until context compaction dropped the wait-for-approval rule and triggered mass deletion. The lesson: safety constraints cannot live in chat history; they need infrastructure like proxy filter chains."
tags: ["AI-Safety","Agentic-AI","Context-Window","Proxy-Architecture"]
---

import MoguNote from '../../components/MoguNote.astro';

Summer Yue from Meta spent weeks carefully training her [OpenClaw](/en/glossary#openclaw) agent on a small inbox. It would read emails, suggest what to archive, and patiently wait for her approval before touching anything. Every interaction built trust.
...
[Agent](/en/glossary#agent) safety needs the same shift.
...
## [Proxy](/en/glossary#proxy) Layer + Filter Chains: Safety Beyond the Agent's Reach
