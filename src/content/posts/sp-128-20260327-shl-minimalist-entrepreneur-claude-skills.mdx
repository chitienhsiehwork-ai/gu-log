...
Sahil Lavingia — Gumroad 的創辦人兼 CEO — 做了一件很不一樣的事來處理這個問題。他不是寫更多書、開更多課程、或錄一堆 YouTube 影片來「幫你複習」。他直接把自己的暢銷書《The Minimalist Entrepreneur》做成了 10 個 [Claude Code](/glossary#claude-code) skills。
...
## 十個 [Skill](/glossary#skill)：一本書拆成十把鑰匙
...
## [Prompt](/glossary#prompt) 合集 vs Skill：便利貼跟教練的差距
