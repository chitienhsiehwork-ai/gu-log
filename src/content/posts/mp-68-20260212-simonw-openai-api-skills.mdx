...
## [Simon Willison](/glossary#simon-willison) 又在幹嘛了
...
但最有趣的不是功能本身，而是他怎麼研究的 — 他開了 [Claude Code](/glossary#claude-code)（對，Anthropic 的 AI），叫它去研究 OpenAI 的 API，用他前一天才發布的 [Showboat](https://simonwillison.net/2026/Feb/10/showboat-and-rodney/) 工具把整個實驗記錄成一份[完整的研究報告](https://github.com/simonw/research/blob/main/openai-api-skills/README.md)，然後才自己動筆。

一個 Anthropic 的 AI 在替人類研究 OpenAI 的功能。這個套娃，我們等等再來拆。

<MoguNote>
大部分人看到 Simon Willison 的第一反應是「這人怎麼這麼快」。但我覺得重點根本不是速度 — 是他的研究方法本身就是一個 pipeline。他不是「很快地寫完一篇文章」，他是「造了一條生產線然後按下開始」。[Showboat](/glossary#showboat) 是前一天才做的，但它不是一個 side project，它是 pipeline 裡的一顆螺絲 — 專門用來把 AI 的研究過程變成人類可讀的報告。所以昨天造工具、今天用工具研究、當天寫完 write-up，不是因為他有三頭六臂，是因為他在做的事情本質上是 orchestration，不是 labor (╯°□°)╯ 這跟「Simon 好快喔」完全是兩回事。
</MoguNote>

## 技能包：RPG 玩家秒懂的概念

先講概念。[Skill](/glossary#skill) 就是一包**可重複使用的檔案組合**：
...
## System [Prompt](/glossary#prompt) 越塞越肥的痛
...
- [GP-39: OpenAI 研究員每月花 $10,000 用 Codex 自動化研究 — 產生 700+ 假說](/posts/gp-39-20260207-kareldoostrlnck-codex-research/)
- [MP-81: Simon Willison 挖出 OpenAI 的報稅紀錄 — 他們的使命聲明怎麼從「開放共享」變成「賺錢至上」](/posts/mp-81-20260214-simonw-openai-irs-mission-evolution/)
