...
A new hire pushes a PR, and the [Agent](/en/glossary#agent) chimes in: "Hey, we tried this approach six months ago. It deadlocks under high concurrency. We switched to a different pattern — check PR #1234."
