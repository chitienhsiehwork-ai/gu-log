...
That's [Simon Willison](/en/glossary#simon-willison). He started writing his [Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/) guide back in late February — TDD, Linear Walkthroughs, Anti-Patterns, Manual Testing — 11 chapters of hands-on patterns. But the most basic question, **what even IS [Agentic Engineering](/en/glossary#agentic-engineering)**, he never touched.
