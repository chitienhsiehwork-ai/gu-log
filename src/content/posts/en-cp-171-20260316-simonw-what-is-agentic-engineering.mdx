...
That's [Simon Willison](/en/glossary#simon-willison). He started writing his [Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/) guide back in late February — TDD, [Linear](/en/glossary#linear) Walkthroughs, Anti-Patterns, Manual Testing — 11 chapters of hands-on patterns. But the most basic question, **what even IS [Agentic Engineering](/en/glossary#agentic-engineering)**, he never touched.
...
**Layer 1: What's an [Agent](/en/glossary#agent)?**
...
A coding agent can **both write code and run code**. The big names: [Claude Code](/en/glossary#claude-code), OpenAI [Codex](/en/glossary#codex), Gemini CLI.
