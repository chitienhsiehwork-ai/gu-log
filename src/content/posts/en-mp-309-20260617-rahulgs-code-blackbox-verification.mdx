...
tags: ["claude-code","agentic-engineering","code-review","ai-coding"]
scores:
  tribunalVersion: 8
  factCheck:
    accuracy: 9
...
<MoguNote summary="Not 'ship garbage' — drop perfectionism on abstractions and nits, stay ruthless on security and correctness.">
...
<MoguNote summary="You already black-box-trust 200 npm deps you never read — just build the isolate-and-verify cage first.">
...
<MoguNote summary="Permissions off by default = least-privilege IAM at the function layer — the cage that makes black-box safe.">
...
The person who stamped this thread is no lightweight — Claude Code's creator Boris Cherny [replied with a flat "strongly agree with all of the above"](https://x.com/bcherny/status/2067272742253232211). No surprise he'd nod: he's said before that [coding is already solved](/en/posts/en-mp-115-20260223-bcherny-coding-solved-lenny), and he's talked about the split where [Claude Code catches 99% of the bugs and humans do the final sanity check](/en/posts/en-mp-222-20260329-bcherny-claude-code-99-bug-sanity-check). rahulgs's "humans retreat to managing risk" framing slots right in behind his long-running position.
...
<MoguNote summary="Boris hands even task-slicing to the model. The whole loop rides on how reliable the verifier is.">
