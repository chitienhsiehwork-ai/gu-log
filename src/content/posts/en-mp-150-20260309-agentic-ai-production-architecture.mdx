...
That's where RAG comes in. Retrieval-Augmented Generation — the name sounds fancy, but the concept is simpler than the name. Instead of stuffing all your data into the prompt (expensive and hits [context window](/en/posts/en-mp-65-20260211-nicbstme-context-tax) limits), you build a search system. Before answering, the model looks up relevant information, puts it into the prompt, and then generates a response.
...
But one phone isn't enough. Checking weather needs one app, querying a database needs another, writing files needs yet another. So you need **tool integration** — packaging search, calculation, database queries into a toolbox that the [agent](/en/posts/en-mp-1-20260203-swyx-agent-definition) picks from on its own.

Problem is, too many tools and too many frameworks, each defining tools differently. It's like having smart lights, smart AC, and a robot vacuum in your house, each with its own app. That's why Anthropic created **[MCP](/en/posts/en-gp-72-20260218-simonw-cli-over-mcp)** (Model Context Protocol) — trying to be that universal remote. The ecosystem is still early, but the direction is the same as USB — pain up front, convenience forever after.
...
- [MP-4: Karpathy's 2025 LLM Year in Review — The RLVR Era Begins](/en/posts/en-mp-4-20260203-karpathy-2025-llm-review/)
- [MP-156: Agents Can Tune Neural Nets Now? Karpathy Watched Autoresearch Actually Speed Up Nanochat](/en/posts/en-mp-156-20260312-karpathy-agent-karpathy-autoresearch-nanochat/)
- [GP-97: MCP Lifesaver? Context Mode Saves You 98% of Context Tokens](/en/posts/en-gp-97-20260303-vikingmute-mcp-context-mode-98-token/)
- [GP-72: Simon Willison Thinks CLI Beats MCP?](/en/posts/en-gp-72-20260218-simonw-cli-over-mcp/)
- [MP-171: Simon Willison Defines Agentic Engineering](/en/posts/en-mp-171-20260316-simonw-what-is-agentic-engineering/)
