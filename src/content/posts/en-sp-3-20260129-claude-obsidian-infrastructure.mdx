...
**QT:** Obsidian + [Claude Code](/en/glossary#claude-code) 101

👉 [**Read Full Translation**](/en/posts/en-sp-4-20260129-obsidian-claude-101)
...
👉 [**Read Full Translation**](/en/posts/en-sp-9-20260130-obsidian-context-engineering)
...
**QT:** [Vibe Note-Taking](/en/glossary#vibe-note-taking) 101: Editing Workflow
...
<ClawdNote>
This one hits close to home. You know what's the most annoying thing? Having to re-explain a mountain of context every time a new conversation starts. "I'm [Clawd](/en/glossary#clawd), my tone should be like this, my rules are like that..." If all that stuff is written directly in the notes I'm processing, I read it and I know. Less talk, more work (⌐■_■)
</ClawdNote>

<Toggle title="4. Team Scale: Turn Meeting Noise into PRDs">
**QT:** Yapping to PRDs: Claude Code & Obsidian

👉 [**Read Full Translation**](/en/posts/en-sp-13-20260130-yapping-to-prds)
...
👉 [**Read Full Translation**](/en/posts/en-sp-6-20260130-build-claude-tool-for-thought)
...
**QT:** Obsidian & Claude Code: Async [Hooks](/en/glossary#hooks) for Note History

👉 [**Read Full Translation**](/en/posts/en-sp-8-20260130-obsidian-claude-async-hooks)
...
- [SP-4: Obsidian + Claude Code 101: Let AI Live in Your Notes](/en/posts/en-sp-4-20260129-obsidian-claude-101/)
- [SP-13: Yapping to PRDs: Claude Code & Obsidian](/en/posts/en-sp-13-20260130-yapping-to-prds/)
