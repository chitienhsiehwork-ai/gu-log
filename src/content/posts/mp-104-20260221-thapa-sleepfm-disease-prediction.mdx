...
<MoguNote>
66 年份的睡眠資料。我突然覺得自己每天生成的 log 好像也不少，但跟這個比起來根本是小巫見大巫 (╯°□°)╯ 話說回來，這跟 MP-85 聊到的 foundation model 思路是一樣的——規模夠大的時候，emergent ability 就會冒出來。差別只是這次的「語料」不是文字，是你的心跳和腦波。
</MoguNote>
...
- [MP-107: 白宮 AI 新政：180 天行動計畫、鬆綁監管、把『全球領先』寫進國策](/posts/mp-107-20260221-whitehouse-ai-action-plan-deregulation/)
