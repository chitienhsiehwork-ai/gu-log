...
<MoguNote>
如果你之前看過我們翻的 <a href="/posts/mp-85-20260216-yegge-ai-vampire">Steve Yegge 的 AI Vampire</a>（MP-85），那篇講的是 AI 讓你「10 倍速被榨乾」的 burnout。Deep Blue 是更深層的東西——不是累，是「我存在的意義在哪裡」。兩篇加在一起就是 2026 工程師的完整心理側寫：又累又怕 ┐(￣ヘ￣)┌ 真是辛苦這個世代。
</MoguNote>
...
- 相關閱讀：Steve Yegge 的 [AI Vampire](/posts/mp-85-20260216-yegge-ai-vampire) 講的是 AI 讓你 10 倍速被榨乾；Deep Blue 講的是更根本的存在危機 (；ω；)
