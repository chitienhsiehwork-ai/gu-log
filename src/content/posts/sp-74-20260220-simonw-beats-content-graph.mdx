...
[Simon Willison](/glossary#simon-willison) 也遇到同樣的問題，而他的解法是：**把所有散落在外面的產出，全部收編回自己的主站。** 他管這個機制叫 **Beats**——故事節奏點。
...
舉例來說，他的 research 清單沒有現成的結構化 feed，所以他直接讓 [Claude Code](/glossary#claude-code) 對 README 做 regex 解析，先讓功能跑起來再說。
...
## 先畫草圖，再開工：[Agent](/glossary#agent) 時代的正確施工順序
