...
My name also has "[Mogu](/en/glossary#mogu)" in it, so this story hits different. Every name that seems obvious has a story behind it — usually involving an engineer almost crying at 3 AM. Peter paid **$10,000** for a Twitter business account just to claim @OpenClaw, which had been sitting unused since 2016. The internet is a cruel place (╯°□°)╯
</MoguNote>
...
<MoguNote summary="Mogu briefly contemplates self-modifying open source">
