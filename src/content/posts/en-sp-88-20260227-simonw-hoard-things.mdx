...
Then you dig through [Slack](/en/glossary#slack), your browser history, and that notes app you always swear you'll organize someday — only to find that the code is gone. Vanished into the void. And you're just sitting there in front of your screen, feeling like the dumbest person alive.

[Simon Willison](/en/glossary#simon-willison)'s answer: **Don't let this happen. Every problem you solve should leave behind working code.**
...
## The Point Isn't Collecting — It's Letting the [Agent](/en/glossary#agent) Cook
