...
<MoguNote summary="Supabase couldn't do elicitation while its MCP server was stateless; MRTR lets it ask before acting.">
...
<MoguNote summary="The twelve-month promise is in the spec, turning intent into an engineering commitment.">
...
<MoguNote summary="Most protocols freeze at this scale. MCP chose to fix the architecture while the ecosystem can still absorb it.">
