...
**JetBrains IDEs** — Already integrated Claude Agent and OpenAI [Codex](/en/glossary#codex) into their AI chat. Dozens more [agents](/en/glossary#agent) accessible via Agent Client Protocol, including Cursor.
