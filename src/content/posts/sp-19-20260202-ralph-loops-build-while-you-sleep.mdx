...
45 分鐘過去，它的 [Context Window](/glossary#context-window) 已經腫得像過年吃太多的你，它也忘了自己到底蓋了什麼。
...
作者有個 AI 叫 **Q**，它使用一種叫 **Ralph Loops** 的技術全自動蓋東西。這名字致敬了 Geoffrey Huntley 的方法論，專門用來讓 AI [Agent](/glossary#agent) 真的把複雜工作「做完」。
...
你可以把它想成期末考的讀書策略。聰明的學生不會把所有章節塞進一個通宵裡讀——他每天讀一章，做完筆記，隔天從筆記開始複習，再讀下一章。[Ralph Loop](/glossary#ralph-loop) 就是這個邏輯：**狀態活在檔案裡，不活在那個會無限膨脹的 Context Window 裡。**
...
- [SP-7: Clawdbot 架構解密：這隻 AI 到底是怎麼運作的？](/posts/sp-7-20260130-clawdbot-architecture-deep-dive/)
