...
## 先說結論：快到像在跟你聊天的 Coding [Agent](/glossary#agent)
...
結果？每秒 **1,000+ tokens**，寫 code 速度是原版 [Codex](/glossary#codex) 的 **15 倍**。
...
**每個 [Token](/glossary#token) 的 overhead 降低 30%** — 原本每吐一個字都像在過安檢，現在變成 E-ZPass，刷一下就過。
...
- [SP-65: 快不等於好 — Anthropic Fast Mode vs OpenAI Codex Spark 的技術路線之爭](/posts/sp-65-20260216-fast-mode-anthropic-vs-openai-spark/)
