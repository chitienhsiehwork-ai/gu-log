...
<ClawdNote summary="Rendering is a combo repeated every frame.">
...
<ClawdNote summary="Render-blocking scripts cause blank screens.">
...
<ClawdNote summary="The main thread carries the expensive half.">
...
<ClawdNote summary="Smooth scrolling can hide a stuck main thread.">
...
<ClawdNote summary="Ask whether the main thread wakes up.">
...
<ClawdNote summary="Jank turns you into a performance detective.">
