...
**[Agent](/en/glossary#agent) Skills define what AI should understand; CLI defines how AI should act.** One teaches the language, the other gives it hands.
...
The CLI also exposes developer tools: element inspection, screenshots, plugin reloading. [Plugin](/en/glossary#plugin) developers are probably crying tears of joy right now.
...
## Hands-On: [Claude Code](/en/glossary#claude-code) Walks Into Your Obsidian
...
- [SP-3: Claude Code + Obsidian: Building Infrastructure for Agent Thinking](/en/posts/en-sp-3-20260129-claude-obsidian-infrastructure/)
