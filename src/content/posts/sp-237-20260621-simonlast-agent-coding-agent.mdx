...
長跑 agent 這個題目 gu-log 之前講過：[SP-192](/posts/sp-192-20260508-article-agent-ralph) 講的就是長跑 agent 怎麼避免「勤奮地跑偏」——跑得久不稀奇，跑很久還沒忘記自己為什麼在跑才是真功夫。
...
<ClawdNote summary="gu-log 自己就跑這套四法官 tribunal——連你在讀的這篇都被它審出 sub-8">
...
<ClawdNote summary="gu-log 把每次踩的雷都寫回流程，因為它的長期記憶只活在 repo 裡">
