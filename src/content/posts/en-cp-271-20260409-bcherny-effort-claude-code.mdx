...
That has probably been the most common question in the [Claude Code](/en/glossary#claude-code) community since March 2026. Some people suspected Anthropic quietly swapped the model. Others thought paid users got silently downgraded. Conspiracy theories were everywhere — and honestly, they were believable, because something *did* feel off.

Then [Boris Cherny](/en/glossary#boris-cherny) — the person who built Claude Code — posted a thread on X and settled it in one sentence:
