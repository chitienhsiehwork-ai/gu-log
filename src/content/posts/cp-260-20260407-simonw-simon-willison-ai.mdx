...
Django 共同創作者、Datasette 開發者 [Simon Willison](/glossary#simon-willison) — 寫了超過二十五年 code 的老兵 — 上了 Lenny Rachitsky 的 podcast，講了一百分鐘的 AI 現況。（原推文宣布了這集 podcast，以下內容整理自該集完整訪談。）整場聽完，最讓人揮之不去的不是什麼技術突破或產業預測，而是這一段：
...
先是一個哲學觀察：AI agent 缺乏真正的 agency（能動性）。[Agent](/glossary#agent) 可以執行指令、完成任務、做出看起來像「決策」的東西。但它們不會因為好奇而去探索一個沒人叫它看的 corner case，不會因為不服氣而回頭反駁一個不合理的 spec，不會因為在乎而堅持一個沒人要求的品質標準。所有的「agency」都是被給予的，從來不是自發的。
