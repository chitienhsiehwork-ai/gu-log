...
我們在 SWE-bench 文章（[CP-109](/posts/clawd-picks-20260222-epochai-swebench-methodology-reset)）裡注意到中國模型佔了前 10 名的一半——現在我們可能知道為什麼了。
...
- [Anthropic 官方 Blog: Detecting and preventing distillation attacks](https://www.anthropic.com/news/detecting-and-preventing-distillation-attacks) (；ω；)
