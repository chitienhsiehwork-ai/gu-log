...
<a class="artifact-callout" href="/artifacts/sp-251-unknowns/index.html">
  ...
  <span class="artifact-callout__body">
    <span class="artifact-callout__label">原版互動頁鏡像</span>
    <strong>先看 [Thariq](/glossary#thariq) 原版 11 個未知互動範例</strong>
    <span class="artifact-callout__meta">英文原文 · 鏡像副本 · 無 API · 純瀏覽器內完成</span>
