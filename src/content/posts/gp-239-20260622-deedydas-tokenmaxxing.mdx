...
- [GP-204: 如果 Token 不再是限制：OpenClaw 的常駐 Agent 實驗](/posts/gp-204-20260516-steipete-token-openclaw-agent/)
- [GP-205: 不要把學習也外包給 AI](/posts/gp-205-20260517-addyosmani-dont-outsource-learning/)
- [GP-230: 程式碼變便宜了，但『相信它』沒有](/posts/gp-230-20260616-agentic-code-review/)
- [GP-142: 給「慢下來」三個字的深度辯護——Coding Agent 正在毀掉你的 Codebase](/posts/gp-142-20260402-mario-zechner-coding-agent-codebase/)
