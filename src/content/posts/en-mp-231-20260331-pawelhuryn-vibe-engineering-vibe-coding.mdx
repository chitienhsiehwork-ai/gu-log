...
tags: ["ai-engineering","claude-code","product-management","vibe-coding"]
---
...
That's what Huryn does, except his clones are Claude sub-agents. He uses [Claude Code](/en/glossary#claude-code) or Claude [Cowork](/en/glossary#cowork) to spawn multiple sub-agents: one does research, another writes implementation, a third handles code review — all running in parallel. This is a completely different experience from sitting in one ChatGPT window trying to ask, edit, and test all at once.
