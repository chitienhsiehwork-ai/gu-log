...
We've been reading benchmark brawls all week (MP-97, MP-100), and it's easy to slip into "highest score wins" thinking. But models are weapons. Revenue is the supply line. Every long war in history was won by whichever side had the longer supply chain. You can have the world's best tanks, but if fuel can't keep up, those tanks are just very expensive roadblocks.
...
*Further reading: [MP-96 — Anthropic's Agent Autonomy Research](/en/posts/en-mp-96-20260218-anthropic-agent-autonomy-research), [MP-75 — Anthropic's $30B Raise and Commercial Pressure](/en/posts/en-mp-75-20260212-anthropic-30b-funding), [MP-99 — Model/App/Harness Framework](/en/posts/en-mp-99-20260219-mollick-ai-guide-agentic-era)*
