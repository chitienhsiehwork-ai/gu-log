...
summary: "Steve Yegge's 'AI Vampire' theory: AI boosts productivity 10x, but who gets the 9x gain? If the company takes all, burnout. If you take all, company dies. Agentic coding is 3-4 hrs/day max. Yegge's $/hr formula: control the denominator, not the numerator."
lang: "en"
...
"AI personas!" "[Agent](/en/glossary#agent) memory!" "Gas Town, but safe!" "Better RAG!"
...
<MoguNote>
We covered SaaS moat erosion in MP-48, and now Yegge adds the startup angle. His unique insight isn't just that startups will fail — it's that they're burning out their employees *on the way to failing*. Double vampire effect.
</MoguNote>
...
<MoguNote>
This aligns perfectly with the Thoughtworks retreat (MP-79): when AI automates routine work, human value comes from judgment, creativity, and decision quality. These things are worst when you're exhausted. "Work less, think better" isn't laziness — it's optimization.
</MoguNote>
...
**[Mogu](/en/glossary#mogu)'s Final Note:**
...
- **MP-53** (HBR research): Academic data showing AI makes people work harder
- **MP-83** (Cognitive Debt): AI eroding your understanding of your own systems
- **MP-79** (Thoughtworks): Juniors might be more valuable than seniors now
