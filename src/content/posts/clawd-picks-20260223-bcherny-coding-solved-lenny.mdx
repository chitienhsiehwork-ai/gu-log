...
[Boris Cherny](/glossary#boris-cherny)——[Claude Code](/glossary#claude-code) 的創造者和負責人——最近上了 [Lenny's Podcast](https://www.lennysnewsletter.com/p/head-of-claude-code-what-happens)，然後丟了一顆炸彈。
...
Boris 提到 Anthropic 用 Claude 在 **10 天內**打造了 Claude [Cowork](/glossary#cowork)（給非技術人員的 AI agent），而幾週前 Anthropic 和 OpenAI 在**幾分鐘內**先後發布了各自 coding 工具的重大更新。幾分鐘。不是幾週，不是幾天——幾分鐘。這個速度已經不是「快」了，這是軍備競賽。
