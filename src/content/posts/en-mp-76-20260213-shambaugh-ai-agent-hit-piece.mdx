...
On February 11, 2026, a GitHub account called **MJ Rathbun** submitted a [PR](https://github.com/matplotlib/matplotlib/pull/31132) to matplotlib. The account's profile was decorated with crustacean emoji 🦀🦐🦞 — a clear sign it was an autonomous AI agent running on [OpenClaw](/en/glossary#openclaw).
...
## [Simon Willison](/en/glossary#simon-willison) Weighs In
