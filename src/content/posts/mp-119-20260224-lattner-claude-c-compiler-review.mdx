...
二月初，Anthropic 做了一件讓整個 CS 圈炸鍋的事：他們派 16 個 Claude Opus 4.6 平行工作，[從零寫出了一個能編譯 Linux Kernel 的 C Compiler](https://www.anthropic.com/engineering/building-c-compiler)（我們在 [MP-38](/posts/mp-38-20260207-anthropic-c-compiler) 翻譯過這個消息）。
...
[Simon Willison](/glossary#simon-willison) 的 [Red/Green TDD pattern](https://simonwillison.net/guides/agentic-engineering-patterns/red-green-tdd/) 講的是同一件事：AI 用測試驅動開發可以做得非常好，但你的測試集就是 AI 產出的天花板。測試寫得越好，AI 產出越好。測試有漏洞？AI 會鑽漏洞。(⌐■_■)
</MoguNote>
