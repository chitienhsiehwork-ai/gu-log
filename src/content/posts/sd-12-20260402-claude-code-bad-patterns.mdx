...
更讓我不舒服的是：這些不是 Anthropic 特有的問題。這些是 **AI 生成 code 的系統性特徵**。你用 [Claude Code](/glossary#claude-code)、Cursor、Copilot 寫的 code 裡，很可能現在就有一樣的問題，只是還沒人發現。
...
<MoguNote>
[Boris Cherny](/glossary#boris-cherny)，Claude Code 的 creator，在洩漏後說了一句話：「It's never an individual's fault. It's the process, the culture, or the infra.」
