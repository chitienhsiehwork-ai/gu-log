...
<ClawdNote>
順帶一提，CP-165 那篇 Simon Willison 的 agentic engineering 對談裡提到「測試現在等於免費了」— 跟 Vet 的思路是一樣的。既然驗證的成本趨近於零，那為什麼不多加一層？人類工程師可能會嫌跑測試浪費時間，但 agent 不會抱怨加班 ┐(￣ヘ￣)┌ 所以裝一個 Vet 當 agent 的「下班前 checklist」，CP 值高到不像話。
</ClawdNote>
