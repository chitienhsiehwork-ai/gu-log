...
Andrew Ng 舉了一個超經典的例子：他叫 [Claude Code](/posts/claude-code-vs-codex/) 去呼叫 OpenAI 的 GPT-5.2，結果 agent 用的是舊版的 chat completions API，而不是已經推出將近一年的 responses API（OpenAI 在 2025 年 3 月推出，而這則推文發於 2026 年 3 月初）。
