...
[影片](https://static.simonwillison.net/static/2026/qwen-animated-small.mp4)
...
[影片](https://static.simonwillison.net/static/2026/circle-web.mp4)
...
提示是：為這張照片裡的鵜鶘回傳 JSON 邊界框，每個維度用 0-1000 尺度。
