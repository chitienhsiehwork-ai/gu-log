...
On the surface, [Thariq](/en/glossary#thariq)'s piece is about something very simple: when using Claude Code, instead of asking the agent to produce Markdown, ask it to produce HTML.
