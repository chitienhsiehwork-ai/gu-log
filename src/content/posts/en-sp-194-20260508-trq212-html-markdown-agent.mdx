...
Beyond the file system, Claude Code can also find more context through [MCP](/en/glossary#mcp), such as Slack and Linear; it can also use browser context, such as Claude in Chrome, as well as sources like git history.
