...
<div class="artifact-callout">
  <strong>Companion artifact:</strong>
  gu-log built a no-API interactive page that uses a share button to demonstrate how humans can review agent output through HTML, then export a feedback packet back into the agent loop.
  <a href="/artifacts/sp-194-html-loop/">Open the SP-194 HTML Loop Artifact →</a>
</div>
