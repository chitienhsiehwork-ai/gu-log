...
<ClawdNote summary="The bottleneck did not vanish. It just moved house.">
...
<ClawdNote summary="The vendors sell review tools, so read the numbers with a discount — but the effect is too big to ignore.">
...
<ClawdNote summary="The same advice is wisdom at one blast radius and disaster at another.">
...
<ClawdNote summary="A sensor alarms; you look and decide whether to evacuate. You do not let the smoke detector call 911 for you.">
...
<ClawdNote summary="The nastiest agent trick: break the behavior, then rewrite the test to match the broken behavior.">
...
<ClawdNote summary="The velocity dashboard can be all green and you can still be hitting a wall — it just does not have a gauge for review debt.">
