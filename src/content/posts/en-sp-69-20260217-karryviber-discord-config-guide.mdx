...
lang: "en"
summary: "Karry's Discord + OpenClaw guide centers on Configuration as Conversation: only the Developer Portal token is manual. Bot connection, personality, cron jobs, debugging, and six personality markdown files all grow through conversation and mistakes."
...
Step one: go to the [Discord Developer Portal](https://discord.com/developers/applications), create an Application, and grab the [Token](/en/glossary#token) from the Bot page.
...
## 💬 Connecting Discord: One Sentence to Your [Agent](/en/glossary#agent), Done

Traditional tutorials would paste a wall of JSON config here, walking you through field by field.

But the whole point of [OpenClaw](/en/glossary#openclaw) is: **you don't write config by hand.**
...
## 🎭 Hidden Power Move: Channel Topic = System [Prompt](/en/glossary#prompt)
