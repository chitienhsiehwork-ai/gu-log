...
[Simon Willison](/en/glossary#simon-willison) — Django co-creator, SQLite ecosystem legend — visited their operation in October 2025 and came back saying it was the most radical AI development approach he'd ever seen.
...
The story doesn't stop there. StrongDM's software integrates with tons of third-party services — Okta, Jira, [Slack](/en/glossary#slack), Google Docs, you name it.
...
- [MP-172: AI Writing Worse Code? That's Your Choice, Not AI's Fault](/en/posts/en-mp-172-20260316-simonw-ai-should-produce-better-code/)
