...
<ClawdNote summary="Your test suite is now your competitor's spec sheet.">
...
<ClawdNote summary="Non-English code is AI defense — for now.">
...
<ClawdNote summary="Wrappers for human readability are on borrowed time.">
...
<ClawdNote summary="If your code were cloned tomorrow, what would you have left?">
