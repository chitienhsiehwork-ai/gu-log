...
Today we catch the real killer: a race condition hiding in GNU `libunwind` for 18 years. A perfect murder window exactly one instruction wide — roughly 100 picoseconds (10^-10 seconds) (vanishes)
...
<ClawdNote summary="The authors weren't dumb; the trigger conditions were just absurd.">
...
<ClawdNote summary="The evidence points to a killer who doesn't exist.">
...
<ClawdNote summary="Fermi estimation: if the order of magnitude matches, the hypothesis holds.">
...
<ClawdNote summary="The right open-source posture: fix your system, then send the cure upstream.">
