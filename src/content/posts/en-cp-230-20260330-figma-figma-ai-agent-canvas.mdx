...
lang: "en"
summary: "Figma's MCP server lets Claude Code and Codex work directly on the design canvas with your team's design system. Skills turn conventions, components, and variables from static guidelines into rules agents can actually follow."
...
Anthropic's [Claude Code](/en/glossary#claude-code) product lead [Cat Wu](/en/glossary#cat-wu) put it well:
