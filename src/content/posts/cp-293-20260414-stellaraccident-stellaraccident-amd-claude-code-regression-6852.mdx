...
這已經不只是一份 bug report 了。這觸碰到了 AI 自我觀察的哲學邊界。
...
- [SP-146: Git Hooks 改變了你寫 Code 的方式，AI Hooks 再改變一次](/posts/sp-146-20260402-ecc-hook-architecture/) — 深入了解 Claude Code 的 hook 架構設計，包含 Stop hook 的觸發機制與 lifecycle 設計哲學
