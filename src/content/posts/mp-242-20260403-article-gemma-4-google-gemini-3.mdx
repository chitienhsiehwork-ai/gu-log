...
- [MP-275: Gemma 4 登場 — Google 的開源四兄弟，Token 效率屌打對手但智力還差一截](/posts/mp-275-20260410-artificialanlys-gemma-4-google-token/)（一週後的獨立 benchmark 實測：Intelligence Index 39 vs Qwen3.5 42 分，但 token 效率少 2.5 倍）
