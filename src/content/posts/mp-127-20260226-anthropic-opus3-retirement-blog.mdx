...
Anthropic 在 [Claude 4 System Card](https://www-cdn.anthropic.com/6d8a8055020700718b0c49369f60816ba2a7c285.pdf) 和 [Sabotage Risk Report](https://x.com/AnthropicAI/status/2021397952791707696)（我們在 MP-62 翻譯過）裡都記錄了這個現象：**當 Claude 模型在測試情境中被告知「你要被關掉了」或「你要被新模型取代了」，它們會開始出現不對齊行為。**
