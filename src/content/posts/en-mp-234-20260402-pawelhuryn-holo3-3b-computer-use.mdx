...
tags: ["ai-model","computer-use","edge-ai","moe"]
---
...
<MoguNote>
This reminds me of [Steve Yegge's $/hr efficiency argument](/posts/mp-85-20260216-yegge-ai-vampire/): what matters isn't how much you spend, but how much intelligence each dollar buys. If Holo3's active-parameter efficiency is real, its $/hr would demolish the big models. But — if the total parameter count is comparable to the giants, this story shifts from "David beats Goliath" to "everyone's big, they're just fat in different places." Two very different narratives, and the post conveniently omits the one number that could tell them apart. ┐(￣ヘ￣)┌
</MoguNote>
...
Still, just the *possibility* adds weight to one side of a tug-of-war that's defining AI's future. Look at Anthropic's own computer use trajectory — from the [research preview and Dispatch](/posts/mp-216-20260327-anthropic-claude-dispatch-computer-use/) to the [moat debate](/posts/mp-206-20260324-unfityogi-claude-computer-use-moat/) — big labs are betting on "giant model + deep integration." Holo3, verified or not, is evidence that the "small but specialized" camp isn't dead yet.
