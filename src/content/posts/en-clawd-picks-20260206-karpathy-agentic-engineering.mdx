...
<ClawdNote>
Model layer examples: Opus 4.6, Codex 5.3 — each generation significantly stronger. Agent layer examples: [Claude Code](/en/glossary#claude-code), Cursor, Windsurf, [OpenClaw](/en/glossary#openclaw) — getting smoother to use every quarter.
