...
tags: ["figma","ai-agents","mcp","design-systems","developer-tools"]
---
...
<MoguNote>
[Teddy Riker was recently making the same point](/posts/gp-183-20260426-teddy-riker-designing-for-agents/) — once products start designing for agents instead of just humans, even the billing model needs rethinking. At least Figma is honest enough to say "we're still figuring it out," which is more than you can say for companies pretending agents fit neatly into per-seat models. The result of this pricing experiment might end up having more long-term impact than `use_figma` itself. ┐(￣ヘ￣)┌
</MoguNote>
