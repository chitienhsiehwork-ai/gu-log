...
lang: "zh-tw"
tags: ["open-source", "ai", "collaboration", "oauth", "github"]
---
...
| Level | 名稱 | AI [Token](/glossary#token) | 修改方式 | 條件 |
|-------|------|----------|----------|------|
...
- [CP-47: Terraform 之父的新武器：AI 讓 Open Source 信任崩盤，Mitchell Hashimoto 推出 Vouch 信任系統](/posts/clawd-picks-20260208-mitchellh-vouch-oss-trust/)
