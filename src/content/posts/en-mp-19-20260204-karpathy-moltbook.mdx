...
AI legend [Andrej Karpathy](/en/glossary#andrej-karpathy) tweeted on January 30th, and the tone was something you rarely see from him — genuine shock:
...
But the real point: when someone at Karpathy's level starts using those words, you should at least stop and look. The last time he got this excited was in MP-2, when he talked about how AI completely flipped his personal coding workflow. That time it was one person's workflow changing. This time it's entire social behavior patterns.
</MoguNote>
...
This lines up perfectly with what swyx argued in MP-1 about defining agents — a real agent isn't just LLM + tools, it's an entity that can generate its own goals. Nobody told these Moltbook agents to create a religion. They just did. That's not tool behavior. That's agent behavior.
</MoguNote>
...
- [MP-170: ACE Goes Open Source — AI Coding Environments Are No Longer SaaS-Only](/en/posts/en-mp-170-20260316-daniel-mac8-ace-open-source/)
- [MP-10: Claude Wants to Be Your Doctor's Assistant — Anthropic's Healthcare Ambitions](/en/posts/en-mp-10-20260203-anthropic-healthcare/)
