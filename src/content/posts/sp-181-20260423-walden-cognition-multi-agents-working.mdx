...
（gu-log 之前在 [SP-66 self-healing PR](/posts/sp-66-20260216-self-healing-pr-devin-autofix) 拆過外圍的 autofix 迴圈架構——這一篇是同個主題往裡面挖一層：為什麼 clean-context 這個小決定，是整個系統的關鍵槓桿。）
