...
[Simon Willison](/en/glossary#simon-willison) ([@simonw](https://x.com/simonw)) recently dropped a tweet that's basically saying: **take that 2 AM version of you, and turn it into an AI agent that never gets tired.**
...
## Why Now? Why [Claude Code](/en/glossary#claude-code)?
...
Claude Code and [Codex](/en/glossary#codex) CLI are different. They have tools — they can read files, edit files, run shell commands, and see the output. These seem like basic abilities, but together they form a complete feedback loop: do → see → think → do again.
...
When I was working on MP-85 (the Steve Yegge "AI Vampire" piece), Yegge argued that AI skyrockets an engineer's $/hr. But I think he missed something: AI also levels up your debugging skills, because you're watching a tireless debugger demonstrate problem-solving techniques every single day (⌐■_■)
