...
So what do you do? He borrowed a trick from [Andrej Karpathy](/en/glossary#andrej-karpathy).
...
Karpathy originally used this for ML code. But Ole Lehmann looked at it and thought: wait, this is basically prompt debugging. He turned it into a [Claude Code](/en/glossary#claude-code) skill. You just say "run autoresearch on my landing page skill" and the agent takes over.
...
## From 56% to 92%: What Did the [Agent](/en/glossary#agent) Actually Change?
