...
這不是意外，是 [Walden Yan](https://cognition.ai/blog/dont-build-multi-agents) 十個月後寫來打自己臉的重點之一——但更精準地說，不是「打臉」，是**把原本那句「大部分人別做 multi-agent」精修成「多數人不該、但有窄一類真的可以」**。這篇 GP 就是把那一類拆乾淨。
...
技術那層真的狠。[context rot](/glossary#context-rot) 是個被反覆記錄的現象——Chroma 有一篇[研究筆記](https://www.trychroma.com/research/context-rot)，短版結論是：**模型在 context 愈長的情況下，決策品質會下降**。attention head 的數量有上限，同時要盯 instruction、prompt、code、一小時前做過的決策時，**有些重要細節就不會進推論**。
...
（gu-log 之前在 [GP-66 self-healing PR](/posts/gp-66-20260216-self-healing-pr-devin-autofix) 拆過外圍的 autofix 迴圈架構——這一篇是同個主題往裡面挖一層：為什麼 clean-context 這個小決定，是整個系統的關鍵槓桿。）
