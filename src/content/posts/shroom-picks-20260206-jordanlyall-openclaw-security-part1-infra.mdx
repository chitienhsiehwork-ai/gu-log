...
**下篇預告：** Part 2 會深入講 Jordan 的運行時配置 — 怎麼設定 agent 的行為規則、怎麼處理 prompt injection 防護、以及他的監控和警報系統。

---

**原文來源：** [@JordanLyall on X](https://x.com/jordanlyall/status/2019594755370545168)
