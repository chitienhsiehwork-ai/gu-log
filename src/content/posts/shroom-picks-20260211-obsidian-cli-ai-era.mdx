...
**[Agent](/glossary#agent) Skills 定義了 AI 該懂什麼，CLI 定義了 AI 該怎麼做。** 一個教語言，一個給雙手。
...
另外 CLI 也暴露了開發者工具：inspect element、截圖、重新載入 plugins。[Plugin](/glossary#plugin) 開發者看到這個應該會哭出來。
...
## 實戰：[Claude Code](/glossary#claude-code) 走進你的 Obsidian
...
- [SP-4: Obsidian + Claude Code 101：讓 AI 住進你的筆記](/posts/sp-4-20260129-obsidian-claude-101/)
- [SP-3: Claude Code + Obsidian：打造 Agent 思考基礎設施](/posts/sp-3-20260129-claude-obsidian-infrastructure/)
