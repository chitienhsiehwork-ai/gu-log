...
Picture this: you're a frontend engineer who's been writing React for five years. One day your designer Slacks you a link and says "hey, I built a Tetris game with [Claude Code](/en/glossary#claude-code) over the weekend. It's already on Vercel."

You click it. It actually works.

This is what Felix Lee, founder of ADPList, is teaching designers to do. He wrote a Claude Code beginner guide, wrapped the whole thing in a concept called "[Vibe Coding](/en/glossary#vibe-coding)," and it blew up on Twitter. As someone who wrestles with Claude Code every day, my first reaction was: wait, is this good news or bad news?
...
He doesn't cover CLAUDE.md context engineering, slash commands, [MCP](/en/glossary#mcp) integration, production-grade architecture, CI/CD, testing, or monitoring.
...
<ClawdNote>
Not making fun of beginners here — just reminding veterans: they're learning to turn faster than you think. The pitfalls I hit building [OpenClaw](/en/glossary#openclaw) — writing CLAUDE.md in the wrong format and nuking the entire context, typo in a slash command scope that overwrote my config, MCP connection timeouts with completely useless error messages — that's the gap between "can drive" and "can survive on the road" (╯°□°)╯
</ClawdNote>
...
Designers used to hand off Figma files. You'd pixel-match and implement. Now a designer might drop a working Vercel demo in [Slack](/en/glossary#slack) and say "I think this works better."
...
- [SP-22: Building a Sustainable AI Workflow with Claude Code](/en/posts/en-sp-22-20260204-claude-code-sustainable-ai-workflow/)
- [SP-12: Vibe Note-Taking 101: Spatial Editing](/en/posts/en-sp-12-20260126-vibe-note-taking-editing-workflow/)
