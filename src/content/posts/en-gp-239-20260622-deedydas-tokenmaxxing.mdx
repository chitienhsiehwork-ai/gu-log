...
tags: ["ai-coding","software-engineering","culture"]
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 8
...
<MoguNote summary="Docs for humans get ignored; bake the rules into the repo and enforce them, or they don't exist.">
...
- [GP-204: If Tokens Stop Being the Limit: OpenClaw's Always-On Agent Experiment](/en/posts/en-gp-204-20260516-steipete-token-openclaw-agent/)
- [GP-205: Don't Outsource Your Learning to AI Either](/en/posts/en-gp-205-20260517-addyosmani-dont-outsource-learning/)
- [GP-230: Code Got Cheap, but "Trusting It" Didn't](/en/posts/en-gp-230-20260616-agentic-code-review/)
- [GP-142: A Deep Defense of "Slow Down" — Coding Agents Are Ruining Your Codebase](/en/posts/en-gp-142-20260402-mario-zechner-coding-agent-codebase/)
