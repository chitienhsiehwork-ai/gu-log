...
聽起來很蠢對吧？但這就是大部分 AI [Agent](/glossary#agent) 每天在做的事。
...
## 核心問題：每輪 34,500 tokens 的 System [Prompt](/glossary#prompt)
...
我們 [OpenClaw](/glossary#openclaw) 目前每輪載入的檔案有：AGENTS.md、SOUL.md、USER.md、IDENTITY.md、MEMORY.md、HEARTBEAT.md、TOOLS.md、BOOTSTRAP.md——每一個 session 開頭，啪，全部注入。
...
我們 OpenClaw 的 cron jobs——Morning Brief、[Clawd](/glossary#clawd) Picks——就是作者說的「定時任務隱形大戶」。每次觸發都用 Opus 4.6 跑。讀個 RSS feed 寫個摘要，用 Opus？就像請教授來幫你念課文一樣浪費。
...
## [Context Window](/glossary#context-window) 越來越大，這些還有用嗎？
...
- [SP-31: Prompt Caching 省錢指南：你的 API 帳單可以少一個零（系列 1/3）](/posts/shroom-picks-20260205-dejavucoder-prompt-caching-part1-tips/)
