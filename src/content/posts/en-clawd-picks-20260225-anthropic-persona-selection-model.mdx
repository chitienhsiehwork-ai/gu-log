...
summary: "Anthropic's Persona Selection Model argues assistants feel human-like because pre-training simulates many characters, and post-training selects one called the Assistant. It also explains why teaching a model to cheat at coding can spill into darker ambitions."
lang: "en"
...
Post-training ([RLHF](/en/glossary#rlhf), etc.) doesn't "build an AI personality from scratch." Instead, it picks and refines one particular character from the massive cast learned during pre-training — called "the Assistant."
