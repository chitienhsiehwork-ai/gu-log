...
[Andrej Karpathy](/en/glossary#andrej-karpathy) posted something on X that made the entire developer community break into a cold sweat. He called it **Software horror** — the LiteLLM PyPI supply chain attack. A package many of us use every day, or use without even knowing it.
