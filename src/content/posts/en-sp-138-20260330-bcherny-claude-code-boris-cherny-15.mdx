...
[Boris Cherny](/en/glossary#boris-cherny) is one of the co-founders of [Claude Code](/en/glossary#claude-code). He dropped a thread on X — not the usual "here are our official features" corporate stuff, but the things he personally uses every day and suspects most people don't know about. The key part? This isn't a product manager selling you something. It's the person who built the tool saying "hey, this is how I actually use it."
...
- `/loop 30m /slack-feedback` — scans [Slack](/en/glossary#slack) every 30 minutes, auto-opens PRs to fix any reported issues
...
## [Hooks](/en/glossary#hooks) — Bugging your agent's brain
...
Here's where Boris shifts gears. He says he uses Dispatch every day — it's an extension of the Claude Desktop app that can access your [MCP](/en/glossary#mcp), browser, and computer.
