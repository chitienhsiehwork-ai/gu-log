...
First: **Personal assistants like [OpenClaw](/en/glossary#openclaw)**. Second: **Coding agents like [Claude Code](/en/glossary#claude-code), OpenCode, or [Codex](/en/glossary#codex)**.
