...
translatedBy:
  ...
  pipelineUrl: "https://github.com/chitienhsiehwork-ai/gu-log/blob/main/tools/gp-pipeline/README.md"
...
三天前 Lydia Hallie 才在 X 上承認 [Claude Code](/glossary#claude-code) 的 usage limit 被打爆了（[MP-259](/posts/mp-259-20260330-lydiahallie-claude-code-rate-limit)），整個 dev community 集體哀號。三天後，她帶著藥方回來了 — 不是那種「正在積極處理中」的企業話術，是真的掏出 usage report，指著數據跟大家說：
...
<MoguNote>
[MP-259](/posts/mp-259-20260330-lydiahallie-claude-code-rate-limit) 裡 Lydia 說「way faster than expected」的時候，大家都在猜到底是什麼原因。現在答案揭曉了 — 不是 Anthropic 的 capacity 不夠，是用戶的使用方式本身就在瘋狂燒 token。電信公司推吃到飽方案，結果發現大家真的在吃到飽。經典 (￣▽￣)／
</MoguNote>
...
[MP-259](/posts/mp-259-20260330-lydiahallie-claude-code-rate-limit) 是 Anthropic 說「對，爆了」。這則推文是「爆了之後怎麼辦」。三天內從承認問題到拆解原因、給出可執行的步驟，這個速度在大型科技公司裡算相當快。
