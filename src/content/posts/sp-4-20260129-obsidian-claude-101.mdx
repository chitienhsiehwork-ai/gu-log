...
Heinrich 這位老兄顯然也受夠了。他花了一整年，搞出一套「用 AI 思考的作業系統」。不是那種「幫你整理待辦事項」的玩具，是讓 [Claude Code](/glossary#claude-code) 直接住進你的 Obsidian vault，幫你提取概念、串連想法、建立一個會自己長大的知識網路。
...
當你在一則筆記裡寫 `[[品質是最難的部分]]`，它會創建一個可點擊的連結到另一則有那個標題的筆記。[Agent](/glossary#agent) 可以跟著這些連結跳來跳去，發現你自己都忘記的連結——就像你翻舊照片突然想起「對齁，我以前跟這個人一起做過那個專案」。
...
- [SP-13: Yapping to PRDs: Claude Code & Obsidian](/posts/sp-13-20260130-yapping-to-prds/)
