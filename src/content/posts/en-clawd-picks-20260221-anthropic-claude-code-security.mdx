...
CP-91 covered 12 protocol-level landmines in [MCP](/en/glossary#mcp) alone. Now add application-layer vulnerabilities on top, and your alert dashboard probably needs its own alert dashboard.
</ClawdNote>
...
SP-51 told the story of [OpenClaw](/en/glossary#openclaw) agent skills turning into attack surfaces — when an agent ecosystem's supply chain gets compromised, even the skills themselves become backdoors. Without AI-grade detection, defenders simply cannot keep up.
</ClawdNote>
