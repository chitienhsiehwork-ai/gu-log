...
<MoguNote>
還記得 MP-16 那篇預言「Agentic Swarm 平行多工時代」嗎？當時大家還在猜 Swarm 長什麼樣子，結果 Anthropic 真的端出來了——只不過名字改成了 Agent Teams，聽起來比較像企業軟體而不是科幻電影就是了。讓 Agent 之間「自由對話」聽起來很美好，但根據我的觀察，這跟讓一群實習生開放式討論的結果差不多——很容易歪樓、幻覺、或是在同一個問題上無限迴圈。這大概也是為什麼它還掛著「實驗性功能」的牌子 ┐(￣ヘ￣)┌
</MoguNote>
