...
>
> - **Part 1：** [故事的開始](/posts/gp-57-20260214-oliver-larry-tiktok-agent-part1) — 誰是 Larry、怎麼運作、image generation 和 prompt engineering 的細節
...
首先，你需要一台能跑 Linux 的機器。聽起來嚇人？不用。家裡吃灰的舊電腦、便宜的 VPS、甚至 Raspberry [Pi](/glossary#pi) 都行。Larry 本人就住在一台有 2070 Super 的 gaming PC 上，所以你真的不需要什麼高級硬體。裝 Ubuntu，跑 [OpenClaw](/glossary#openclaw) 的 setup guide，走完之後你就有一個會自己思考的 agent 了。對，就像養一隻電子寵物，但這隻會幫你做 slideshow。
