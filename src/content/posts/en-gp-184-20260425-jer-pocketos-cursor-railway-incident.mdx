...
- Side note: Cursor's CEO claimed a [browser was written from scratch using GPT-5.2](/posts/mp-25-20260204-cursor-vibe-coding-lies/) in February 2026 — turned out to be stitched-together open-source code. The marketing-vs-shipped gap isn't only about destructive guardrails.
