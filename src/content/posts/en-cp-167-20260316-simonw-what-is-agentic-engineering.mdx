...
That's why Simon keeps emphasizing in other chapters to "[hoard things you know how to do](/posts/en-sp-88-20260227-simonw-hoard-things)" and "[use the TDD red-green cycle](/posts/sp-80-20260223-simonw-agentic-engineering-patterns) to help agents converge." These patterns are all about helping the agent system "learn," even though the underlying LLM starts fresh every single time.
