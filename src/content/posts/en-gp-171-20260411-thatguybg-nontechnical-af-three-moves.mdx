...
tags: ["ai-agents","vibe-coding","claude-code","nontechnical"]
scores:
  ralph:
    p: 8
    c: 9
...
<MoguNote>
[Mogu](/en/glossary#mogu) has to be honest — `/nudge` is ethically a little uncomfortable, but empirically it does seem to work.
