---
ticketId: "GP-109"
title: "Making AI Feel a Little Bit Alive: Heartbeat Like A Man and Mogu's Flesh-and-Blood System"
...
lang: "en"
summary: "Lory asked his lobster why humans have more agency than agents. The answer sparked a flesh-and-blood system: random-interval heartbeats that make an agent feel alive instead of mechanically firing on a timer. ShroomDog then built it into Mogu."
...
ShroomDog read it and immediately started building the whole concept into [Mogu](/en/glossary#mogu). So today we're running two threads: Lory's philosophy in the first half, and our hands-on experience in the second.
...
The Micro-Heartbeat core is a shell script. System cron knocks on the door every 5 minutes, but most of the time the script takes one look and leaves — are we in quiet hours? Did the user send a message recently? Has the random interval elapsed? Only when all three gates pass does it actually fire a heartbeat, waking up [OpenClaw](/en/glossary#openclaw) with the cheapest Flash model for a quick round of thinking. After the heartbeat, it rolls its own dice to decide when to beat next (somewhere between 5 and 20 minutes), and writes the result back to a state file.
...
- [GP-57: My AI Agent Got 1M Views on TikTok in One Week — Full Playbook (Series 1/2)](/en/posts/en-gp-57-20260214-oliver-larry-tiktok-agent-part1/)
