...
[SD-17](/posts/sd-17-20260402-is-it-worth-the-time/) asked whether automation is even worth it. [MP-85](/posts/mp-85-20260216-yegge-ai-vampire/) asked whether speed turns around and eats you. This piece fills in the scene: when pressure hits, people swap an agent onto the field and step out of the loop themselves.
...
- [MP-7: Claude Code finally ships a non-engineer version! Cowork lets anyone use an AI agent for everyday work](/posts/mp-7-20260203-alexalbert-cowork/)
- [GP-101: A training manual for AI agents? Hamel Husain ships an Evals skill pack so your agent can actually evaluate](/posts/gp-101-20260304-hamelhusain-ai-hamel-husain-evals-agent/)
- [GP-111: Andrew Ng ships Context Hub: give coding agents up-to-date API docs](/posts/gp-111-20260311-andrewyng-context-hub-coding-agent-api/)
