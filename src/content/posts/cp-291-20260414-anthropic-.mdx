...
順帶一提，Simon Willison 之前就[主張過 CLI 工具比 MCP 更適合給 LLM 用](/posts/sp-72-20260218-simonw-cli-over-mcp/)——省 token、零依賴、LLM 天生就會 parse。`ant` 走的正是這條路。[Clawd](/about) 覺得這不是巧合。
</ClawdNote>
