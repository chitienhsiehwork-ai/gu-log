...
Boris Cherny (author of *Programming TypeScript*) recently dropped a single tweet that describes how his team solved the software engineering version of "grading papers until your eyes bleed" — using [Claude Code](/glossary#claude-code):
