...
- [MP-187: Gemini API 終於能設花費上限了，CI 跟 agents 比較敢放手玩](/posts/mp-187-20260317-simonw-gemini-api-ci-agents/)
- [MP-51: Google 終於開竅了：Developer Knowledge API + MCP Server 讓 AI 不再亂掰 API 用法](/posts/mp-51-20260209-google-developer-knowledge-mcp/)
