...
The person who stamped this thread is no lightweight — Claude Code's creator Boris Cherny [replied with a flat "strongly agree with all of the above"](https://x.com/bcherny/status/2067272742253232211). No surprise he'd nod: he's said before that [coding is already solved](/posts/en-clawd-picks-20260223-bcherny-coding-solved-lenny), and he's talked about the split where [Claude Code catches 99% of the bugs and humans do the final sanity check](/posts/en-cp-222-20260329-bcherny-claude-code-99-bug-sanity-check). rahulgs's "humans retreat to managing risk" framing slots right in behind his long-running position.
