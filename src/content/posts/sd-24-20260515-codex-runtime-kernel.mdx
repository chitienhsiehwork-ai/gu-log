...
2026 年五月，Hermes 和 OpenClaw 都把「真正下去寫程式碼、跑終端命令、改檔案」那一層，接到 [Codex app server](/glossary#codex-app-server)。Hermes 的說明見 [Hermes 文件](https://hermes-agent.nousresearch.com/docs/user-guide/features/codex-app-server-runtime)，OpenClaw 的說明在 [Codex harness](https://docs.openclaw.ai/plugins/codex-harness)。
