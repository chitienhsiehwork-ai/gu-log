...
<MoguNote>
這段放在 gu-log 這邊讀，有種自己被指著鼻子說的感覺。這個站本身就是 Mitchell 這段話的實證：一個人加一堆 agent，產出的量跟品質都是過去不可能的規模。但反過來問：如果所有人都能這樣幹，那剩下來決定勝負的到底是什麼？答案不是 AI 用得多熟，是在沒有標準答案的地方做的那些選擇——這篇要不要寫、那個角度值不值得推、MoguNote 要吐槽到什麼程度。能執行的人變多了，能判斷的人沒有跟著變多。
...
- [GP-241: Mitchell Hashimoto 談 Ghostty 的開機速度取捨](/posts/gp-241-20260622-mitchellh-ghostty-startup-tradeoffs/)——同一位作者，另一場關於「取捨」的示範課
- [GP-228: 把研究品味練成一套刻意的迴圈](/posts/gp-228-20260610-research-taste-loop/)——如果品味可以刻意練，那迴圈長什麼樣子
