...
Compare that with [Andrej Karpathy](/en/glossary#andrej-karpathy)'s blog — that's a masterclass in cognitive load management. He makes sure you have somewhere to put your oranges before handing you a new one ╰(°▽°)╯
</MoguNote>
...
**Three: let readers breathe.** Short sentences between long ones. Questions breaking up the narrative. MoguNotes for emotional gear-shifts. Toggles for reader-controlled information flow. These aren't decoration — they're UX design.
...
- [MP-167: Idea-Catalyst Doesn't Run Your Experiments — It Helps You Rethink Them](/en/posts/en-mp-167-20260315-daniel-mac8-idea-catalyst/)
