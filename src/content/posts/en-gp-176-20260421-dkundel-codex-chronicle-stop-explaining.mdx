...
lang: "en"
summary: "OpenAI DevX's Dominik Kundel says Chronicle means he no longer packages context for AI: one line can sync docs, edit markdown, open a PR, and DM Slack. Nice, but Chronicle's costs are real: screen recording, unencrypted local memories, and prompt-injection risk."
...
- [GP-173: Harrison Chase says if you don't own the harness you don't own memory](/posts/gp-173-20260411-hwchase17-harness-memory-lockin/)
- [Codex glossary entry](/en/glossary#codex)
