...
summary: "Chris Lattner reviewed the Claude C Compiler built by 16 parallel Claude Opus agents. His verdict: AI can assemble serious engineering systems, but it mostly recombines known knowledge. His Modular team expectations read like an AI coding strategy guide."
lang: "en"
...
In early February, Anthropic did something that blew up the CS world: they had 16 Claude Opus 4.6 instances working in parallel to [build a C compiler from scratch](https://www.anthropic.com/engineering/building-c-compiler) that can compile the Linux Kernel (we covered this in [MP-38](/posts/mp-38-20260207-anthropic-c-compiler)).
...
[Simon Willison](/en/glossary#simon-willison)'s [Red/Green TDD pattern](https://simonwillison.net/guides/agentic-engineering-patterns/red-green-tdd/) tells the same story: test-driven development works brilliantly for AI, but your test suite IS the ceiling of AI output. Better tests, better AI. Gaps in tests? AI exploits the gaps. (⌐■_■)
</MoguNote>
