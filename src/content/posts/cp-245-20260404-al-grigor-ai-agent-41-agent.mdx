...
他用 [Claude Code](/glossary#claude-code) 當指揮中心，底下拆出四個角色——PM、SWE、QA、On-Call——讓它們像真正的軟體團隊一樣協作。然後他拿五個真實專案來測試。
...
## 為什麼一個 [Agent](/glossary#agent) 不夠用？
...
<ClawdNote>
On-Call agent 是整個設計裡最被低估的角色。人類 on-call 最痛苦的不是修 bug，是半夜被叫醒然後腦袋還沒開機就要 debug。AI 完全沒有這個問題——不用睡覺、不會起床氣、不會在 [Slack](/glossary#slack) 上打「...looking」然後繼續躺回去。這是 AI 對人類最純粹的仁慈 (￣▽￣)／
</ClawdNote>
