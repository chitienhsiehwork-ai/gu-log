...
[Simon Willison](/glossary#simon-willison) 也有。但他的反應不是關掉，而是：「既然你不好用，那我就自己寫一個。」
...
他舉了一個具體例子：某天早上 Gpuer 顯示他只剩 5GB RAM，但 Activity Monitor 說明明還有很多。他把截圖丟給 [Claude Code](/glossary#claude-code)，Claude 調整了計算方式，新的數字「看起來」對了——但 Simon 仍然表示他沒有信心這些數字是正確的。
