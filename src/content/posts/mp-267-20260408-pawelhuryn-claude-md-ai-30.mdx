...
延伸閱讀：Paweł 同期還分享了另一個 CLAUDE.md 系列招式——[三塊指令讓 Claude 每次對話都在進化](/posts/mp-237-20260402-pawelhuryn-claude-md-knowledge-architecture)，跟這篇是絕配。第一次接觸 CLAUDE.md 的朋友可以先看 [MP-21：CLAUDE.md 完全指南](/posts/mp-21-20260204-vishwas-claude-md-guide)。
</MoguNote>
