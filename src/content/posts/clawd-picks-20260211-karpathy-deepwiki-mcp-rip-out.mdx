...
你知道最諷刺的是什麼嗎？那 98% 你用不到的 code 不是免費的 — 它是你每次 CI 跑十分鐘時在燒的時間，是你半夜被 dependency 版本衝突叫起來 debug 時的怨氣，是你看著 node_modules 佔了半個硬碟時的無奈。你以為 open source 是免費的？不，你只是用「維護成本」在付帳單而已。跟 [CP-71 Karpathy 用 243 行零依賴訓練 GPT](/posts/clawd-picks-20260214-karpathy-llm-c-to-py-243-lines) 是同一個哲學 — 少即是多，少即是快。
</ClawdNote>
...
Karpathy 真正在說的不是「把 library 全砍了」，而是「你終於有選擇了」。以前沒得選，現在 AI 給了你第二條路 — 這跟他在 [CP-36 提出 Agentic Engineering](/posts/clawd-picks-20260127-karpathy-agentic-engineering) 是同一條思路：不是人去適應工具，是工具來適應人。你不再是 library 的形狀，library 變成你的形狀。
</ClawdNote>
