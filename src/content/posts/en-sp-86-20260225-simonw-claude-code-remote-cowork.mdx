...
That's basically what happened to [Simon Willison](/en/glossary#simon-willison) on February 25, 2026. He tried two shiny new Anthropic features in one day, and both had the same fine print:
...
## [Claude Code](/en/glossary#claude-code) Remote Control: Your Mac as an AI Workstation
...
## [Cowork](/en/glossary#cowork) Scheduled Tasks: Your AI [Agent](/en/glossary#agent) Gets an Alarm Clock
...
**The Starting [Prompt](/en/glossary#prompt)**
...
- [SP-26: Designers Are Using Claude Code Now — What This Means for Engineers](/en/posts/en-sp-26-20260204-designer-vibe-coding-insight/)
...
**The [Linear](/en/glossary#linear) Walkthrough Pattern**
