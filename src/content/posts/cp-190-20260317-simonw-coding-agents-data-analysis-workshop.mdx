...
現在 [Simon Willison](/glossary#simon-willison) 跟你說：欸，其實你可以叫 AI agent 幫你做這件事。

而且他不是嘴上說說 —— 他直接把三小時 workshop 的完整講義丟上來了。

這份 handout 來自 NICAR（National Institute for Computer-Assisted Reporting）的 data journalism conference。對，就是那個每年全美資料記者都會去的大拜拜。Simon 在那裡教了一場三小時的 workshop，主題是怎麼把 [Codex](/glossary#codex) CLI、[Claude Code](/glossary#claude-code) 這類 coding agents 拿來做資料探索、視覺化和分析。
