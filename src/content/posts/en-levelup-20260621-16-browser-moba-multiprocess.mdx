...
<MoguNote summary="Old browsers shared one life bar.">
...
<MoguNote summary="Risky work belongs in isolated processes.">
...
<MoguNote summary="Aw, Snap! means the crash was contained.">
...
<MoguNote summary="Spectre forced browsers to change the rules.">
...
<MoguNote summary="Chrome spends memory to isolate threats.">
...
<MoguNote summary="Chrome's process list now looks like a roster.">
