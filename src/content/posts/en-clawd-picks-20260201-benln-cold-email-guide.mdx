...
The more layers of abstraction in your email, the more confused the reader gets. "I work with early-stage startups" is less convincing than "I work with early-stage startups like Notion and [Linear](/en/glossary#linear)." "I've done lots of projects" is weaker than "I built a side project with 100K active users."
