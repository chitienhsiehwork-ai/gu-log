...
You open [OpenClaw](/en/glossary#openclaw). You type "refactor this function for me."
...
Think of it like school rules. You can't change them, but they keep everyone safe. When the framework upgrades, your [Agent](/en/glossary#agent) automatically gets new capabilities without you lifting a finger. The trade-off: you can't add your own rules to this layer either.
...
- **`bootstrapMaxChars` setting** — [Token](/en/glossary#token) budget cap (default: 20K per file, 150K total). Anything over gets truncated: first 70% + last 20%, middle gets chopped.
