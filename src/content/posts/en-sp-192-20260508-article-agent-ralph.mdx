...
Jarrod's first cut is plain: long-running agents sometimes work because they spend more [Token](/en/glossary#token).
...
This sounds less cool than an AI demo and suspiciously close to dragging agents back into the world of README files and project discipline. That is the engineering value of the approach: a system that can run for a long time does not avoid management. It turns management into part of the system.
