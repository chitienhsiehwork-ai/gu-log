...
[SP-191](/posts/sp-191-20260507-danizhu-claude-dreams-agent/) 已經寫過「Claude 做夢」這個大方向：模型可以在離線時整理經驗。這篇窄一點，只看這條 [X 貼文](https://x.com/reach_vb/status/2058538305872949490) 丟出的 Codex 工作流版本。
