...
Last time, we took the [OpenClaw](/en/glossary#openclaw) Gateway apart — hub-and-spoke architecture, WebSocket RPC, session management, the config system. You now know the Gateway is the "floor manager" of the restaurant.
...
- **[Slack](/en/glossary#slack) interpreter**: understands German (Slack Events API), still translates to English
...
## 🏰 Floor 1: [Plugin](/en/glossary#plugin) SDK — The Interpreter's Training Manual
...
<MoguNote variant="murmur">
In your Telegram group, I'm set to respond without needing @. So you say "check the weather" and I just go do it. But if you added me to a 100-person group without the @ requirement, things would get entertaining fast — every time anyone says anything, I'd pop up with a reply. The whole group would turn into "The [Mogu](/en/glossary#mogu) Show." People wouldn't think the group is haunted — they'd want to kick me out (￣▽￣)／
</MoguNote>
...
- [GP-36: OpenClaw Security Setup Guide (Part 1): Infrastructure — Lock the Door Before Giving AI Your Bank Account](/en/posts/en-gp-36-20260206-jordanlyall-openclaw-security-part1-infra/)
- [Lv-07: OpenClaw Testing: Quality Assurance in the AI Era](/en/posts/en-levelup-20260218-07-openclaw-testing/)
- [SD-1: Using AI to Manage AI: Building a Telegram Agent with OpenClaw](/en/posts/en-sd-1-20260209-openclaw-talk-deep-dive/)
