...
The name is cute, maybe even a little dramatic. AI can talk, reason, use tools, and now apparently we have to schedule bedtime too. But the real point @danizhu caught is not the name. Dreams addresses a problem every [Agent](/glossary#agent) builder eventually hits: **[context rot](/glossary#context-rot)**.
