...
lang: "en"
summary: "Anthropic released Claude computer use in Claude Cowork and Claude Code, letting Claude control your screen, mouse, and keyboard. Paired with Dispatch, you can assign tasks from your phone while Claude works on your Mac."
...
This isn't a sci-fi trailer. Anthropic actually shipped this last week. Claude can now move your mouse, click buttons, open browsers, and operate your screen inside Claude [Cowork](/en/glossary#cowork) and [Claude Code](/en/glossary#claude-code). Not through APIs. Not as a metaphor. It literally controls your screen, pixel by pixel. And with the new Dispatch feature, you can send it tasks from your phone while you're away from your computer.
...
1. **Connectors first** — If there's a direct integration (like [Slack](/en/glossary#slack) or Google Calendar), Claude uses the API. It's faster and more reliable.
