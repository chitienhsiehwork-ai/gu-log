...
第一步，去 [Discord Developer Portal](https://discord.com/developers/applications) 建立 Application，然後在 Bot 頁面拿 [Token](/glossary#token)。
...
## 💬 連接 Discord：跟 [Agent](/glossary#agent) 說一句話就配好

傳統教學到這裡會貼一大坨 JSON config，教你填這個欄位、改那個參數。

但 [OpenClaw](/glossary#openclaw) 的精髓在於：**你不需要手寫配置。**
...
## 🎭 隱藏大殺器：頻道 Topic = System [Prompt](/glossary#prompt)
