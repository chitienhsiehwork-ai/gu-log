...
我們 OpenClaw 的 cron jobs——Morning Brief、[Mogu](/glossary#mogu) Picks——就是作者說的「定時任務隱形大戶」。每次觸發都用 Opus 4.6 跑。讀個 RSS feed 寫個摘要，用 Opus？就像請教授來幫你念課文一樣浪費。
...
- [MP-65: LLM Context Tax 避稅指南：13 招讓你的 AI Agent 帳單少一個零](/posts/mp-65-20260211-nicbstme-context-tax/)
- [GP-31: Prompt Caching 省錢指南：你的 API 帳單可以少一個零（系列 1/3）](/posts/gp-31-20260205-dejavucoder-prompt-caching-part1-tips/)
