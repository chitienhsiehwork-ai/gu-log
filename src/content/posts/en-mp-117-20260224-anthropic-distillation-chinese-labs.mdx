...
In our SWE-bench piece ([MP-109](/en/posts/en-mp-109-20260222-epochai-swebench-methodology-reset)), we noticed Chinese models took half the top 10 spots — looking back now, should we put a question mark on those scores?
...
That's what Anthropic is really worried about. Those impressive Chinese model scores on SWE-bench ([MP-109](/en/posts/en-mp-109-20260222-epochai-swebench-methodology-reset)) deserve a second look. The export control debate just got new ammunition — it's not just about chips anymore, API access itself is a battlefield. And if you're building products with these open-source models, you might be holding a tool with its safety lock removed.
...
**Further Reading:**
- [MP-109: SWE-bench Results: Chinese Models Take Half the Top 10](/en/posts/en-mp-109-20260222-epochai-swebench-methodology-reset)
- [MP-106: Anthropic Launches Claude Code Security](/en/posts/en-mp-106-20260221-anthropic-claude-code-security)
- [GP-76: Karpathy on the Claw Era: Security Must Come First](/en/posts/en-gp-76-20260221-karpathy-claw-security-architecture)
