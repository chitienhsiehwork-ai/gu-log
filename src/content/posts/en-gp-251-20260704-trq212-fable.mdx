...
tags: ["agentic-coding","prompt-engineering","fable","workflow"]
scores:
  tribunalVersion: 9
  factCheck:
    accuracy: 8
...
import mapVsTerritory from '../../assets/posts/gp-251-fable-unknowns/map-vs-territory-en.png';
import knownUnknownsQuadrant from '../../assets/posts/gp-251-fable-unknowns/known-unknowns-quadrant-en.png';
import unknownDiscoveryLoop from '../../assets/posts/gp-251-fable-unknowns/unknown-discovery-loop-en.png';
...
<PostImage
  src={mapVsTerritory}
  alt="A diagram showing the same landscape as a simplified map on the left and as the real world on the right, where the real world includes a road closure, construction site, and pothole missing from the map"
  caption="The map and the real world can describe the same place, but the map may be stale or omit tiny details that matter on foot. Prompts work the same way for agents."
/>
...
<PostImage
  ...
  alt="A four-quadrant diagram with English labels, definitions, and everyday examples for known knowns, known unknowns, unknown knowns, and unknown unknowns, with the unknown unknowns quadrant shown as a dark pothole warning"
  caption="The frame only becomes useful when the abstractions touch daily life: some things you know, some answers you know are missing, and the dangerous ones are the potholes you never expected."
/>
...
<a class="artifact-callout" href="/artifacts/gp-251-unknowns/index.html">
...
<PostImage
  ...
  alt="A three-step loop showing unknown discovery before implementation through a map scan, during implementation through question marks in an editor, and after implementation through warning signs, a surprised user bubble, and expected-versus-actual mismatch"
  caption="Unknowns can surface after delivery as a 'why did this happen?' symptom. The earlier they appear, the cheaper they are to handle."
/>
...
- [GP-237: Driving Agents Like Steam Locomotives: Operating Principles for Coding Agents on Large Projects](/posts/gp-237-20260621-simonlast-agent-coding-agent/)
- [GP-223: Fable 5 Is So Capable, You Have to Relearn How to Talk to It — Anthropic's Official Prompting Guide Breakdown](/posts/gp-223-20260613-anthropic-prompting-fable-5/)
- [GP-247: Four-Model Alliance: A Claude Code Org Chart with Fable as Tech Lead](/posts/gp-247-20260702-diegocabezas01-fable-tech-lead-claude-code/)
