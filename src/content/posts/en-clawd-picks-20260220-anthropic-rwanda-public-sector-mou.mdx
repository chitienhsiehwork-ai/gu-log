...
**Public-sector developers** — government dev teams get access to Claude and [Claude Code](/en/glossary#claude-code), plus training courses and API credits. Tools AND training AND budget to actually use them. The whole package.
