...
func TestLoadGPProfileRejectsLegacyMissingAndDuplicateRoles(t *testing.T) {
	...
	config := `{"profiles":{"test":{"translator":{"provider":"grok","model":"same","reasoningEffort":"low","promptContract":"p1","outputContract":"o1"},"sourceReviewer":{"provider":"codex","model":"review","reasoningEffort":"high","promptContract":"p2","outputContract":"o2"},"corrector":{"provider":"codex","model":"same","reasoningEffort":"high","promptContract":"p3","outputContract":"o3"},"commentary":{"provider":"grok","model":"comment","reasoningEffort":"low","promptContract":"p4","outputContract":"o4"},"vibeScorer":{"provider":"grok","model":"vibe","reasoningEffort":"low","promptContract":"p5","outputContract":"o5"}}}}`
