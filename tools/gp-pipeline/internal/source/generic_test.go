...
func TestValidateSafeHTTPURL(t *testing.T) {
	cases := []struct {
		...
		{"canonical public IPv4 ok", "https://8.8.8.8/article", false},
		...
		{"single integer loopback rejected", "http://2130706433/secret", true},
		{"octal loopback rejected", "http://0177.0.0.1/secret", true},
		{"hex loopback rejected", "http://0x7f000001/secret", true},
		{"short loopback rejected", "http://127.1/secret", true},
