...
// formerly embedded in the bash pipeline (validate_tweet_source_capture and
...
//
// Rules (mirroring the retired bash validate_tweet_source_capture):
...
// ValidateArticleCapture applies the pipeline's source-completeness validator
