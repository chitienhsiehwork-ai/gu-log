...
**Problem**: 敘事結構是 gu-log 品質的核心差異化因素（GU-LOG_WRITER_PROMPT 整個 Narrative Structure section），也是 SP-158 核心教訓（decorative persona + linear structure = trap）。但沒有任何 dimension explicitly 測結構。
