...
| `crossRef` | 內部文章 cross-reference + identity linking（ShroomDog/Mogu 首次出現連結） | crossReferences + identityLinking |
...
| `moguNote` | 吐槽 + 洞察品質：有沒有自己的立場、不只是解釋 |
...
| **Vibe** | vibe | `score/10` | persona · moguNote · vibe · clarity |
