...
| # | 文章組 | 問題類型 | sourceUrl |
|---|---|---|---|
| 1 | GP-127 + MP-250 + MP-261 | 同 URL (CP) + 同 topic (SP↔CP) | anthropic.com/engineering/... + x.com tweet |
...
3. **無 cross-series check** — SP 和 MP pipeline 完全獨立，同一篇 tweet 可以各翻一次。
...
| 組 | 保留 | Deprecate | 理由 |
|---|---|---|---|
| 1 | GP-127 | MP-250, MP-261 | SP 是 deep-dive 原文翻譯，品質 > CP tweet 翻譯 |
| 2 | MP-218 或 MP-235 | 另一篇 | 需比較品質，二選一 |
| 3 | GP-138 | MP-238 | SP 是 curated 翻譯 |
| 4 | GP-50 | MP-66 | SP 是 curated 翻譯 |
| 5 | MP-151 或 MP-156 | 另一篇 | 需比較品質，二選一 |
| 6 | GP-111 | MP-160 | SP 是 curated 翻譯 |
