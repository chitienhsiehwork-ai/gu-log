...
- [ ] 1.2 實作正式文章路徑 allowlist，接受帶／不帶尾端斜線的繁中／英文單一安全 slug，排除 `.md`、API、資產、列表與其他路徑
...
- [ ] 2.3 驗證中介層 matcher 有界，且路由額度、舊網址轉址與明確 `.md` 標頭不變

## 3. Deployment verification

- [ ] 3.1 擴充 strict verifier，覆蓋繁中／英文正式 GET、偏好 Markdown、偏好 HTML、同分、`q=0`、萬用範圍、無效／不支援類型
- [ ] 3.2 驗證 HEAD 沒有正文且 Content-Type／Vary 正確；API 與明確 `.md` 保持原契約，帶／不帶尾端斜線都能協商
