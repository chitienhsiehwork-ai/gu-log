...
- 中文文章出現禁用譯名時，glossary checker 必須報錯；blockquotes 同樣是讀者可見內容，只有英文文章、程式碼與其他非正文語法不受影響。
...
- `gp-source-preservation`: GP translator 在開始翻譯前必須收到 glossary 宣告的 canonical term 與禁用譯名，且 prompt contract 變更會使舊 gate manifest 失效。
...
- 目前仍含有「代理人」的中文文章，以及 GP-273 的 preservation fixtures
