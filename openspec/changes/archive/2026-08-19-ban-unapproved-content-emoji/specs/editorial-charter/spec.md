...
- **AND** approved component 的 local import alias SHALL 映回真實 component 身分，其 trusted source SHALL 由測試維持不含 literal Unicode emoji，亦不得以 HTML entity、CSS escape、JavaScript character escape 或其疊層組合產生 emoji
