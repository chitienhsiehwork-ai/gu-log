...
# Legacy filename retained for compatibility. Runtime is supplied by
# scripts/tribunal.sh via `codex exec --model gpt-5.5`; this frontmatter is
# prompt metadata, not a Claude Code model selector.
model: gpt-5.5
tools:
  - Read
  - Write
