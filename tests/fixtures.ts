...
type CoverageList = Awaited<ReturnType<Page['coverage']['stopJSCoverage']>>;

let addCoverageReport:
  | ((coverageList: CoverageList, testInfo: ReturnType<typeof test.info>) => Promise<void>)
  | null = null;
