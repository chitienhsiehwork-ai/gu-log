...
- `vibe-opus-scorer.md` → persona / moguNote / vibe / narrative（v9；clarity 已移到 Fresh Eyes，v8 以下才含 clarity）
...
tools/gp-pipeline/gp-pipeline fetch <url> --work-dir /tmp/sp-probe
tools/gp-pipeline/gp-pipeline eval --source /tmp/sp-probe/source-tweet.md
