...
let pwaIntegration = null;

try {
  const { default: AstroPWA } = await import('@vite-pwa/astro');
  pwaIntegration = AstroPWA({
  ...
  // Allow local development and tests to run without the optional PWA package.
}

// https://astro.build/config
export default defineConfig({
  site: 'https://gu-log.vercel.app',
  integrations: [sitemap(), mdx(), ...(pwaIntegration ? [pwaIntegration] : [])],
  markdown: {
