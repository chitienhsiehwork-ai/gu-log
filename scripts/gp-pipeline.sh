...
# tools/gp-pipeline/ (Go); this thin wrapper translates the legacy env-var
# surface into Go CLI flags and execs the self-compiling wrapper. The older
# scripts/gp-pipeline.sh is kept as a backwards-compat shim and behaves
# identically.
...
GP_PIPELINE="$GU_LOG_DIR/tools/gp-pipeline/gp-pipeline"
