...
- **`WebFetch` on x.com** — blocked in most Codex sandboxes (402/403). Skip it.
...
The OpenClaw [x-tweet-fetcher](https://github.com/ythx-101/x-tweet-fetcher) skill is the right tool on a VPS with Playwright and outbound network. In the gu-log sandbox (Codex on the web, or any locked-down box):
